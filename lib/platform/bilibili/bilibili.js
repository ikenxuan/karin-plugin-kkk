...
import { bilibiliComments, checkCk, DynamicType, genParams } from '../../platform/bilibili/index.js';
let img;
        ...
        switch (this.Type) {
            case 'one_video': {
                ...
                if ((Config.upload.usefilelimit && Number(videoSize) > Number(Config.upload.filelimit)) && !Config.upload.compress) {
                    ...
                    await this.getvideo(Config.bilibili.videopriority === true ? { playUrlData: nockData } : { infoData, playUrlData });
                break;
            }
