...
const OriginalDrawContent = ({ content }) => {
	return /* @__PURE__ */ import_react.default.createElement("div", { className: "px-12 py-8 mt-4 w-full rounded-2xl bg-content1" }, /* @__PURE__ */ import_react.default.createElement(OriginalUserInfo, {
		avatar_url: content.avatar_url,
		frame: content.frame,
		username: content.username,
		create_time: content.create_time,
