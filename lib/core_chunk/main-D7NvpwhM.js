...
import { C as Client, b as bilibiliErrorCodeMap, D as DynamicType, g as getBilibiliData, A as AdditionalType, a as bilibiliApiUrls, w as wbi_sign, c as browserExports, M as MajorType, d as getDouyinData, h as heicConvertExports } from "./vendor-BDYGKpr1.js";
...
import { r as renderComponentToHtml } from "./template-_SqNhc0z.js";
import { karinPathBase, karinPathTemp } from "node-karin/root";
import { getDouyinDB, getBilibiliDB, cleanOldDynamicCache, bilibiliDBInstance, douyinDBInstance } from "./db-DVxMSgur.js";
...
const Render = async (path2, params, useReact = true) => {
  if (useReact) {
    return await renderWithReact(path2, params);
  }
  return await renderWithTemplate(path2, params);
};
const renderWithReact = async (path2, params) => {
  try {
...
const renderWithLocalComponent = async (templateType, templateName, params) => {
...
const renderWithTemplate = async (path2, params) => {
  const basePaths = {
    douyin: "douyin/html",
