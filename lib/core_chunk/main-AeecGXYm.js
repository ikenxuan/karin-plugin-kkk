...
import { C as Client, D as DynamicType, g as getBilibiliData, A as AdditionalType, b as bilibiliApiUrls, w as wbi_sign, M as MajorType, a as getDouyinData, h as heicConvertExports, l as logger$1 } from "./vendor-BGsg9s4-.js";
import karin, { copyConfigSync, filesByExt, watch, logger, requireFileSync, segment, createNotFoundResponse, ffmpeg, ffprobe, render, common, createBadRequestResponse, createServerErrorResponse, createSuccessResponse, getBot, defineConfig, components, mkdirSync, config } from "node-karin";
import axios, { AxiosError } from "node-karin/axios";
import { pipeline } from "stream/promises";
import path, { join } from "node:path";
import { r as reactServerRender } from "./template-BGGyVxIw.js";
import { karinPathBase, karinPathTemp } from "node-karin/root";
import { getDouyinDB, getBilibiliDB, cleanOldDynamicCache, bilibiliDBInstance, douyinDBInstance } from "./db-6ZrksljJ.js";
