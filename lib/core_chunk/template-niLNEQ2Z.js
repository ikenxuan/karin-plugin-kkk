...
import { $ as List, A as Zap, B as Shield, C as chip_default, Ct as require_react, D as IoSearch, E as require_jsx_runtime, F as TrendingUp, G as QrCode, H as Send, I as ThumbsUp, J as Play, K as Power, L as Terminal, M as User, N as UserPlus, O as init_io5, P as TriangleAlert, Q as LogIn, R as Star, S as code_default, St as require_server_node, T as HeroUIProvider, U as RefreshCw, Ut as Chalk, V as Share2, W as Radio, X as MessageCircle, Y as Music, Z as MapPin, _ as FaCodeBranch, _t as Bookmark, a as remarkGfm, at as Eye, b as init_fa6, bt as clsx_default, c as init_rehype_raw, ct as CornerDownLeft, d as rehypeHighlight, dt as Clock, et as Link, f as init_react_markdown, ft as CircleQuestionMark, g as FaBug, gt as Bot, h as init_md, ht as Calendar, i as init_remark_gfm, it as FileText, j as Users, k as init_lucide_react, l as rehypeRaw, lt as Coins, m as MdAccessTime, mt as CircleAlert, nt as Heart, o as init_remark_breaks, ot as ExternalLink, p as Markdown, pt as CircleCheckBig, q as Plug2, r as init_chalk, rt as Hash, s as remarkBreaks, st as Crown, tt as Info, u as init_rehype_highlight, ut as Code, v as FaCube, vt as BookOpen, w as button_default, x as init_dist, xt as init_clsx, y as FaLayerGroup, yt as Bell, z as Sparkles } from "./vendor-4CM806JY.js";
...
var init_Comment$3 = __esmMin(() => {
	...
	VideoInfoHeader$1 = (props) => (0, import_jsx_runtime$23.jsx)("div", {
		...
		children: (0, import_jsx_runtime$23.jsxs)("div", {
			className: "flex justify-between items-start gap-16",
			children: [(0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$23.jsx)("div", {
					...
					children: (0, import_jsx_runtime$23.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$23.jsx)("img", {
							...
							className: "flex flex-col gap-2 px-8 py-4 rounded-3xl bg-default-100/50 w-fit ml-8",
					...
					className: "grid grid-cols-2 gap-x-16 gap-y-6 pl-2",
					children: [
						(0, import_jsx_runtime$23.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text",
							children: [(0, import_jsx_runtime$23.jsx)("span", {
								className: "text-foreground-400 mr-4",
								children: "类型"
							}), (0, import_jsx_runtime$23.jsx)("span", {
	...
	CommentItemComponent$2 = (props) => (0, import_jsx_runtime$23.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$23.jsx)("img", {
			...
			children: [
				(0, import_jsx_runtime$23.jsxs)("div", {
					className: "mb-6 text-6xl text-foreground-600 flex items-center gap-7 flex-wrap select-text",
					children: [
						(0, import_jsx_runtime$23.jsx)("span", {
						...
						props.is_author_digged && (0, import_jsx_runtime$23.jsx)("div", {
						...
						props.status_label && (0, import_jsx_runtime$23.jsx)("div", {
							className: "inline-flex items-center px-4 py-2 text-4xl rounded-xl font-light bg-content2 text-foreground-700",
				...
				(0, import_jsx_runtime$23.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$23.jsxs)("div", {
						className: "flex items-center gap-6 select-text flex-wrap",
						children: [
							(0, import_jsx_runtime$23.jsx)("span", {
								className: "text-5xl",
				...
				props.replyComment && Object.keys(props.replyComment).length > 0 && (0, import_jsx_runtime$23.jsx)("div", {
					className: "mt-10 pl-8 pt-8 border-t border-divider/30",
					children: (0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$16.jsx)("div", {
					...
					children: (0, import_jsx_runtime$16.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$16.jsx)("img", {
							...
							className: "flex flex-col gap-2 px-8 py-4 rounded-3xl bg-default-100/50 w-fit ml-12",
							children: [(0, import_jsx_runtime$16.jsx)("span", {
								className: "text-[42px] text-foreground-400",
								children: "分辨率（px）"
					...
					children: [
						(0, import_jsx_runtime$16.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$16.jsx)("span", {
								className: "text-foreground-400 mr-4 flex-shrink-0",
								children: "类型"
							}), (0, import_jsx_runtime$16.jsx)("span", {
								className: "font-medium text-foreground-600",
								children: props.Type
							...
							children: [
								(0, import_jsx_runtime$1.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$1.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$1.jsx)(FaLayerGroup, { className: "w-9 h-9 text-primary" }), (0, import_jsx_runtime$1.jsxs)("div", { children: [(0, import_jsx_runtime$1.jsx)("div", {
										...
										className: "flex items-center gap-4",
										children: [(0, import_jsx_runtime$1.jsx)(FaCube, { className: "w-9 h-9 text-success" }), (0, import_jsx_runtime$1.jsxs)("div", { children: [(0, import_jsx_runtime$1.jsx)("div", {
											className: "text-2xl text-default-400",
											children: "插件版本"
										}), (0, import_jsx_runtime$1.jsx)("div", {
											className: "text-4xl font-bold text-foreground",
								...
								adapterInfo && (0, import_jsx_runtime$1.jsxs)("div", {
									className: "flex items-center gap-4",
									children: [(0, import_jsx_runtime$1.jsx)(Plug2, { className: "w-9 h-9 text-secondary" }), (0, import_jsx_runtime$1.jsxs)("div", { children: [(0, import_jsx_runtime$1.jsx)("div", {
										className: "text-2xl text-default-400",
										children: "适配器"
									}), (0, import_jsx_runtime$1.jsx)("div", {
										className: "text-4xl font-bold text-foreground",
										children: (0, import_jsx_runtime$1.jsxs)("span", {
											className: "relative inline-block pr-24",
											children: [adapterInfo.name, (0, import_jsx_runtime$1.jsx)(chip_default, {
												color: "secondary",
												variant: "flat",
												size: "lg",
												...
												children: (0, import_jsx_runtime$1.jsxs)("span", {
													className: "font-bold",
													children: ["v", adapterInfo.version]
												})
											})]
										})
									})] })]
