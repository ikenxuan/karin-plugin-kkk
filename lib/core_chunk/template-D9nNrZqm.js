...
import { $ as Send, A as format, At as Bot, B as init_lucide_react, C as init_locale, Ct as Clock, D as init_date_fns, Dt as CircleCheckBig, E as init_lu, Et as CircleEllipsis, F as button_default, Ft as init_clsx, G as TriangleAlert, H as Users, I as HeroUIProvider, It as require_server_node, J as Star, K as ThumbsUp, L as require_jsx_runtime, Lt as require_react, M as init_dist, Mt as BookOpen, N as code_default, Nt as Bell, Ot as CircleAlert, P as chip_default, Pt as clsx_default, Q as Share2, R as IoSearch, S as init_ai, St as Code, T as LuFullscreen, Tt as CircleFadingArrowUp, U as User, V as Zap, W as UserPlus, X as Smartphone, Y as Sparkles, Z as Shield, _ as FaCodeBranch, _t as Eye, at as Plug2, b as AiFillHeart, bt as CornerDownLeft, c as init_rehype_highlight, ct as MessageCircle, d as Markdown, dt as List, et as RefreshCw, f as MdAccessTime, ft as Link, g as FaBug, gt as FileText, h as init_ri, ht as Hash, it as Plus, jt as Bookmark, k as formatDistanceToNow, kt as Calendar, l as rehypeHighlight, lt as MapPin, m as RiShareForwardFill, mt as Heart, nt as QrCode, ot as Play, p as init_md, pt as Info, q as Terminal, rt as Power, st as Music, tt as Radio, u as init_react_markdown, ut as LogIn, v as FaCommentDots, vt as ExternalLink, w as zhCN, wt as CircleQuestionMark, x as AiFillStar, xt as Coins, y as init_fa6, yt as Crown, z as init_io5 } from "./vendor-XSH-_Sf8.js";
...
var import_react$30, import_jsx_runtime$28, GlowImage, GlowText, GlowIcon, GlowBorderContainer, SmartGlowBorder;
var init_GlowImage = __esmMin(() => {
	import_react$30 = __toESM(require_react(), 1);
	...
	GlowImage = ({ src, children, alt, className, imgClassName, mode = "blur-layer", blurRadius = 18, glowStrength = .6, scale = 1.06, shadowRadius = 28, crossOrigin }) => {
		const [shadowColor, setShadowColor] = import_react$30.useState("rgba(255,255,255,0.5)");
		import_react$30.useEffect(() => {
		...
		if (children) return (0, import_jsx_runtime$28.jsxs)("div", {
			className,
			style: {
				position: "relative",
	...
	GlowText = ({ children, className, glowClassName, blurRadius = 12, glowStrength = .6, scale = 1.02 }) => (0, import_jsx_runtime$28.jsxs)("span", {
		className,
		style: {
			position: "relative",
			display: "inline-block"
	...
	GlowIcon = ({ Icon, iconProps = {}, className, glowColor, glowStrength = .8, glowRadius = 12, glowLayers = 3, glowSpread = 4 }) => {
		const dropShadow = import_react$30.useMemo(() => Array.from({ length: glowLayers }, (_, i) => {
		...
		return (0, import_jsx_runtime$28.jsx)("div", {
			className,
			style: { display: "inline-block" },
			children: (0, import_jsx_runtime$28.jsx)(Icon, {
				...iconProps,
				style: {
					filter: dropShadow,
					...iconProps.style
	...
	SmartGlowBorder = ({ children, className, glowColor, glowStrength = .5, borderWidth = 1, borderRadius = "1.5rem", glowPosition = "left-top", lightInfluenceRange = .3, enableDynamicGlow = true }) => {
		const containerRef = import_react$30.useRef(null);
		const [detectedGlowColor, setDetectedGlowColor] = import_react$30.useState("rgb(245, 158, 11)");
		import_react$30.useEffect(() => {
		...
		return (0, import_jsx_runtime$28.jsx)("div", {
			ref: containerRef,
			children: (0, import_jsx_runtime$28.jsx)(GlowBorderContainer, {
				className,
...
}), import_jsx_runtime$27, DefaultLayout;
var init_DefaultLayout = __esmMin(() => {
	...
	DefaultLayout = ({ children, version, data, scale = 3, className = "", style = {} }) => {
		...
		return (0, import_jsx_runtime$27.jsx)(HeroUIProvider, { children: (0, import_jsx_runtime$27.jsxs)("div", {
			...
			children: [children, version ? (0, import_jsx_runtime$27.jsx)("div", {
				...
				children: (0, import_jsx_runtime$27.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$27.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$27.jsx)(GlowImage, {
								...
								children: (0, import_jsx_runtime$27.jsxs)("svg", {
									...
									children: [
										(0, import_jsx_runtime$27.jsx)("path", {
											id: "_1",
								...
								children: [(0, import_jsx_runtime$27.jsx)("div", {
									...
									children: (0, import_jsx_runtime$27.jsx)("span", { children: version.plugin })
						...
						(0, import_jsx_runtime$27.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$27.jsxs)("div", {
								...
								children: [
									version.hasUpdate && (0, import_jsx_runtime$27.jsx)(CircleFadingArrowUp, {
										strokeWidth: 3,
										className: "w-4 h-4 text-success"
									}),
									!version.hasUpdate && version.releaseType === "Stable" && (0, import_jsx_runtime$27.jsx)(CircleCheckBig, {
										strokeWidth: 3,
										className: "w-4 h-4"
									}),
									!version.hasUpdate && version.releaseType === "Preview" && (0, import_jsx_runtime$27.jsx)(TriangleAlert, {
										strokeWidth: 3,
										className: "w-4 h-4 text-warning"
									}),
									!version.hasUpdate && version.releaseType !== "Stable" && version.releaseType !== "Preview" && (0, import_jsx_runtime$27.jsx)(Info, {
										strokeWidth: 3,
										className: "w-4 h-4"
									}),
									(0, import_jsx_runtime$27.jsx)("span", {
						...
						(0, import_jsx_runtime$27.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }),
						(0, import_jsx_runtime$27.jsxs)("div", {
							className: "flex items-end space-x-8",
							children: [(0, import_jsx_runtime$27.jsx)(GlowImage, {
								...
								children: [(0, import_jsx_runtime$27.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [(0, import_jsx_runtime$27.jsx)(Zap, {
										strokeWidth: 3,
						...
						version.releaseType === "Stable" && (0, import_jsx_runtime$27.jsxs)(import_jsx_runtime$27.Fragment, { children: [(0, import_jsx_runtime$27.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }), (0, import_jsx_runtime$27.jsxs)("div", {
							className: "flex items-end space-x-8",
							children: [(0, import_jsx_runtime$27.jsx)(GlowImage, {
								src: "/image/vite.svg",
								alt: "logo",
								...
								children: [(0, import_jsx_runtime$27.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [
										(0, import_jsx_runtime$27.jsx)(Code, {
											strokeWidth: 3,
											className: "w-4 h-4"
										}),
										(0, import_jsx_runtime$27.jsx)("span", { children: "Built with" }),
										(0, import_jsx_runtime$27.jsx)(GlowImage, {
			...
			}) : (0, import_jsx_runtime$27.jsx)("div", { className: "h-24" })]
		}) });
	};
});
...
var import_react$28, import_jsx_runtime$26, QRCodeSection$3, VideoInfoHeader$1, organizeReplies, ReplyItemComponent, CommentItemComponent$2, DouyinComment, Comment_default$3;
var init_Comment$3 = __esmMin(() => {
	...
	VideoInfoHeader$1 = (props) => (0, import_jsx_runtime$26.jsx)("div", {
			...
			children: [(0, import_jsx_runtime$26.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$26.jsx)("div", {
					...
					children: (0, import_jsx_runtime$26.jsxs)("div", {
						...
						}), props.Type === "视频" && props.Resolution && (0, import_jsx_runtime$26.jsxs)("div", {
					...
					children: [
						...
						props.Type === "视频" ? (0, import_jsx_runtime$26.jsxs)(import_jsx_runtime$26.Fragment, { children: [(0, import_jsx_runtime$26.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text",
							children: [(0, import_jsx_runtime$26.jsx)("span", {
								className: "mr-4 text-foreground-400",
								children: "大小"
						...
						})] }) : (0, import_jsx_runtime$26.jsxs)(import_jsx_runtime$26.Fragment, { children: [(0, import_jsx_runtime$26.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text",
							children: [(0, import_jsx_runtime$26.jsx)("span", {
								className: "mr-4 text-foreground-400",
								children: "区域"
				...
				className: "shrink-0",
				children: (0, import_jsx_runtime$26.jsx)(QRCodeSection$3, { qrCodeDataUrl: props.qrCodeDataUrl })
			})]
		})
	});
	...
	ReplyItemComponent = ({ reply, depth = 0, isLast, maxDepth = 6 }) => {
		...
		if (reply.hiddenCount) return (0, import_jsx_runtime$26.jsx)("div", {
			...
			children: (0, import_jsx_runtime$26.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$26.jsxs)("div", {
					...
					children: [
						!isLast && (0, import_jsx_runtime$26.jsx)("div", { className: "absolute top-0 bottom-0 left-1/2 w-0.5 bg-default-300 -ml-px" }),
						!isLast && (0, import_jsx_runtime$26.jsx)("div", { className: "absolute -bottom-6 left-1/2 w-0.5 h-6 bg-default-300 -ml-px" }),
						(0, import_jsx_runtime$26.jsx)("svg", {
							className: "absolute top-0 left-0 w-full h-[50px] pointer-events-none overflow-visible z-0 text-default-300",
							children: (0, import_jsx_runtime$26.jsx)("path", {
					...
					children: (0, import_jsx_runtime$26.jsx)("div", {
						...
						children: (0, import_jsx_runtime$26.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$26.jsx)(CircleEllipsis, {
								size: 45,
								className: "mr-5"
							}), (0, import_jsx_runtime$26.jsxs)("span", {
		...
		return (0, import_jsx_runtime$26.jsx)("div", {
				...
				children: [(0, import_jsx_runtime$26.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$26.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$26.jsxs)("div", {
							...
							}), reply.children.length > 0 && (0, import_jsx_runtime$26.jsx)("div", { className: "w-0.5 bg-default-300 h-full grow mt-3 rounded-t-full" })]
						}), (0, import_jsx_runtime$26.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$26.jsxs)("div", {
									...
									children: [
										...
										reply.label_text !== "" && (0, import_jsx_runtime$26.jsx)("div", {
										...
										reply.reply_to_username && (0, import_jsx_runtime$26.jsxs)("div", {
											className: clsx_default("flex items-center", !isNicknameLonger ? "overflow-hidden min-w-0 shrink" : "shrink-0"),
											children: [(0, import_jsx_runtime$26.jsx)(Play, {
												size: 35,
								...
								(0, import_jsx_runtime$26.jsxs)("div", {
									...
									}), reply.image_list && reply.image_list.length > 0 && reply.image_list.filter(Boolean).map((img, idx) => (0, import_jsx_runtime$26.jsx)("div", {
									...
									children: (0, import_jsx_runtime$26.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$26.jsxs)("div", {
												...
												children: [(0, import_jsx_runtime$26.jsx)(Heart, {
													size: 40,
					...
					}), reply.children.length > 0 && (0, import_jsx_runtime$26.jsx)("div", {
						className: "flex relative flex-col",
						children: (0, import_jsx_runtime$26.jsx)("div", { children: reply.children.map((child, index) => (0, import_jsx_runtime$26.jsx)(ReplyItemComponent, {
							reply: child,
							depth: depth + 1,
	...
	CommentItemComponent$2 = (props) => (0, import_jsx_runtime$26.jsx)("div", {
		...
		children: (0, import_jsx_runtime$26.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$26.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$26.jsxs)("div", {
					...
					}), props.replyComment && props.replyComment.length > 0 && (0, import_jsx_runtime$26.jsx)("div", { className: "w-0.5 bg-default-300 h-full grow mt-4 rounded-t-full" })]
				}), (0, import_jsx_runtime$26.jsxs)("div", {
					...
					children: [
						...
						(props.commentimage || props.sticker) && (0, import_jsx_runtime$26.jsx)("div", {
			...
			}), props.replyComment && props.replyComment.length > 0 && (0, import_jsx_runtime$26.jsxs)("div", {
				className: "flex relative flex-col mt-8 ml-5",
				children: [(0, import_jsx_runtime$26.jsx)("div", { className: "absolute -top-8 left-[50px] w-0.5 h-8 bg-default-300 -ml-px" }), organizeReplies(props.replyComment, props.cid || "", props.maxDepth).map((reply, index, arr) => (0, import_jsx_runtime$26.jsx)(ReplyItemComponent, {
					reply,
					depth: 1,
	...
	DouyinComment = import_react$28.memo((props) => {
		const randomSuggestWord = import_react$28.useMemo(() => {
		...
		return (0, import_jsx_runtime$26.jsx)(DefaultLayout, {
			...props,
			children: (0, import_jsx_runtime$26.jsxs)("div", {
				className: "p-5",
				children: [
					(0, import_jsx_runtime$26.jsx)("div", { className: "h-20" }),
					(0, import_jsx_runtime$26.jsx)(VideoInfoHeader$1, {
						...props.data,
						qrCodeDataUrl: props.qrCodeDataUrl
					}),
					randomSuggestWord && (0, import_jsx_runtime$26.jsx)("div", {
						...
						children: (0, import_jsx_runtime$26.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$26.jsx)("span", {
								...
								children: [randomSuggestWord, (0, import_jsx_runtime$26.jsx)(IoSearch, {
									size: 32,
					...
					(0, import_jsx_runtime$26.jsx)("div", {
						...
						children: props.data.CommentsData.length > 0 ? (0, import_jsx_runtime$26.jsx)(import_jsx_runtime$26.Fragment, { children: props.data.CommentsData.map((comment, index) => (0, import_jsx_runtime$26.jsx)(CommentItemComponent$2, {
							...comment,
							isLast: index === props.data.CommentsData.length - 1,
							maxDepth: props.data.maxDepth
						}, comment.cid || index)) }) : (0, import_jsx_runtime$26.jsx)("div", {
...
var import_react$27, import_jsx_runtime$25, DouyinHeader$1, CoverSection$1, InfoSection, UserInfoSection$1, CoCreatorsInfo, DouyinDynamic, Dynamic_default;
var init_Dynamic = __esmMin(() => {
	...
	DouyinHeader$1 = ({ useDarkTheme }) => (0, import_jsx_runtime$25.jsxs)("div", {
	...
	CoverSection$1 = ({ imageUrl }) => (0, import_jsx_runtime$25.jsx)("div", {
	...
	InfoSection = (props) => (0, import_jsx_runtime$25.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime$25.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$25.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$25.jsx)(Heart, { className: "w-11 h-11 text-like" }), (0, import_jsx_runtime$25.jsxs)("span", { children: [props.data.dianzan, "点赞"] })]
					}),
					(0, import_jsx_runtime$25.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$25.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$25.jsx)(MessageCircle, { className: "w-11 h-11 text-comment" }), (0, import_jsx_runtime$25.jsxs)("span", { children: [props.data.pinglun, "评论"] })]
					}),
					(0, import_jsx_runtime$25.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$25.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$25.jsx)(Bookmark, { className: "w-11 h-11" }), (0, import_jsx_runtime$25.jsxs)("span", { children: [props.data.shouchang, "收藏"] })]
					}),
					(0, import_jsx_runtime$25.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$25.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$25.jsx)(Share2, { className: "w-11 h-11 text-success" }), (0, import_jsx_runtime$25.jsxs)("span", { children: [props.data.share, "分享"] })]
					})
				]
			}),
			(0, import_jsx_runtime$25.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$25.jsx)(Clock, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$25.jsxs)("span", { children: ["发布于: ", props.data.create_time] })]
			}),
			(0, import_jsx_runtime$25.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$25.jsx)(LuFullscreen, { className: "w-11 h-11 text-time text-time" }), (0, import_jsx_runtime$25.jsxs)("span", { children: ["图片生成于: ", format(/* @__PURE__ */ new Date(), "yyyy-MM-dd HH:mm:ss")] })]
			})
		]
	});
	UserInfoSection$1 = (props) => (0, import_jsx_runtime$25.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$25.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$25.jsx)("div", {
				...
				children: [(0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$25.jsx)(Hash, {
						size: 32,
			...
			children: [
				(0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [
						...
						(0, import_jsx_runtime$25.jsx)("div", { className: "w-full h-px bg-default-300" }),
						(0, import_jsx_runtime$25.jsx)("span", {
				...
				(0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$25.jsxs)("div", {
							className: "flex gap-1 items-center",
							children: [(0, import_jsx_runtime$25.jsx)(Eye, {
								size: 28,
								className: "text-view"
							}), (0, import_jsx_runtime$25.jsx)("span", {
								className: "text-default-400",
				...
				(0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$25.jsxs)("div", {
							className: "flex gap-1 items-center",
							children: [(0, import_jsx_runtime$25.jsx)(Users, {
								size: 28,
	...
	CoCreatorsInfo = ({ info }) => {
		...
		const listRef = import_react$27.useRef(null);
		const [visibleCount, setVisibleCount] = import_react$27.useState(items.length);
		import_react$27.useEffect(() => {
			const calc = () => {
		...
		return (0, import_jsx_runtime$25.jsx)("div", {
			...
			children: (0, import_jsx_runtime$25.jsxs)("div", {
				...
				}), items.length > visibleCount && (0, import_jsx_runtime$25.jsxs)("div", {
					className: "flex flex-col items-center min-w-[152px] w-[152px] shrink-0",
					children: [
						(0, import_jsx_runtime$25.jsx)("div", {
	...
	DouyinDynamic = (props) => {
		...
		return (0, import_jsx_runtime$25.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$25.jsxs)("div", { children: [
				(0, import_jsx_runtime$25.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$25.jsx)(DouyinHeader$1, { useDarkTheme: props.data.useDarkTheme }),
				(0, import_jsx_runtime$25.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$25.jsx)(CoverSection$1, { imageUrl: props.data.image_url }),
				(0, import_jsx_runtime$25.jsx)("div", { className: "h-[20px]" }),
				(0, import_jsx_runtime$25.jsx)(InfoSection, { ...props }),
				(0, import_jsx_runtime$25.jsx)("div", { className: "h-[100px]" }),
				(0, import_jsx_runtime$25.jsxs)("div", {
					className: "flex flex-col gap-10 px-0 pt-25",
					children: [(0, import_jsx_runtime$25.jsxs)("div", {
						className: "w-full",
						children: [coCreatorCount && coCreatorCount > 0 && (0, import_jsx_runtime$25.jsx)("div", {
							className: "px-16 pb-8",
							children: (0, import_jsx_runtime$25.jsxs)("div", {
								className: "gap-2 inline-flex items-center rounded-2xl bg-default-100 text-foreground-700 px-6 py-3",
								children: [(0, import_jsx_runtime$25.jsx)(Users, { className: "w-7 h-7" }), (0, import_jsx_runtime$25.jsxs)("span", {
									className: "text-3xl font-medium leading-none select-text text-foreground-700",
									children: [coCreatorCount, "人共创"]
								})]
							})
						}), (0, import_jsx_runtime$25.jsx)(CoCreatorsInfo, { info: props.data.cooperation_info })]
					}), (0, import_jsx_runtime$25.jsxs)("div", {
						className: "flex justify-between items-start px-20 pb-20",
						children: [(0, import_jsx_runtime$25.jsx)(UserInfoSection$1, { ...props }), (0, import_jsx_runtime$25.jsx)("div", {
							className: "flex flex-col items-center gap-4",
							children: props.qrCodeDataUrl ? (0, import_jsx_runtime$25.jsx)("img", {
...
}, 1), import_jsx_runtime$24, CoverSection, UserInfoSection, QRCodeSection$2, DouyinLive, Live_default;
var init_Live = __esmMin(() => {
	init_lucide_react();
	__toESM(require_react(), 1);
	init_DefaultLayout();
	import_jsx_runtime$24 = __toESM(require_jsx_runtime(), 1);
	CoverSection = ({ imageUrl }) => (0, import_jsx_runtime$24.jsx)("div", {
		className: "py-10",
	...
	UserInfoSection = ({ avater_url, username, fans }) => (0, import_jsx_runtime$24.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$24.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$24.jsx)("div", {
						...
						children: (0, import_jsx_runtime$24.jsx)("span", { children: username })
					}),
					(0, import_jsx_runtime$24.jsx)("div", { className: "w-4" }),
				...
				className: "flex gap-2 items-center",
				children: [(0, import_jsx_runtime$24.jsx)(Users, { className: "w-8 h-8 text-follow" }), (0, import_jsx_runtime$24.jsxs)("span", {
	...
	QRCodeSection$2 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$24.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$24.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$24.jsx)(QrCode, { className: "w-12 h-12" }), (0, import_jsx_runtime$24.jsx)("span", { children: "直播分享链接" })]
		}), (0, import_jsx_runtime$24.jsx)("div", {
	...
	DouyinLive = (props) => {
		...
		return (0, import_jsx_runtime$24.jsxs)(DefaultLayout, {
			...props,
			children: [(0, import_jsx_runtime$24.jsx)(CoverSection, { imageUrl: props.data.image_url }), (0, import_jsx_runtime$24.jsxs)("div", {
				className: "flex flex-col px-20",
				children: [
					(0, import_jsx_runtime$24.jsx)("div", { className: "h-2.5" }),
					(0, import_jsx_runtime$24.jsx)("div", {
					...
					(0, import_jsx_runtime$24.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$24.jsxs)("div", {
								className: "flex gap-2 items-center",
								children: [(0, import_jsx_runtime$24.jsx)(Eye, { className: "w-11 h-11 text-view" }), (0, import_jsx_runtime$24.jsxs)("span", { children: ["观看总人数", props.data.总观看次数] })]
							}),
							(0, import_jsx_runtime$24.jsx)("span", { children: "|" }),
							(0, import_jsx_runtime$24.jsxs)("div", {
								className: "flex gap-2 items-center",
								children: [(0, import_jsx_runtime$24.jsx)(Users, { className: "w-11 h-11 text-follow" }), (0, import_jsx_runtime$24.jsxs)("span", { children: ["在线观众", props.data.在线观众] })]
							})
						]
					}),
					(0, import_jsx_runtime$24.jsx)("div", { className: "h-20" }),
					(0, import_jsx_runtime$24.jsx)(UserInfoSection, {
						avater_url: props.data.avater_url,
						username: props.data.username,
						fans: props.data.fans,
						useDarkTheme: props.data.useDarkTheme
					}),
					(0, import_jsx_runtime$24.jsx)("div", { className: "h-[120px]" }),
					(0, import_jsx_runtime$24.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$24.jsxs)("div", {
							...
							}), (0, import_jsx_runtime$24.jsx)(QRCodeSection$2, {
								qrCodeDataUrl,
								useDarkTheme: props.data.useDarkTheme
							})]
						})]
...
}, 1), import_jsx_runtime$23, DouyinHeader, MusicCoverSection, MusicInfoSection, MusicAuthorInfoSection, MusicQRCodeSection, DouyinMusicInfo, MusicInfo_default;
var init_MusicInfo = __esmMin(() => {
	...
	DouyinHeader = ({ useDarkTheme }) => (0, import_jsx_runtime$23.jsxs)("div", {
		className: "flex items-center px-12 py-15",
	...
	MusicCoverSection = ({ imageUrl }) => (0, import_jsx_runtime$23.jsx)("div", {
		className: "flex flex-col items-center my-5",
		children: (0, import_jsx_runtime$23.jsx)("div", {
			className: "flex flex-col items-center overflow-hidden shadow-large rounded-[25px] w-[90%] relative",
			children: (0, import_jsx_runtime$23.jsx)("img", {
	...
	MusicInfoSection = ({ desc, musicId, userCount, createTime }) => (0, import_jsx_runtime$23.jsxs)("div", {
		className: "flex flex-col px-16 py-5",
		children: [
			...
			(0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$23.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$23.jsx)(Music, { className: "w-11 h-11" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["音乐ID: ", musicId] })]
				}), (0, import_jsx_runtime$23.jsxs)("div", {
					className: "flex gap-2 items-center select-text",
					children: [(0, import_jsx_runtime$23.jsx)(Users, { className: "w-11 h-11 text-follow" }), (0, import_jsx_runtime$23.jsxs)("span", { children: [userCount, " 人使用过"] })]
				})]
			}),
			(0, import_jsx_runtime$23.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-default-500 font-light select-text",
				children: [(0, import_jsx_runtime$23.jsx)(LuFullscreen, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["图片生成于: ", createTime] })]
			})
		]
	});
	MusicAuthorInfoSection = ({ avatarUrl, username, userShortId, totalFavorited, followingCount, fans }) => (0, import_jsx_runtime$23.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$23.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$23.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$23.jsx)(Hash, { className: "w-8 h-8" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["ID: ", userShortId] })]
				}),
				(0, import_jsx_runtime$23.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$23.jsx)(Heart, { className: "w-8 h-8 text-like" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["获赞: ", totalFavorited] })]
				}),
				(0, import_jsx_runtime$23.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$23.jsx)(UserPlus, { className: "w-8 h-8" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["关注: ", followingCount] })]
				}),
				(0, import_jsx_runtime$23.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$23.jsx)(Users, { className: "w-8 h-8 text-follow" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["粉丝: ", fans] })]
				})
			]
		})]
	});
	MusicQRCodeSection = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$23.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$23.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$23.jsx)(QrCode, { className: "w-11 h-11" }), (0, import_jsx_runtime$23.jsx)("span", { children: "文件直链：永久有效" })]
		}), (0, import_jsx_runtime$23.jsx)("div", {
	...
	DouyinMusicInfo = (props) => {
		...
		return (0, import_jsx_runtime$23.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$23.jsxs)("div", { children: [
				(0, import_jsx_runtime$23.jsx)(DouyinHeader, { useDarkTheme: data.useDarkTheme }),
				(0, import_jsx_runtime$23.jsx)(MusicCoverSection, {
					imageUrl: data.image_url,
					description: data.desc,
					useDarkTheme: data.useDarkTheme
				}),
				(0, import_jsx_runtime$23.jsx)("div", { className: "h-[90px]" }),
				(0, import_jsx_runtime$23.jsx)(MusicInfoSection, {
					desc: data.desc,
				...
				(0, import_jsx_runtime$23.jsx)("div", { className: "h-[100px]" }),
				(0, import_jsx_runtime$23.jsx)("div", {
				...
				(0, import_jsx_runtime$23.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$23.jsx)(MusicAuthorInfoSection, {
						...
						fans: data.fans,
						useDarkTheme: data.useDarkTheme
					}), (0, import_jsx_runtime$23.jsx)(MusicQRCodeSection, {
						qrCodeDataUrl,
						useDarkTheme: data.useDarkTheme
					})]
				})
...
var import_react$24, import_jsx_runtime$22, formatCount, formatDuration$1, VideoCard, DouyinUserVideoList;
var init_UserVideoList = __esmMin(() => {
	...
	VideoCard = ({ video }) => {
		const [titleLineCount, setTitleLineCount] = import_react$24.useState(2);
		const titleRef = import_react$24.useRef(null);
		...
		return (0, import_jsx_runtime$22.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$22.jsxs)("div", {
				...
				children: [
					...
					video.music && (0, import_jsx_runtime$22.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$22.jsx)("span", { children: "♫" }), (0, import_jsx_runtime$22.jsx)("span", {
						...
						children: (0, import_jsx_runtime$22.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$22.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$22.jsx)(AiFillHeart, { size: 34 }), (0, import_jsx_runtime$22.jsx)("span", { children: formatCount(video.statistics.like_count) })]
								}),
								(0, import_jsx_runtime$22.jsxs)("div", {
									className: "flex items-center gap-2 text-default-600",
									children: [(0, import_jsx_runtime$22.jsx)(FaCommentDots, { size: 34 }), (0, import_jsx_runtime$22.jsx)("span", { children: formatCount(video.statistics.comment_count) })]
								}),
								(0, import_jsx_runtime$22.jsxs)("div", {
									className: "flex items-center gap-2 text-default-600",
									children: [(0, import_jsx_runtime$22.jsx)(AiFillStar, { size: 34 }), (0, import_jsx_runtime$22.jsx)("span", { children: formatCount(video.statistics.collect_count) })]
								}),
								(0, import_jsx_runtime$22.jsxs)("div", {
									className: "flex items-center gap-2 text-default-600",
									children: [(0, import_jsx_runtime$22.jsx)(RiShareForwardFill, { size: 34 }), (0, import_jsx_runtime$22.jsx)("span", { children: formatCount(video.statistics.share_count) })]
								})
							]
						})
					})
	...
	DouyinUserVideoList = (prpos) => (0, import_jsx_runtime$22.jsxs)(DefaultLayout, {
		...prpos,
		children: [prpos.data.user.head_image && (0, import_jsx_runtime$22.jsxs)("div", {
			className: "relative w-full overflow-hidden",
			children: [(0, import_jsx_runtime$22.jsx)("img", {
				src: prpos.data.user.head_image,
				alt: "头部背景",
				className: "w-full h-auto object-cover"
			}), (0, import_jsx_runtime$22.jsx)("div", { className: "absolute inset-0 bg-linear-to-b from-transparent via-default-50/40 to-default-50" })]
		}), (0, import_jsx_runtime$22.jsx)("div", {
			...
			children: (0, import_jsx_runtime$22.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$22.jsx)("img", {
							...
							children: [
								(0, import_jsx_runtime$22.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$22.jsx)("h1", {
										className: "text-6xl font-bold text-default-900",
										children: prpos.data.user.nickname
									}), prpos.data.user.verified && (0, import_jsx_runtime$22.jsx)("span", {
								...
								(0, import_jsx_runtime$22.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$22.jsxs)("span", { children: ["抖音号：", prpos.data.user.short_id] }), prpos.data.user.ip_location && (0, import_jsx_runtime$22.jsx)("span", { children: prpos.data.user.ip_location })]
								}),
								(0, import_jsx_runtime$22.jsxs)("div", {
									className: "flex gap-8 text-3xl",
									children: [
										(0, import_jsx_runtime$22.jsxs)("div", { children: [(0, import_jsx_runtime$22.jsx)("span", {
				...
				}), prpos.data.videos.length > 0 ? (0, import_jsx_runtime$22.jsx)(import_jsx_runtime$22.Fragment, { children: (0, import_jsx_runtime$22.jsx)("div", {
					className: "grid grid-cols-2 gap-6 mb-8",
					children: prpos.data.videos.map((video) => (0, import_jsx_runtime$22.jsx)(VideoCard, { video }, video.aweme_id))
				}) }) : (0, import_jsx_runtime$22.jsx)("div", {
...
var UserList_exports$1 = __export({ default: () => UserList_default$1 }, 1), import_jsx_runtime$21, DouyinUserItem, DouyinUserList, UserList_default$1;
var init_UserList$1 = __esmMin(() => {
	...
	DouyinUserItem = (props) => (0, import_jsx_runtime$21.jsxs)("li", {
		...
		children: [(0, import_jsx_runtime$21.jsx)("img", {
			...
			children: [(0, import_jsx_runtime$21.jsxs)("div", {
				...
				}), (0, import_jsx_runtime$21.jsx)(chip_default, {
					color: props.switch ? "success" : "default",
					variant: "flat",
					size: "lg",
					startContent: (0, import_jsx_runtime$21.jsx)(Power, {
						className: "w-4 h-4",
						"aria-hidden": "true"
					}),
				...
				children: [
					(0, import_jsx_runtime$21.jsxs)("span", {
						...
						children: [(0, import_jsx_runtime$21.jsx)(Hash, {
					...
					(0, import_jsx_runtime$21.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$21.jsx)(Users, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$21.jsxs)("span", {
							className: "truncate",
					...
					(0, import_jsx_runtime$21.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$21.jsx)(UserPlus, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$21.jsxs)("span", {
							className: "truncate",
	...
	DouyinUserList = (prop) => (0, import_jsx_runtime$21.jsx)(DefaultLayout, {
		...prop,
		children: (0, import_jsx_runtime$21.jsxs)("div", {
			...
			}), (0, import_jsx_runtime$21.jsx)("ul", {
				className: "grid grid-cols-2 gap-7 list-none p-0",
				"aria-label": "抖音用户列表",
				children: prop.data.renderOpt.map((user, index) => (0, import_jsx_runtime$21.jsx)(DouyinUserItem, { ...user }, `${user.short_id}-${index}`))
			})]
		})
	});
...
var import_react$22, import_jsx_runtime$20, DEFAULT_MUSIC_COVER, formatNumber$3, formatDate$2, formatDuration, StatBlock, DouyinVideoInfo, videoInfo_default$1;
var init_videoInfo$1 = __esmMin(() => {
	...
	StatBlock = ({ label, value, icon }) => (0, import_jsx_runtime$20.jsxs)("div", {
	...
	DouyinVideoInfo = import_react$22.memo((props) => {
		const formattedDate = (0, import_react$22.useMemo)(() => formatDate$2(props.data.create_time), [props.data.create_time]);
		const duration = (0, import_react$22.useMemo)(() => props.data.video ? formatDuration(props.data.video.duration) : null, [props.data.video]);
		const mainTag = (0, import_react$22.useMemo)(() => "DOUYIN", []);
		const musicCover = (0, import_react$22.useMemo)(() => props.data.music?.cover || DEFAULT_MUSIC_COVER, [props.data.music?.cover]);
		const featureText = (0, import_react$22.useMemo)(() => props.data.video?.ratio?.toUpperCase() || "VIDEO", [props.data.video]);
		const { coverStyle, blurLayerStyle, contentStyle } = (0, import_react$22.useMemo)(() => {
					...
					(0, import_jsx_runtime$20.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$20.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$20.jsxs)("div", {
								...
								}), duration && (0, import_jsx_runtime$20.jsxs)("div", {
									className: "flex gap-3 items-center font-mono text-3xl font-medium",
									children: [(0, import_jsx_runtime$20.jsx)(Clock, { size: 40 }), (0, import_jsx_runtime$20.jsx)("span", { children: duration })]
								})]
							}), (0, import_jsx_runtime$20.jsx)("div", {
					...
					(0, import_jsx_runtime$20.jsxs)("div", {
						...
						children: [
							...
							(0, import_jsx_runtime$20.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$20.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$20.jsx)("img", {
										...
										children: (0, import_jsx_runtime$20.jsx)(Plus, {
											size: 26,
											strokeWidth: 3
										})
									})]
									...
									children: [(0, import_jsx_runtime$20.jsxs)("div", {
										...
										}), props.data.user_profile?.ip_location && (0, import_jsx_runtime$20.jsx)("span", {
										...
										children: [(0, import_jsx_runtime$20.jsxs)("span", { children: ["抖音号: ", props.data.author.short_id] }), props.data.user_profile && (0, import_jsx_runtime$20.jsxs)(import_jsx_runtime$20.Fragment, { children: [
											(0, import_jsx_runtime$20.jsx)("span", { children: "•" }),
											(0, import_jsx_runtime$20.jsxs)("span", { children: [formatNumber$3(props.data.user_profile.follower_count), " 粉丝"] }),
											(0, import_jsx_runtime$20.jsx)("span", { children: "•" }),
											(0, import_jsx_runtime$20.jsxs)("span", { children: [formatNumber$3(props.data.user_profile.total_favorited), " 获赞"] })
										] })]
									})]
								})]
							}),
							(0, import_jsx_runtime$20.jsxs)("div", {
								...
								children: [
									(0, import_jsx_runtime$20.jsx)(StatBlock, {
										label: "LIKES",
										value: props.data.statistics.digg_count,
										icon: (0, import_jsx_runtime$20.jsx)(Heart, {
											size: 48,
									...
									(0, import_jsx_runtime$20.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$20.jsx)("div", {
												...
												children: (0, import_jsx_runtime$20.jsx)(MessageCircle, {
													size: 42,
													className: "text-default-900"
												})
											}),
									...
									(0, import_jsx_runtime$20.jsx)(StatBlock, {
										...
										icon: (0, import_jsx_runtime$20.jsx)(Star, {
											size: 48,
											className: "text-default-900"
										})
									}),
									(0, import_jsx_runtime$20.jsx)(StatBlock, {
										...
										icon: (0, import_jsx_runtime$20.jsx)(Share2, {
											size: 48,
...
var import_react$21, import_jsx_runtime$19, DouyinQrcodeImg, qrcodeImg_default$1;
var init_qrcodeImg$1 = __esmMin(() => {
	init_lucide_react();
	import_react$21 = __toESM(require_react(), 1);
	init_DefaultLayout();
	import_jsx_runtime$19 = __toESM(require_jsx_runtime(), 1);
	DouyinQrcodeImg = import_react$21.memo((props) => {
		const disclaimer = [
			"免责声明:",
			...
			children: (0, import_jsx_runtime$19.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$19.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$19.jsxs)("div", {
							className: "flex gap-4 items-center",
							children: [(0, import_jsx_runtime$19.jsx)(QrCode, { className: "w-12 h-12 text-foreground-600" }), (0, import_jsx_runtime$19.jsx)("h1", {
								className: "text-6xl font-bold text-foreground",
								children: "抖音扫码登录"
							})]
						}), (0, import_jsx_runtime$19.jsxs)("div", {
							className: "flex gap-3 items-center text-3xl text-default-600",
							children: [(0, import_jsx_runtime$19.jsx)(Clock, { className: "w-8 h-8" }), (0, import_jsx_runtime$19.jsx)("span", { children: "请在120秒内通过抖音APP扫码进行登录" })]
						})]
					}),
					(0, import_jsx_runtime$19.jsx)("div", { className: "h-12" }),
					(0, import_jsx_runtime$19.jsx)("div", {
						...
						children: (0, import_jsx_runtime$19.jsx)("div", {
							...
							children: props.data.qrCodeDataUrl ? (0, import_jsx_runtime$19.jsx)("div", {
								...
								children: [(0, import_jsx_runtime$19.jsx)(QrCode, { className: "w-16 h-16 text-default-500" }), (0, import_jsx_runtime$19.jsx)("span", {
					...
					(0, import_jsx_runtime$19.jsx)("div", { className: "h-10" }),
					(0, import_jsx_runtime$19.jsxs)("div", {
						className: "p-8 rounded-3xl border-2 shadow-lg bg-warning-50 border-warning-200",
						children: [(0, import_jsx_runtime$19.jsxs)("h3", {
							className: "flex gap-4 items-center mb-6 text-4xl font-semibold text-warning-700",
							children: [(0, import_jsx_runtime$19.jsx)(Shield, { className: "w-10 h-10 text-warning-600" }), "注意事项与免责声明"]
						}), (0, import_jsx_runtime$19.jsx)("div", {
							className: "space-y-4",
							children: disclaimer.split("\n").map((line, index) => (0, import_jsx_runtime$19.jsx)("p", {
...
var import_react$20, import_jsx_runtime$18, processCommentHTML$1, ImageWithSkeleton, QRCodeSection$1, VideoInfoHeader, CommentItemComponent$1, BilibiliComment, Comment_default$2;
var init_Comment$2 = __esmMin(() => {
	...
	ImageWithSkeleton = ({ src, alt, className = "", placeholder }) => {
		const [hasError, setHasError] = (0, import_react$20.useState)(false);
		const handleError = () => {
			setHasError(true);
		};
		...
		if (hasError) return (0, import_jsx_runtime$18.jsx)("div", {
		...
		return (0, import_jsx_runtime$18.jsx)("img", {
			src,
			alt,
	...
	QRCodeSection$1 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$18.jsx)("div", {
		className: "flex flex-col items-center",
		children: (0, import_jsx_runtime$18.jsx)("div", {
			className: "flex justify-center items-center w-[400px] h-[400px] p-4",
			children: qrCodeDataUrl ? (0, import_jsx_runtime$18.jsx)("img", {
				src: qrCodeDataUrl,
				alt: "二维码",
				className: "object-contain w-full h-full rounded-lg"
	...
	VideoInfoHeader = (props) => (0, import_jsx_runtime$18.jsx)("div", {
		className: "max-w-[1400px] mx-auto px-10 py-8",
			...
			children: [(0, import_jsx_runtime$18.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$18.jsx)("div", {
					...
					children: (0, import_jsx_runtime$18.jsxs)("div", {
						...
						}), props.Type === "视频" && props.Resolution && (0, import_jsx_runtime$18.jsxs)("div", {
					...
					children: [
						...
						(0, import_jsx_runtime$18.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$18.jsx)("span", {
								className: "flex-shrink-0 mr-4 text-foreground-400",
								children: "评论"
							}), (0, import_jsx_runtime$18.jsxs)("span", {
								className: "font-medium text-foreground-600",
								children: [props.CommentLength, "条"]
							})]
						}),
						props.Type === "视频" ? (0, import_jsx_runtime$18.jsxs)(import_jsx_runtime$18.Fragment, { children: [(0, import_jsx_runtime$18.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text whitespace-nowrap",
							children: [(0, import_jsx_runtime$18.jsx)("span", {
								className: "flex-shrink-0 mr-4 text-foreground-400",
								children: "大小"
						...
						})] }) : (0, import_jsx_runtime$18.jsx)(import_jsx_runtime$18.Fragment, { children: (0, import_jsx_runtime$18.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text whitespace-nowrap",
							children: [(0, import_jsx_runtime$18.jsx)("span", {
								className: "flex-shrink-0 mr-4 text-foreground-400",
								children: "图片"
				...
				className: "flex-shrink-0",
				children: (0, import_jsx_runtime$18.jsx)(QRCodeSection$1, { qrCodeDataUrl: props.qrCodeDataUrl })
			})]
		})
	});
	CommentItemComponent$1 = ({ isLast = false, ...props }) => (0, import_jsx_runtime$18.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$18.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$18.jsx)(ImageWithSkeleton, {
				...
				props.frame && (0, import_jsx_runtime$18.jsx)(ImageWithSkeleton, {
					src: props.frame,
					alt: "头像框",
					className: "absolute inset-0 transform scale-120",
					placeholder: "头像框"
				}),
				props.vipstatus === 1 && (0, import_jsx_runtime$18.jsx)("div", {
			...
			children: [
					...
					children: [
						(0, import_jsx_runtime$18.jsxs)("div", {
							...
							children: [
								...
								props.level !== void 0 && props.level >= 0 && props.level <= 7 && (0, import_jsx_runtime$18.jsx)("img", {
									src: `/image/bilibili/level/lv${props.level}.svg`,
									alt: `等级${props.level}`,
									className: "inline-block flex-shrink-0 w-24 h-24 align-middle"
								}),
								props.isUP && (0, import_jsx_runtime$18.jsx)("img", {
						...
						props.fanCard && props.fanCard.image && (0, import_jsx_runtime$18.jsx)("div", {
						...
						props.label_type === 1 && (0, import_jsx_runtime$18.jsx)("div", {
						...
						props.status_label && (0, import_jsx_runtime$18.jsx)("div", {
				...
				(props.img_src || props.sticker) && (0, import_jsx_runtime$18.jsx)("div", {
					className: "flex my-5 overflow-hidden rounded-[25px] w-[95%] shadow-large",
					children: (0, import_jsx_runtime$18.jsx)(ImageWithSkeleton, {
					...
					children: [(0, import_jsx_runtime$18.jsx)("div", {
						...
						children: (0, import_jsx_runtime$18.jsxs)("div", {
							...
							children: [
								...
								" · ",
								props.location,
								props.replylength > 0 ? (0, import_jsx_runtime$18.jsxs)("span", {
						...
						children: (0, import_jsx_runtime$18.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$18.jsx)(ThumbsUp, { className: "w-[60px] h-[60px] text-foreground-500" }), (0, import_jsx_runtime$18.jsx)("span", {
				...
				props.replies && props.replies.length > 0 && (0, import_jsx_runtime$18.jsx)("div", {
					className: "mt-10",
					children: props.replies.map((subReply, index) => (0, import_jsx_runtime$18.jsx)("div", { children: (0, import_jsx_runtime$18.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$18.jsxs)("div", {
							...
							children: [
								...
								subReply.frame && (0, import_jsx_runtime$18.jsx)(ImageWithSkeleton, {
									src: subReply.frame,
									alt: "头像框",
									className: "absolute inset-0 transform scale-90",
									placeholder: "头像框"
								}),
								subReply.vipstatus === 1 && (0, import_jsx_runtime$18.jsx)("div", {
							...
							children: [
								(0, import_jsx_runtime$18.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$18.jsxs)("div", {
										...
										children: [
											...
											subReply.level !== void 0 && subReply.level >= 0 && subReply.level <= 7 && (0, import_jsx_runtime$18.jsx)("img", {
												src: `/image/bilibili/level/lv${subReply.level}.svg`,
												alt: `等级${subReply.level}`,
												className: "inline-block flex-shrink-0 w-24 h-24 align-middle"
											}),
											subReply.isUP && (0, import_jsx_runtime$18.jsx)("img", {
												src: "/image/bilibili/up_pb.svg",
												alt: "UP主标签",
												className: "inline-block flex-shrink-0 align-middle w-23 h-23"
											})
										]
									}), subReply.fanCard && subReply.fanCard.image && (0, import_jsx_runtime$18.jsx)("div", {
										className: "absolute -top-10 right-0 h-[180px] z-10 pointer-events-none",
										children: (0, import_jsx_runtime$18.jsxs)("div", {
											className: "inline-block relative h-full",
											children: [(0, import_jsx_runtime$18.jsx)("img", {
								...
								subReply.img_src && (0, import_jsx_runtime$18.jsx)("div", {
									className: "flex my-5 overflow-hidden rounded-[25px] w-[95%] shadow-large",
									children: (0, import_jsx_runtime$18.jsx)(ImageWithSkeleton, {
	...
	BilibiliComment = import_react$20.memo((props) => {
		const processedData = (0, import_react$20.useMemo)(() => {
		...
		return (0, import_jsx_runtime$18.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$18.jsxs)("div", {
				className: "p-5",
				children: [
					(0, import_jsx_runtime$18.jsx)("div", { className: "h-20" }),
					(0, import_jsx_runtime$18.jsx)(VideoInfoHeader, {
						...processedData,
						qrCodeDataUrl: props.qrCodeDataUrl
					}),
					(0, import_jsx_runtime$18.jsx)("div", {
						className: "overflow-hidden mt-8",
						children: processedData.CommentsData.length > 0 ? processedData.CommentsData.map((comment, index) => (0, import_jsx_runtime$18.jsx)(CommentItemComponent$1, {
							isLast: index === processedData.CommentsData.length - 1,
							...comment
						}, index)) : (0, import_jsx_runtime$18.jsx)("div", {
							className: "flex justify-center items-center py-20 text-foreground-400",
							children: (0, import_jsx_runtime$18.jsx)("div", {
								className: "text-center",
...
var import_react$19, import_jsx_runtime$17, processCommentHTML, CommentText, EnhancedImage, proxyImageUrl, processHtmlImages, DecorationCard;
var init_shared = __esmMin(() => {
	...
	CommentText = ({ content, className, style }) => (0, import_jsx_runtime$17.jsx)("div", {
		className,
		style,
	...
	EnhancedImage = ({ src, alt, className = "", placeholder, isCircular = false }) => {
		...
		if (!src || hasError) return (0, import_jsx_runtime$17.jsx)("div", {
	...
	DecorationCard = ({ html }) => (0, import_jsx_runtime$17.jsx)("div", {
		className: "font-bilifont",
		dangerouslySetInnerHTML: { __html: processHtmlImages(html) }
	});
});
var UserList_exports = __export({ default: () => UserList_default }, 1), import_jsx_runtime$16, BilibiliUserItem, BilibiliUserList, UserList_default;
var init_UserList = __esmMin(() => {
	...
	BilibiliUserItem = (props) => (0, import_jsx_runtime$16.jsxs)("li", {
		className: "flex items-center p-8 gap-8 rounded-3xl shadow-large bg-content1 select-text",
		children: [(0, import_jsx_runtime$16.jsx)(EnhancedImage, {
			...
			children: [(0, import_jsx_runtime$16.jsxs)("div", {
				className: "flex items-center gap-5 mb-3",
				children: [(0, import_jsx_runtime$16.jsxs)("span", {
					className: "text-4xl font-medium text-foreground select-text inline-flex items-center gap-2.5 truncate",
					children: [(0, import_jsx_runtime$16.jsx)(User, {
						className: "w-8 h-8 opacity-80 flex-shrink-0",
						"aria-hidden": "true"
				...
				}), (0, import_jsx_runtime$16.jsx)(chip_default, {
					color: props.switch ? "success" : "default",
					variant: "flat",
					size: "lg",
					startContent: (0, import_jsx_runtime$16.jsx)(Power, {
						className: "w-5 h-5",
						"aria-hidden": "true"
					}),
					className: "flex-shrink-0",
				...
				children: [
					...
					(0, import_jsx_runtime$16.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$16.jsx)(UserPlus, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$16.jsxs)("span", {
							className: "truncate",
	...
	BilibiliUserList = (prop) => (0, import_jsx_runtime$16.jsx)(DefaultLayout, {
		...prop,
		children: (0, import_jsx_runtime$16.jsxs)("div", {
			className: "w-full px-10 py-16",
			children: [(0, import_jsx_runtime$16.jsxs)("div", {
				className: "mb-8 p-7 rounded-3xl bg-content2 shadow-medium",
				children: [
					(0, import_jsx_runtime$16.jsx)("h2", {
						className: "text-5xl font-bold text-foreground mb-2 select-text",
						children: prop.data.groupInfo.groupName
					}),
			...
			}), (0, import_jsx_runtime$16.jsx)("ul", {
				className: "grid grid-cols-2 gap-7 list-none p-0",
				"aria-label": "B站用户列表",
				children: prop.data.renderOpt.map((user, index) => (0, import_jsx_runtime$16.jsx)(BilibiliUserItem, { ...user }, `${user.host_mid}-${index}`))
			})]
		})
	});
...
var import_react$17, import_jsx_runtime$15, formatNumber$2, formatDateParts, formatDateTime, BangumiBilibiliHeader, BangumiBilibiliEpisodes, BangumiBilibili, bangumi_default;
var init_bangumi = __esmMin(() => {
			...
			children: (0, import_jsx_runtime$15.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$15.jsxs)("div", {
					...
					children: [
						...
						props.upInfo && (0, import_jsx_runtime$15.jsxs)("div", {
							className: "flex gap-12 items-center mt-15",
							children: [(0, import_jsx_runtime$15.jsxs)("div", {
								className: "relative",
								children: [
									(0, import_jsx_runtime$15.jsx)(EnhancedImage, {
									...
									props.upInfo.avatar_subscript_url && (0, import_jsx_runtime$15.jsx)(EnhancedImage, {
										className: "absolute -right-1 -bottom-1 w-8 h-8 select-text",
										src: props.upInfo.avatar_subscript_url,
										alt: "头像角标"
									}),
									props.upInfo.pendant?.image && (0, import_jsx_runtime$15.jsx)(EnhancedImage, {
								...
								children: [
									(0, import_jsx_runtime$15.jsxs)("div", {
										...
										children: [
											...
											props.upInfo.verify_type > 0 && (0, import_jsx_runtime$15.jsx)("div", {
												className: "flex items-center",
												children: props.upInfo.verify_type === 1 ? (0, import_jsx_runtime$15.jsx)(Shield, {
													size: 20,
													className: "text-warning"
												}) : (0, import_jsx_runtime$15.jsx)(Crown, {
													size: 20,
													className: "text-primary"
												})
											}),
											props.upInfo.vip_status === 1 && props.upInfo.vip_label?.text && (0, import_jsx_runtime$15.jsx)(chip_default, {
												size: "sm",
									...
									(0, import_jsx_runtime$15.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$15.jsx)(Users, { size: 30 }),
											(0, import_jsx_runtime$15.jsxs)("span", { children: [formatNumber$2(props.upInfo.follower), "粉丝"] }),
											props.upInfo.is_follow === 1 && (0, import_jsx_runtime$15.jsx)(chip_default, {
												size: "sm",
												color: "primary",
												variant: "flat",
									...
									(0, import_jsx_runtime$15.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$15.jsx)(Hash, { size: 20 }), (0, import_jsx_runtime$15.jsxs)("span", { children: ["UID: ", props.upInfo.mid] })]
									})
								]
							})]
						}),
						(0, import_jsx_runtime$15.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$15.jsx)("span", { children: "提示：请在120秒内发送" }),
								(0, import_jsx_runtime$15.jsx)(code_default, {
									size: "lg",
									color: "danger",
									children: " 第 ？ 集 "
								}),
								(0, import_jsx_runtime$15.jsx)("span", { children: "选择集数" })
							]
						})
					]
				}), (0, import_jsx_runtime$15.jsxs)("div", {
					className: "flex flex-col flex-1 justify-between text-foreground",
					children: [(0, import_jsx_runtime$15.jsxs)("div", { children: [
						(0, import_jsx_runtime$15.jsx)("div", {
							className: "mb-8 text-8xl font-bold leading-tight select-text",
							children: props.title
						}),
						props.subtitle && (0, import_jsx_runtime$15.jsx)("div", {
							className: "mb-12 text-4xl select-text text-foreground",
							children: props.subtitle
						}),
						props.styles && props.styles.length > 0 && (0, import_jsx_runtime$15.jsx)("div", {
							className: "flex flex-wrap gap-8 mb-12",
							children: props.styles.map((style, index) => (0, import_jsx_runtime$15.jsx)(chip_default, {
								radius: "sm",
								size: "lg",
						...
						actorList.length > 0 && (0, import_jsx_runtime$15.jsxs)("div", {
							className: "mb-12",
							children: [(0, import_jsx_runtime$15.jsxs)("div", {
								className: "flex gap-6 items-center mb-6 text-3xl select-text text-foreground",
								children: [(0, import_jsx_runtime$15.jsx)(Users, { size: 30 }), (0, import_jsx_runtime$15.jsx)("span", { children: "声优阵容" })]
							}), (0, import_jsx_runtime$15.jsxs)("div", {
								className: "flex flex-wrap gap-8",
								children: [actorList.slice(0, 6).map((actor, index) => (0, import_jsx_runtime$15.jsx)("div", {
									className: "text-3xl select-text text-foreground",
									children: actor
								}, index)), actorList.length > 6 && (0, import_jsx_runtime$15.jsxs)("div", {
									className: "text-3xl select-text text-foreground",
									children: [
										"等",
										actorList.length,
						...
						props.evaluate && (0, import_jsx_runtime$15.jsxs)("div", {
							className: "mb-12",
							children: [(0, import_jsx_runtime$15.jsxs)("div", {
								className: "flex gap-6 items-center mb-6 text-3xl select-text text-foreground",
								children: [(0, import_jsx_runtime$15.jsx)(Star, { size: 30 }), (0, import_jsx_runtime$15.jsx)("span", { children: "评价" })]
							}), (0, import_jsx_runtime$15.jsx)("div", {
	...
	BangumiBilibiliEpisodes = (props) => {
		...
		return (0, import_jsx_runtime$15.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$15.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$15.jsx)(Play, { size: 46 }),
					(0, import_jsx_runtime$15.jsx)("span", { children: "剧集列表" }),
					(0, import_jsx_runtime$15.jsxs)(chip_default, {
						size: "lg",
						color: "danger",
						variant: "flat",
			...
			}), (0, import_jsx_runtime$15.jsx)("div", { children: flattenedEpisodes.map((item) => {
				...
				return (0, import_jsx_runtime$15.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$15.jsx)("div", {
						...
						children: isFirstOfDate ? (0, import_jsx_runtime$15.jsxs)(import_jsx_runtime$15.Fragment, { children: [
							(0, import_jsx_runtime$15.jsx)("div", {
							...
							!isLastOfAll && (0, import_jsx_runtime$15.jsx)("div", { className: clsx_default("mt-8 w-1 bg-divider", episodesInSameDate > 1 ? "h-110" : "h-95") })
						] }) : (0, import_jsx_runtime$15.jsxs)(import_jsx_runtime$15.Fragment, { children: [
							(0, import_jsx_runtime$15.jsx)("div", { className: "w-1 h-10 bg-divider" }),
							(0, import_jsx_runtime$15.jsx)("div", { className: "my-2 w-4 h-4 rounded-full bg-divider" }),
							(!isLastOfAll || episodesInSameDate > 1) && (0, import_jsx_runtime$15.jsx)("div", { className: clsx_default("w-1 bg-divider", isLastOfDate ? "h-110" : "h-130") })
						] })
					}), (0, import_jsx_runtime$15.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$15.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$15.jsx)("div", {
									...
									children: [(0, import_jsx_runtime$15.jsx)("div", {
										...
										children: [(0, import_jsx_runtime$15.jsx)(Calendar, { size: 30 }), (0, import_jsx_runtime$15.jsx)("span", { children: "发布了内容" })]
									})]
								})]
							}), (0, import_jsx_runtime$15.jsx)("div", {
								...
								children: [(0, import_jsx_runtime$15.jsx)("div", {
									...
									children: (0, import_jsx_runtime$15.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$15.jsx)(EnhancedImage, {
											...
											className: "object-cover w-full h-full select-text"
										}), episode.badge && (0, import_jsx_runtime$15.jsx)(chip_default, {
											radius: "lg",
											size: "lg",
									...
									children: [(0, import_jsx_runtime$15.jsx)("div", {
										...
										children: [
											(0, import_jsx_runtime$15.jsxs)("div", {
												...
												children: [(0, import_jsx_runtime$15.jsx)(Hash, { size: 36 }), (0, import_jsx_runtime$15.jsx)("span", {
													className: "truncate",
											...
											(0, import_jsx_runtime$15.jsxs)("div", {
												className: "flex gap-6 items-center select-text text-foreground-600",
												children: [(0, import_jsx_runtime$15.jsx)(Clock, { size: 36 }), (0, import_jsx_runtime$15.jsx)("span", {
											...
											(0, import_jsx_runtime$15.jsxs)("div", {
												className: "flex gap-6 items-center select-text text-foreground-600",
												children: [(0, import_jsx_runtime$15.jsx)(Share2, { size: 36 }), (0, import_jsx_runtime$15.jsx)("span", {
													className: "truncate",
	...
	BangumiBilibili = import_react$17.memo((props) => (0, import_jsx_runtime$15.jsx)(DefaultLayout, {
		...props,
		children: (0, import_jsx_runtime$15.jsxs)("div", {
			className: "p-4",
			children: [(0, import_jsx_runtime$15.jsx)(BangumiBilibiliHeader, {
			...
			}), (0, import_jsx_runtime$15.jsx)(BangumiBilibiliEpisodes, { ...props.data })]
		})
	}));
...
var import_react$16, import_jsx_runtime$14, BilibiliDynamicUserInfo, BilibiliDynamicContent, BilibiliDynamicStatus, BilibiliDynamicFooter, BilibiliDrawDynamic, DYNAMIC_TYPE_DRAW_default;
var init_DYNAMIC_TYPE_DRAW = __esmMin(() => {
	...
	BilibiliDynamicUserInfo = (props) => (0, import_jsx_runtime$14.jsxs)("div", {
		...
		children: [
			...
			props.decoration_card && (0, import_jsx_runtime$14.jsx)("div", {
				className: "pl-40",
				children: (0, import_jsx_runtime$14.jsx)("div", { dangerouslySetInnerHTML: { __html: props.decoration_card } })
			})
		]
	});
	BilibiliDynamicContent = (props) => {
		...
		return (0, import_jsx_runtime$14.jsxs)(import_jsx_runtime$14.Fragment, { children: [(0, import_jsx_runtime$14.jsxs)("div", {
		...
		}), props.image_url && Array.isArray(props.image_url) && props.image_url.length > 0 && (0, import_jsx_runtime$14.jsxs)("div", {
			className: "px-20",
			children: [
				layoutType === "grid" && (0, import_jsx_runtime$14.jsx)("div", {
					className: "grid grid-cols-3 gap-4 w-full",
					children: props.image_url.slice(0, 9).map((img, index) => (0, import_jsx_runtime$14.jsx)("div", {
				...
				layoutType === "waterfall" && (0, import_jsx_runtime$14.jsxs)("div", {
				...
				layoutType === "vertical" && props.image_url.map((img, index) => (0, import_jsx_runtime$14.jsxs)(import_react$16.Fragment, { children: [(0, import_jsx_runtime$14.jsx)("div", {
					className: "flex flex-col items-center",
					children: (0, import_jsx_runtime$14.jsx)("div", {
				...
				}), (0, import_jsx_runtime$14.jsx)("div", { className: "h-18" })] }, index)),
				(layoutType === "waterfall" || layoutType === "grid") && (0, import_jsx_runtime$14.jsx)("div", { className: "h-18" })
			]
		})] });
	};
	...
	BilibiliDrawDynamic = import_react$16.memo((props) => (0, import_jsx_runtime$14.jsx)(DefaultLayout, {
		...props,
		children: (0, import_jsx_runtime$14.jsxs)("div", {
			className: "p-4",
			children: [
				...
				(0, import_jsx_runtime$14.jsx)("div", { className: "h-15" }),
				(0, import_jsx_runtime$14.jsx)(BilibiliDynamicContent, {
					...
					children: [
						...
						(0, import_jsx_runtime$13.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$13.jsx)(LuFullscreen, {
								size: 32,
								className: "text-time"
							}), (0, import_jsx_runtime$13.jsxs)("span", { children: ["图片生成于: ", format(/* @__PURE__ */ new Date(), "yyyy-MM-dd HH:mm:ss")] })]
						}),
						(0, import_jsx_runtime$13.jsxs)("div", {
							className: "flex gap-3 items-center",
	...
	BilibiliArticleUserInfo = import_react$12.memo((props) => (0, import_jsx_runtime$10.jsxs)("div", {
		...
		children: [
			...
			props.data.decoration_card && (0, import_jsx_runtime$10.jsx)("div", {
				className: "pl-40",
				children: (0, import_jsx_runtime$10.jsx)("div", { dangerouslySetInnerHTML: { __html: props.data.decoration_card.card_url } })
			})
		]
	}));
				...
				children: [
					(0, import_jsx_runtime$9.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$9.jsx)(EnhancedImage, {
							...
							className: "object-cover w-full h-full",
							placeholder: "视频封面"
						}), (0, import_jsx_runtime$9.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t to-transparent from-black/20" })]
					}),
					(0, import_jsx_runtime$9.jsxs)("div", {
					...
					(0, import_jsx_runtime$9.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$9.jsxs)("div", {
							...
							children: (0, import_jsx_runtime$9.jsxs)(button_default, {
								...
								children: [(0, import_jsx_runtime$9.jsx)(ExternalLink, { className: "mr-1 w-4 h-4" }), "观看"]
							})
						})]
					})
				]
			...
			children: (0, import_jsx_runtime$8.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$8.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$8.jsxs)("div", {
							className: "flex gap-4 items-center",
							children: [(0, import_jsx_runtime$8.jsx)(QrCode, { className: "w-12 h-12 text-foreground-600" }), (0, import_jsx_runtime$8.jsx)("h1", {
								className: "text-6xl font-bold text-foreground",
								children: "B站扫码登录"
							})]
						}), (0, import_jsx_runtime$8.jsxs)("div", {
							className: "flex gap-3 items-center text-3xl text-default-600",
							children: [(0, import_jsx_runtime$8.jsx)(Clock, { className: "w-8 h-8" }), (0, import_jsx_runtime$8.jsx)("span", { children: "请在120秒内通过哔哩哔哩APP扫码进行登录" })]
						})]
					}),
					(0, import_jsx_runtime$8.jsx)("div", { className: "h-12" }),
					(0, import_jsx_runtime$8.jsx)("div", {
						className: "flex flex-col items-center",
						children: (0, import_jsx_runtime$8.jsxs)("div", {
							className: "flex overflow-hidden flex-col justify-center items-center p-12",
							children: [qrCodeDataUrl ? (0, import_jsx_runtime$8.jsx)("div", {
								className: "flex justify-center items-center w-120 h-120",
								...
								className: "flex flex-col gap-4 justify-center items-center w-120 h-120",
								children: [(0, import_jsx_runtime$8.jsx)(QrCode, { className: "w-16 h-16 text-default-500" }), (0, import_jsx_runtime$8.jsx)("span", {
									className: "text-2xl text-default-500",
									children: "未提供二维码图片"
								})]
							}), (0, import_jsx_runtime$8.jsxs)("div", {
								...
								}), (0, import_jsx_runtime$8.jsx)("pre", {
					...
					(0, import_jsx_runtime$8.jsxs)("div", {
						className: "p-8 rounded-3xl border-2 shadow-lg bg-warning-50 border-warning-200",
						children: [(0, import_jsx_runtime$8.jsxs)("h3", {
							className: "flex gap-4 items-center mb-6 text-4xl font-semibold text-warning-700",
							children: [(0, import_jsx_runtime$8.jsx)(Shield, { className: "w-10 h-10 text-warning-600" }), "注意事项与免责声明"]
						}), (0, import_jsx_runtime$8.jsx)("div", {
							className: "space-y-4",
							children: disclaimer.split("\n").map((line, index) => (0, import_jsx_runtime$8.jsx)("p", {
								className: `text-2xl leading-relaxed ${index === 0 ? "font-semibold text-warning-700" : "text-foreground-600"}`,
								children: line
							}, index))
						})]
		...
		children: (0, import_jsx_runtime$7.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$7.jsx)("div", {
				...
				children: [
					...
					type === "视频" && (0, import_jsx_runtime$7.jsxs)(import_jsx_runtime$7.Fragment, { children: [
						(0, import_jsx_runtime$7.jsxs)("div", {
							className: "flex items-center p-2.5 tracking-[6px] text-[45px] text-left",
							children: [
								"视频大小：",
					...
					type === "图集" && (0, import_jsx_runtime$7.jsxs)("div", {
						className: "flex items-center p-2.5 tracking-[6px] text-[45px] text-left",
						children: [
							"图片数量：",
							imageLength,
				...
				children: [
					(0, import_jsx_runtime$6.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$6.jsx)("img", {
							...
							alt: props.data.desc,
							className: "object-cover w-full h-full"
						}), (0, import_jsx_runtime$6.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t to-transparent from-black/30" })]
					}),
					(0, import_jsx_runtime$6.jsxs)("div", {
						className: "p-20 pb-36",
						children: [
					...
					(0, import_jsx_runtime$6.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$6.jsxs)("div", {
							...
							children: (0, import_jsx_runtime$6.jsx)(button_default, {
								...
								children: (0, import_jsx_runtime$6.jsxs)("div", {
									className: "flex items-center",
									children: [(0, import_jsx_runtime$6.jsx)(ExternalLink, { className: "mr-1 w-4 h-4" }), (0, import_jsx_runtime$6.jsx)("span", { children: "查看原文" })]
								})
							})
						})]
					})
		...
		children: [(0, import_jsx_runtime$5.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$5.jsx)("div", {
				...
				children: [
					...
					type === "图文" && imageLength && (0, import_jsx_runtime$5.jsxs)("div", {
						className: "tracking-[6px] text-[45px] select-text",
						children: [
							"图片数量：",
							imageLength,
...
var import_react$6, import_jsx_runtime$4, ICON_MAP, MenuItemComponent, MenuGroupComponent, Help, Help_default;
var init_Help = __esmMin(() => {
	...
	MenuItemComponent = ({ item }) => (0, import_jsx_runtime$4.jsx)(SmartGlowBorder, {
		className: "block",
		...
		children: (0, import_jsx_runtime$4.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$4.jsx)("div", {
				...
				children: (0, import_jsx_runtime$4.jsx)(GlowIcon, {
	...
	MenuGroupComponent = ({ group, startIndex }) => {
		...
		return (0, import_jsx_runtime$4.jsx)("div", {
			className: "px-10 py-10 rounded-2xl bg-muted/50",
			children: (0, import_jsx_runtime$4.jsxs)("div", { children: [
	...
	Help = import_react$6.memo((props) => {
		...
		return (0, import_jsx_runtime$4.jsxs)(DefaultLayout, {
			...
			children: [
				...
				(0, import_jsx_runtime$4.jsx)("div", { className: "h-8" }),
				(0, import_jsx_runtime$4.jsx)("div", {
...
var import_react$5, import_jsx_runtime$3, ansiColorMap, ansi256ToColor, convertAnsiToHtml, seededRandom, generateBugPositions, getLogLevelTheme, ADAPTER_LOGO_MAP, getAdapterLogo, ErrorHeader, VerificationQrCode, BusinessErrorDetails, handlerError, handlerError_default;
var init_handlerError = __esmMin(() => {
	...
	getAdapterLogo = (adapterName) => {
		...
		return (0, import_jsx_runtime$3.jsx)(Plug2, { className: "w-9 h-9 text-secondary" });
	};
	ErrorHeader = ({ method, timestamp, businessName }) => {
		const displayMethod = businessName || method;
		const errorEmojiUrl = import_react$5.useMemo(() => {
			const withoutSuffix = [
				343,
				1,
				342,
		...
		const errorTitle = import_react$5.useMemo(() => {
			const titles = [
				"哎呀！出错啦~",
				"糟糕，翻车了！",
				"呜呜，坏掉惹",
						...
						children: [
							...
							(0, import_jsx_runtime$3.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$3.jsx)("div", {
									...
									className: "flex gap-3 items-center",
									children: [(0, import_jsx_runtime$3.jsx)(Clock, { className: "w-10 h-10 text-warning" }), (0, import_jsx_runtime$3.jsx)("span", {
	...
	VerificationQrCode = ({ qrCodeDataUrl, verificationUrl }) => {
		...
		return (0, import_jsx_runtime$3.jsx)("div", {
			...
			children: (0, import_jsx_runtime$3.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$3.jsxs)("h3", {
					className: "flex gap-3 items-center mb-6 text-4xl font-medium text-foreground",
					children: [(0, import_jsx_runtime$3.jsx)(QrCode, { className: "w-10 h-10 text-warning" }), "人机验证"]
				}), (0, import_jsx_runtime$3.jsx)("div", {
						...
						children: [(0, import_jsx_runtime$3.jsx)("div", {
							...
							children: [
								...
								(0, import_jsx_runtime$3.jsxs)("div", {
									...
									children: [
										(0, import_jsx_runtime$3.jsx)("p", { children: "1. 使用手机扫描左侧二维码" }),
										(0, import_jsx_runtime$3.jsx)("p", { children: "2. 在网页中完成人机验证" }),
										(0, import_jsx_runtime$3.jsx)("p", { children: "3. 将验证结果发送至此对话" })
									]
								}),
								verificationUrl && (0, import_jsx_runtime$3.jsx)("div", {
	...
	BusinessErrorDetails = ({ error, logs, triggerCommand }) => (0, import_jsx_runtime$3.jsx)("div", {
		className: "w-full max-w-[1440px] mx-auto px-20 py-8",
		children: (0, import_jsx_runtime$3.jsxs)("div", {
			className: "space-y-12",
			children: [
				triggerCommand && (0, import_jsx_runtime$3.jsxs)("div", {
					className: "pl-8 border-l-2 border-default-200",
					children: [(0, import_jsx_runtime$3.jsxs)("h3", {
						className: "flex gap-3 items-center mb-8 text-4xl font-medium text-foreground",
						children: [(0, import_jsx_runtime$3.jsx)(Terminal, { className: "w-10 h-10" }), "触发命令"]
					}), (0, import_jsx_runtime$3.jsx)("div", {
				...
				(0, import_jsx_runtime$3.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$3.jsxs)("h3", {
						...
						children: [(0, import_jsx_runtime$3.jsx)(CircleAlert, { className: "w-8 h-8" }), "错误堆栈"]
					}), (0, import_jsx_runtime$3.jsx)("div", {
				...
				logs && logs.length > 0 && (0, import_jsx_runtime$3.jsxs)("div", {
					className: "pl-8 border-l-2 border-default-200",
					children: [(0, import_jsx_runtime$3.jsxs)("h3", {
						className: "flex gap-3 items-center mb-6 text-3xl font-medium text-foreground",
						children: [(0, import_jsx_runtime$3.jsx)(FileText, { className: "w-8 h-8" }), "相关执行日志"]
					}), (0, import_jsx_runtime$3.jsx)("div", {
						className: "space-y-3",
	...
	handlerError = (props) => {
		...
		const bugPositions = import_react$5.useMemo(() => generateBugPositions(50), []);
		return (0, import_jsx_runtime$3.jsxs)(DefaultLayout, {
			...props,
			children: [(0, import_jsx_runtime$3.jsx)("div", {
				className: "overflow-hidden fixed inset-0 pointer-events-none",
				style: { zIndex: 0 },
				children: bugPositions.map((pos, index) => (0, import_jsx_runtime$3.jsx)(FaBug, {
					className: "absolute",
					style: {
						width: `${pos.size}px`,
						height: `${pos.size}px`,
				...
				style: { zIndex: 1 },
				children: [
					(0, import_jsx_runtime$3.jsx)("div", { className: "h-[60px]" }),
					(0, import_jsx_runtime$3.jsx)(ErrorHeader, {
						type,
						platform,
						method,
						timestamp,
					...
					isVerification && (0, import_jsx_runtime$3.jsx)(VerificationQrCode, {
						qrCodeDataUrl,
						verificationUrl
					}),
					(0, import_jsx_runtime$3.jsx)(BusinessErrorDetails, {
						error: businessError,
						logs,
						triggerCommand
					}),
					(0, import_jsx_runtime$3.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$3.jsxs)("div", {
							...
							children: [
									...
									children: [
										(0, import_jsx_runtime$3.jsxs)("div", {
											...
											children: [(0, import_jsx_runtime$3.jsx)("img", {
												src: "/image/frame-logo.png",
												className: "h-auto w-17"
											}), (0, import_jsx_runtime$3.jsxs)("div", { children: [(0, import_jsx_runtime$3.jsx)("div", {
										...
										amagiVersion && (0, import_jsx_runtime$3.jsxs)("div", {
											className: "flex gap-4 items-center",
											children: [(0, import_jsx_runtime$3.jsx)("img", {
								...
								adapterInfo && (0, import_jsx_runtime$3.jsxs)("div", {
									className: "flex gap-4 items-center",
									children: [getAdapterLogo(adapterInfo.name), (0, import_jsx_runtime$3.jsxs)("div", { children: [(0, import_jsx_runtime$3.jsxs)("div", {
										className: "inline-flex gap-2 items-center text-2xl text-default-400",
										children: [(0, import_jsx_runtime$3.jsx)("span", { children: "适配器名称" }), (0, import_jsx_runtime$3.jsx)(chip_default, {
											color: "secondary",
											variant: "flat",
											size: "md",
											children: (0, import_jsx_runtime$3.jsx)("span", {
								...
								(0, import_jsx_runtime$3.jsxs)("div", {
									...
									children: [data.buildTime && (0, import_jsx_runtime$3.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$3.jsx)(MdAccessTime, { className: "w-5 h-5" }), (0, import_jsx_runtime$3.jsxs)("span", { children: ["插件编译于 ", data.buildTime] })]
									}), data.commitHash && (0, import_jsx_runtime$3.jsxs)("div", {
										className: "flex gap-2 items-center text-2xl text-default-400",
										children: [(0, import_jsx_runtime$3.jsx)(FaCodeBranch, { className: "w-5 h-5" }), (0, import_jsx_runtime$3.jsxs)("span", { children: ["Commit ", data.commitHash] })]
									})]
								})
							]
						}), (0, import_jsx_runtime$3.jsxs)("div", {
							...
							children: [
								...
								(0, import_jsx_runtime$3.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$3.jsx)("p", {
										...
										className: "space-y-3",
										children: [(0, import_jsx_runtime$3.jsxs)("p", {
											className: "text-3xl",
											children: [
												"· 提交 ",
												(0, import_jsx_runtime$3.jsx)("span", {
											...
											className: "text-3xl",
											children: ["· 加入 QQ 群：", (0, import_jsx_runtime$3.jsx)("span", {
												className: "font-semibold text-primary",
												children: "795874649"
											})]
										})]
	...
	QrLogin = import_react$2.memo((props) => {
		...
		return (0, import_jsx_runtime.jsxs)(DefaultLayout, {
			...
			children: [
				...
				(0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime.jsx)("div", {
							...
							style: { background: isDark ? "radial-gradient(ellipse at 30% 30%, rgba(99,102,241,0.5) 0%, rgba(139,92,246,0.25) 50%, transparent 100%)" : "radial-gradient(ellipse at 30% 30%, rgba(99,102,241,0.35) 0%, rgba(139,92,246,0.18) 50%, transparent 100%)" }
						}),
						(0, import_jsx_runtime.jsx)("div", {
						...
						(0, import_jsx_runtime.jsx)("div", {
							...
							style: { background: isDark ? "radial-gradient(ellipse at 50% 60%, rgba(124,58,237,0.35) 0%, rgba(99,102,241,0.18) 50%, transparent 100%)" : "radial-gradient(ellipse at 50% 60%, rgba(124,58,237,0.25) 0%, rgba(99,102,241,0.12) 50%, transparent 100%)" }
						})
					]
				}),
				(0, import_jsx_runtime.jsx)("div", {
				...
				(0, import_jsx_runtime.jsxs)("div", {
					className: "absolute top-[80px] right-[70px] pointer-events-none select-none opacity-[0.04]",
					children: [(0, import_jsx_runtime.jsx)("span", {
				...
				(0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime.jsx)("p", {
									className: "text-[18px] font-medium tracking-[0.3em] uppercase",
									style: { color: mutedColor },
									children: "karin-plugin-kkk"
								}),
								(0, import_jsx_runtime.jsxs)("div", {
						...
						(0, import_jsx_runtime.jsxs)("div", {
							className: "absolute top-20 right-20 flex flex-col items-end space-y-2",
						...
						(0, import_jsx_runtime.jsxs)("div", {
							...
							children: [qrCodeDataUrl ? (0, import_jsx_runtime.jsx)("div", {
								className: "flex justify-center items-center w-[320px] h-[320px]",
								...
								className: "flex flex-col gap-4 justify-center items-center w-[320px] h-[320px]",
								children: [(0, import_jsx_runtime.jsx)(QrCode, { className: "w-16 h-16 text-default-300" }), (0, import_jsx_runtime.jsx)("span", {
