...
import { $ as Power, A as chip_default, At as require_server_node, B as UserPlus, C as init_date_fns, Ct as Calendar, Dt as Bell, E as format, Et as BookOpen, F as init_io5, G as Star, H as TrendingUp, I as init_lucide_react, J as Share2, Jt as Chalk, K as Sparkles, L as Zap, M as HeroUIProvider, N as require_jsx_runtime, O as init_dist, Ot as clsx_default, P as IoSearch, Q as QrCode, R as Users, S as init_lu, St as CircleAlert, T as formatDistanceToNow, Tt as Bookmark, U as ThumbsUp, V as TriangleAlert, W as Terminal, X as RefreshCw, Y as Send, Z as Radio, _ as AiFillStar, _t as Code, a as rehypeHighlight, at as LogIn, b as zhCN, bt as CircleFadingArrowUp, c as MdAccessTime, ct as Info, d as init_ri, dt as FileText, et as Plug2, f as FaBug, ft as Eye, g as AiFillHeart, gt as Coins, h as init_fa6, ht as CornerDownLeft, i as init_rehype_highlight, it as MapPin, j as button_default, jt as require_react, k as code_default, kt as init_clsx, l as init_md, lt as Heart, m as FaCommentDots, mt as Crown, nt as Music, o as init_react_markdown, ot as List, p as FaCodeBranch, pt as ExternalLink, q as Shield, r as init_chalk, rt as MessageCircle, s as Markdown, st as Link, tt as Play, u as RiShareForwardFill, ut as Hash, v as init_ai, vt as Clock, wt as Bot, x as LuFullscreen, xt as CircleCheckBig, y as init_locale, yt as CircleQuestionMark, z as User } from "./vendor-hakf-RAS.js";
...
var import_react$27, import_jsx_runtime$26, GlowImage, GlowText, GlowIcon, GlowBorderContainer, SmartGlowBorder;
var init_GlowImage = __esmMin(() => {
	...
	GlowImage = ({ src, alt, className, imgClassName, mode = "blur-layer", blurRadius = 18, glowStrength = .6, scale = 1.06, shadowRadius = 28, crossOrigin }) => {
		const [shadowColor, setShadowColor] = import_react$27.useState("rgba(255,255,255,0.5)");
	...
	GlowIcon = ({ Icon, iconProps = {}, className, glowColor, glowStrength = .8, glowRadius = 12, glowLayers = 3, glowSpread = 4 }) => {
		const dropShadow = import_react$27.useMemo(() => Array.from({ length: glowLayers }, (_, i) => {
	...
	SmartGlowBorder = ({ children, className, glowColor, glowStrength = .5, borderWidth = 1, borderRadius = "1.5rem", glowPosition = "left-top", lightInfluenceRange = .3, enableDynamicGlow = true }) => {
		const containerRef = import_react$27.useRef(null);
		const [detectedGlowColor, setDetectedGlowColor] = import_react$27.useState("rgb(245, 158, 11)");
		import_react$27.useEffect(() => {
...
var import_react$25, import_jsx_runtime$24, QRCodeSection$3, VideoInfoHeader$1, CommentItemComponent$2, DouyinComment, Comment_default$3;
var init_Comment$3 = __esmMin(() => {
	...
	DouyinComment = import_react$25.memo((props) => {
		const randomSuggestWord = import_react$25.useMemo(() => {
...
var import_react$24, import_jsx_runtime$23, DouyinHeader$1, CoverSection$1, InfoSection, UserInfoSection$1, CoCreatorsInfo, DouyinDynamic, Dynamic_default;
var init_Dynamic = __esmMin(() => {
	...
	InfoSection = ({ desc, dianzan, pinglun, shouchang, share, createTime }) => (0, import_jsx_runtime$23.jsxs)("div", {
			...
			(0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$23.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$23.jsx)(Heart, { className: "w-11 h-11 text-like" }), (0, import_jsx_runtime$23.jsxs)("span", { children: [dianzan, "点赞"] })]
					}),
					(0, import_jsx_runtime$23.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$23.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$23.jsx)(MessageCircle, { className: "w-11 h-11 text-comment" }), (0, import_jsx_runtime$23.jsxs)("span", { children: [pinglun, "评论"] })]
					}),
					(0, import_jsx_runtime$23.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$23.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$23.jsx)(Bookmark, { className: "w-11 h-11" }), (0, import_jsx_runtime$23.jsxs)("span", { children: [shouchang, "收藏"] })]
					}),
					(0, import_jsx_runtime$23.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$23.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$23.jsx)(Share2, { className: "w-11 h-11 text-success" }), (0, import_jsx_runtime$23.jsxs)("span", { children: [share, "分享"] })]
					})
				]
			}),
			(0, import_jsx_runtime$23.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$23.jsx)(Clock, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["发布于: ", createTime] })]
			}),
			(0, import_jsx_runtime$23.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
	...
	UserInfoSection$1 = ({ avater_url, username, douyinId, likes, following, followers }) => (0, import_jsx_runtime$23.jsxs)("div", {
	...
	CoCreatorsInfo = ({ info }) => {
		...
		const listRef = import_react$24.useRef(null);
		const [visibleCount, setVisibleCount] = import_react$24.useState(items.length);
	...
	DouyinDynamic = (props) => {
		...
		return (0, import_jsx_runtime$23.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$23.jsxs)("div", { children: [
				...
				(0, import_jsx_runtime$23.jsx)(DouyinHeader$1, { useDarkTheme: data.useDarkTheme }),
				(0, import_jsx_runtime$23.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$23.jsx)(CoverSection$1, { imageUrl: data.image_url }),
				(0, import_jsx_runtime$23.jsx)("div", { className: "h-[20px]" }),
				(0, import_jsx_runtime$23.jsx)(InfoSection, {
					desc: data.desc,
				...
				(0, import_jsx_runtime$23.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$23.jsxs)("div", {
						...
						children: [coCreatorCount && coCreatorCount > 0 && (0, import_jsx_runtime$23.jsx)("div", {
							...
							children: (0, import_jsx_runtime$23.jsxs)("div", {
								className: "gap-2 inline-flex items-center rounded-2xl bg-foreground-200 text-foreground-700 px-6 py-3",
						...
						}), (0, import_jsx_runtime$23.jsx)(CoCreatorsInfo, { info: data.cooperation_info })]
					}), (0, import_jsx_runtime$23.jsxs)("div", {
						className: "flex justify-between items-start px-20 pb-20",
						children: [(0, import_jsx_runtime$23.jsx)(UserInfoSection$1, {
...
var import_react$21, import_jsx_runtime$20, formatCount, formatDuration, VideoCard, DouyinUserVideoList;
var init_UserVideoList$1 = __esmMin(() => {
	...
	VideoCard = ({ video }) => {
		const [titleLineCount, setTitleLineCount] = import_react$21.useState(2);
		const titleRef = import_react$21.useRef(null);
...
var import_react$17, import_jsx_runtime$16, processCommentHTML$1, ImageWithSkeleton, QRCodeSection$1, VideoInfoHeader, CommentItemComponent$1, BilibiliComment, Comment_default$2;
...
var import_react$2, import_jsx_runtime$1, ansiColorMap, convertAnsiToHtml, seededRandom, generateBugPositions, getLogLevelTheme, ADAPTER_LOGO_MAP, getAdapterLogo, ErrorHeader, BusinessErrorDetails, handlerError, handlerError_default;
var init_handlerError = __esmMin(() => {
	...
	convertAnsiToHtml = (text) => {
		...
		while ((match = ansiRegex.exec(text)) !== null) {
			if (match.index > lastIndex) {
				...
				if (currentClasses.length > 0) result += `<span class="${currentClasses.join(" ")}">${escapeHtml(textContent)}</span>`;
				else result += escapeHtml(textContent);
			}
			const codes = match[1].split(";").map(Number);
			for (const code of codes) if (code === 0 || code === 39 || code === 49) currentClasses = currentClasses.filter((c) => !c.startsWith("text-") && !c.startsWith("bg-"));
			else if (code === 1) {
				if (!currentClasses.includes("font-bold")) currentClasses.push("font-bold");
			} else if (code === 22) currentClasses = currentClasses.filter((c) => c !== "font-bold");
	...
	ErrorHeader = ({ method, timestamp, businessName }) => (0, import_jsx_runtime$1.jsx)("div", {
		...
		children: (0, import_jsx_runtime$1.jsx)("div", {
			...
			children: (0, import_jsx_runtime$1.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$1.jsx)("img", {
					...
					src: "/image/other/handlerError/流泪.png"
									...
									children: (0, import_jsx_runtime$1.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$1.jsxs)("div", {
											...
											children: [(0, import_jsx_runtime$1.jsx)(Clock, {
												size: 22,
												className: `flex-shrink-0 mb-1 ${theme.iconClass}`
	...
	handlerError = (props) => {
		...
		const bugPositions = import_react$2.useMemo(() => generateBugPositions(50), []);
							...
							children: [
								...
								(0, import_jsx_runtime$1.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$1.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$1.jsx)("span", {
											className: "text-primary font-bold text-3xl flex-shrink-0",
											children: "1."
...
var init_changelog = __esmMin(() => {
	init_dist();
	init_lucide_react();
	import_react$1 = __toESM(require_react(), 1);
	init_react_markdown();
