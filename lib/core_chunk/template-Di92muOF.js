...
var import_react$2, import_jsx_runtime$1, ansiColorMap, ansi256ToColor, convertAnsiToHtml, seededRandom, generateBugPositions, getLogLevelTheme, ADAPTER_LOGO_MAP, getAdapterLogo, ErrorHeader, BusinessErrorDetails, handlerError, handlerError_default;
var init_handlerError = __esmMin(() => {
	...
	ErrorHeader = ({ method, timestamp, businessName }) => {
		...
		const errorEmojiUrl = import_react$2.useMemo(() => {
			const withoutSuffix = [
				343,
				1,
				342,
		...
		const errorTitle = import_react$2.useMemo(() => {
			const titles = [
				"哎呀！出错啦~",
				"糟糕...翻车！",
				"呜呜，坏掉惹",
