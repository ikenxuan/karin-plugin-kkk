	...
	Networks = class {
		...
		async downloadStream(progressCallback, retryCount = 0) {
			...
			try {
				...
				if (Number.isNaN(contentLength)) throw new Error("无效的 content-length 响应头");
