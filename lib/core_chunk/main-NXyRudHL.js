...
import { C as Client, b as bilibiliErrorCodeMap, D as DynamicType, g as getBilibiliData, A as AdditionalType, a as bilibiliApiUrls, w as wbi_sign, c as browserExports, M as MajorType, d as getDouyinData, h as heicConvertExports } from "./vendor-DShOMusp.js";
import karin, { logger, config, segment, createNotFoundResponse, copyConfigSync, filesByExt, watch, requireFileSync, ffmpeg, ffprobe, render, common, createBadRequestResponse, createServerErrorResponse, createSuccessResponse, getBot, defineConfig, components, karinPathRoot, mkdirSync } from "node-karin";
import axios, { AxiosError } from "node-karin/axios";
import { pipeline } from "stream/promises";
import path, { join } from "node:path";
import { g as getDouyinDB, a as getBilibiliDB, c as cleanOldDynamicCache, b as bilibiliDBInstance, d as douyinDBInstance } from "./db-GPskdIxH.js";
  ...
  for (const tag of rich_text_nodes) {
    ...
    switch (tag.type) {
      ...
      case "RICH_TEXT_NODE_TYPE_EMOJI": {
        ...
        text = text.replace(regex2, `<img src='${tag.emoji.icon_url}' style='height: 160px; margin: 0 0 -10px 0;'>`);
        break;
      }
    }
  }
          ...
          case DynamicType.AV: {
            if (data[dynamicId].Dynamic_Data.modules.module_dynamic.major?.type === "MAJOR_TYPE_ARCHIVE") {
              ...
              if (INFODATA.data.data.redirect_url) {
                ...
                await getBilibiliData("单个视频下载信息数据", "", { avid: Number(aid), cid: INFODATA.data.data.cid, typeMode: "strict" });
              }
              img2 = await Render(
                "bilibili/dynamic/DYNAMIC_TYPE_AV",
                {
