...
import { $ as RefreshCw, A as format, At as Bookmark, B as init_lucide_react, C as init_locale, Ct as CircleQuestionMark, D as init_date_fns, Dt as CircleAlert, E as init_lu, Et as CircleCheckBig, F as button_default, Ft as require_server_node, G as TriangleAlert, H as Users, I as HeroUIProvider, It as require_react, J as Star, K as ThumbsUp, L as require_jsx_runtime, M as init_dist, Mt as Bell, N as code_default, Nt as clsx_default, Ot as Calendar, P as chip_default, Pt as init_clsx, Q as Send, R as IoSearch, S as init_ai, St as Clock, T as LuFullscreen, Tt as CircleEllipsis, U as User, V as Zap, W as UserPlus, X as Shield, Y as Sparkles, Z as Share2, _ as FaCodeBranch, _t as ExternalLink, at as Play, b as AiFillHeart, bt as Coins, c as init_rehype_highlight, ct as MapPin, d as Markdown, dt as Link, et as Radio, f as MdAccessTime, ft as Info, g as FaBug, gt as Eye, h as init_ri, ht as FileText, it as Plug2, jt as BookOpen, k as formatDistanceToNow, kt as Bot, l as rehypeHighlight, lt as LogIn, m as RiShareForwardFill, mt as Hash, nt as Power, ot as Music, p as init_md, pt as Heart, q as Terminal, rt as Plus, st as MessageCircle, tt as QrCode, u as init_react_markdown, ut as List, v as FaCommentDots, vt as Crown, w as zhCN, wt as CircleFadingArrowUp, x as AiFillStar, xt as Code, y as init_fa6, yt as CornerDownLeft, z as init_io5 } from "./vendor-BNovp5B4.js";
...
var import_react$29, import_jsx_runtime$27, GlowImage, GlowText, GlowIcon, GlowBorderContainer, SmartGlowBorder;
var init_GlowImage = __esmMin(() => {
	import_react$29 = __toESM(require_react(), 1);
	...
	GlowImage = ({ src, children, alt, className, imgClassName, mode = "blur-layer", blurRadius = 18, glowStrength = .6, scale = 1.06, shadowRadius = 28, crossOrigin }) => {
		const [shadowColor, setShadowColor] = import_react$29.useState("rgba(255,255,255,0.5)");
		import_react$29.useEffect(() => {
		...
		if (children) return (0, import_jsx_runtime$27.jsxs)("div", {
			className,
			style: {
				position: "relative",
	...
	GlowText = ({ children, className, glowClassName, blurRadius = 12, glowStrength = .6, scale = 1.02 }) => (0, import_jsx_runtime$27.jsxs)("span", {
		className,
		style: {
			position: "relative",
			display: "inline-block"
		...
		children: [(0, import_jsx_runtime$27.jsx)("span", {
			...
			children
		}), (0, import_jsx_runtime$27.jsx)("span", { children })]
	});
	GlowIcon = ({ Icon, iconProps = {}, className, glowColor, glowStrength = .8, glowRadius = 12, glowLayers = 3, glowSpread = 4 }) => {
		const dropShadow = import_react$29.useMemo(() => Array.from({ length: glowLayers }, (_, i) => {
		...
		return (0, import_jsx_runtime$27.jsx)("div", {
			className,
			style: { display: "inline-block" },
			children: (0, import_jsx_runtime$27.jsx)(Icon, {
				...iconProps,
				style: {
					filter: dropShadow,
					...iconProps.style
	...
	SmartGlowBorder = ({ children, className, glowColor, glowStrength = .5, borderWidth = 1, borderRadius = "1.5rem", glowPosition = "left-top", lightInfluenceRange = .3, enableDynamicGlow = true }) => {
		const containerRef = import_react$29.useRef(null);
		const [detectedGlowColor, setDetectedGlowColor] = import_react$29.useState("rgb(245, 158, 11)");
		import_react$29.useEffect(() => {
		...
		return (0, import_jsx_runtime$27.jsx)("div", {
			ref: containerRef,
			children: (0, import_jsx_runtime$27.jsx)(GlowBorderContainer, {
				className,
...
}), import_jsx_runtime$26, DefaultLayout;
var init_DefaultLayout = __esmMin(() => {
	...
	DefaultLayout = ({ children, version, data, scale = 3, className = "", style = {} }) => {
		...
		return (0, import_jsx_runtime$26.jsx)(HeroUIProvider, { children: (0, import_jsx_runtime$26.jsxs)("div", {
			className: clsx_default("w-[1440px]", "bg-default-50 text-default-900", "font-[HarmonyOSHans-Regular]", className, { dark: useDarkTheme }),
			id: "container",
			style: {
				transform: `scale(${scale})`,
			...
			children: [children, version ? (0, import_jsx_runtime$26.jsx)("div", {
				...
				children: (0, import_jsx_runtime$26.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$26.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$26.jsx)(GlowImage, {
								glowStrength: useDarkTheme ? 1 : 0,
								blurRadius: 20,
								children: (0, import_jsx_runtime$26.jsxs)("svg", {
									id: "114514",
									xmlns: "http://www.w3.org/2000/svg",
									viewBox: "0 0 230 221",
									className: "w-auto h-18",
									children: [
										(0, import_jsx_runtime$26.jsx)("path", {
											id: "_1",
								...
								children: [(0, import_jsx_runtime$26.jsx)("div", {
									...
									children: (0, import_jsx_runtime$26.jsx)("span", { children: version.plugin })
								}), (0, import_jsx_runtime$26.jsx)("span", {
						...
						(0, import_jsx_runtime$26.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$26.jsxs)("div", {
								...
								children: [
									version.hasUpdate && (0, import_jsx_runtime$26.jsx)(CircleFadingArrowUp, {
										strokeWidth: 3,
										className: "w-4 h-4 text-success"
									}),
									!version.hasUpdate && version.releaseType === "Stable" && (0, import_jsx_runtime$26.jsx)(CircleCheckBig, {
										strokeWidth: 3,
										className: "w-4 h-4"
									}),
									!version.hasUpdate && version.releaseType === "Preview" && (0, import_jsx_runtime$26.jsx)(TriangleAlert, {
										strokeWidth: 3,
										className: "w-4 h-4 text-warning"
									}),
									!version.hasUpdate && version.releaseType !== "Stable" && version.releaseType !== "Preview" && (0, import_jsx_runtime$26.jsx)(Info, {
										strokeWidth: 3,
										className: "w-4 h-4"
									}),
									(0, import_jsx_runtime$26.jsx)("span", {
						...
						(0, import_jsx_runtime$26.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }),
						(0, import_jsx_runtime$26.jsxs)("div", {
							className: "flex items-end space-x-8",
							children: [(0, import_jsx_runtime$26.jsx)(GlowImage, {
								...
								children: [(0, import_jsx_runtime$26.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [(0, import_jsx_runtime$26.jsx)(Zap, {
										strokeWidth: 3,
									...
									children: [(0, import_jsx_runtime$26.jsx)("span", {
						...
						version.releaseType === "Stable" && (0, import_jsx_runtime$26.jsxs)(import_jsx_runtime$26.Fragment, { children: [(0, import_jsx_runtime$26.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }), (0, import_jsx_runtime$26.jsxs)("div", {
							className: "flex items-end space-x-8",
							children: [(0, import_jsx_runtime$26.jsx)(GlowImage, {
								src: "/image/vite.svg",
								alt: "logo",
								...
								children: [(0, import_jsx_runtime$26.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [
										(0, import_jsx_runtime$26.jsx)(Code, {
											strokeWidth: 3,
											className: "w-4 h-4"
										}),
										(0, import_jsx_runtime$26.jsx)("span", { children: "Built with" }),
										(0, import_jsx_runtime$26.jsx)(GlowImage, {
			...
			}) : (0, import_jsx_runtime$26.jsx)("div", { className: "h-24" })]
		}) });
	};
});
...
var import_react$27, import_jsx_runtime$25, QRCodeSection$3, VideoInfoHeader$1, organizeReplies, ReplyItemComponent, CommentItemComponent$2, DouyinComment, Comment_default$3;
var init_Comment$3 = __esmMin(() => {
	init_clsx();
	init_lucide_react();
	import_react$27 = __toESM(require_react(), 1);
	init_io5();
	init_DefaultLayout();
	import_jsx_runtime$25 = __toESM(require_jsx_runtime(), 1);
	QRCodeSection$3 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$25.jsx)("div", {
		className: "flex flex-col items-center",
		children: (0, import_jsx_runtime$25.jsx)("div", {
			className: "flex justify-center items-center w-[400px] h-[400px] p-4",
			children: qrCodeDataUrl ? (0, import_jsx_runtime$25.jsx)("img", {
				src: qrCodeDataUrl,
				alt: "二维码",
				className: "object-contain w-full h-full rounded-lg"
			}) : (0, import_jsx_runtime$25.jsxs)("div", {
				className: "flex flex-col justify-center items-center text-foreground-400",
				children: [(0, import_jsx_runtime$25.jsx)(QrCode, {
					size: 80,
					className: "mb-4"
	...
	VideoInfoHeader$1 = (props) => (0, import_jsx_runtime$25.jsx)("div", {
		className: "max-w-[1400px] mx-auto px-10 py-8",
			...
			children: [(0, import_jsx_runtime$25.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$25.jsx)("div", {
					...
					children: (0, import_jsx_runtime$25.jsxs)("div", {
						...
						}), props.Type === "视频" && props.Resolution && (0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [
						...
						props.Type === "视频" ? (0, import_jsx_runtime$25.jsxs)(import_jsx_runtime$25.Fragment, { children: [(0, import_jsx_runtime$25.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text",
							children: [(0, import_jsx_runtime$25.jsx)("span", {
								className: "mr-4 text-foreground-400",
								children: "大小"
						...
						})] }) : (0, import_jsx_runtime$25.jsxs)(import_jsx_runtime$25.Fragment, { children: [(0, import_jsx_runtime$25.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text",
							children: [(0, import_jsx_runtime$25.jsx)("span", {
								className: "mr-4 text-foreground-400",
								children: "区域"
				...
				className: "shrink-0",
				children: (0, import_jsx_runtime$25.jsx)(QRCodeSection$3, { qrCodeDataUrl: props.qrCodeDataUrl })
			})]
		})
	});
	...
	ReplyItemComponent = ({ reply, depth = 0, isLast, maxDepth = 6 }) => {
		...
		if (reply.hiddenCount) return (0, import_jsx_runtime$25.jsx)("div", {
			...
			children: (0, import_jsx_runtime$25.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [
						!isLast && (0, import_jsx_runtime$25.jsx)("div", { className: "absolute top-0 bottom-0 left-1/2 w-0.5 bg-default-300 -ml-px" }),
						!isLast && (0, import_jsx_runtime$25.jsx)("div", { className: "absolute -bottom-6 left-1/2 w-0.5 h-6 bg-default-300 -ml-px" }),
						(0, import_jsx_runtime$25.jsx)("svg", {
							className: "absolute top-0 left-0 w-full h-[50px] pointer-events-none overflow-visible z-0 text-default-300",
							children: (0, import_jsx_runtime$25.jsx)("path", {
					...
					children: (0, import_jsx_runtime$25.jsx)("div", {
						...
						children: (0, import_jsx_runtime$25.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$25.jsx)(CircleEllipsis, {
								size: 45,
								className: "mr-5"
							}), (0, import_jsx_runtime$25.jsxs)("span", {
				...
				children: [(0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$25.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$25.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$25.jsx)("div", {
								className: "w-[100px] h-[100px] shrink-0 z-10 relative",
								children: (0, import_jsx_runtime$25.jsx)("img", {
									src: reply.userimageurl,
									className: "object-cover rounded-full w-[100px] h-[100px] bg-background",
									alt: "用户头像"
								})
							}), reply.children.length > 0 && (0, import_jsx_runtime$25.jsx)("div", { className: "w-0.5 bg-default-300 h-full grow mt-3 rounded-t-full" })]
						}), (0, import_jsx_runtime$25.jsxs)("div", {
							className: "flex flex-col pb-8 pl-3 min-w-0",
							children: [
								(0, import_jsx_runtime$25.jsxs)("div", {
									className: "flex flex-nowrap items-center h-[100px] content-center w-full overflow-hidden",
									children: [
										(0, import_jsx_runtime$25.jsx)("span", {
										...
										reply.label_text !== "" && (0, import_jsx_runtime$25.jsx)("div", {
										...
										reply.reply_to_username && (0, import_jsx_runtime$25.jsxs)("div", {
											className: clsx_default("flex items-center", !isNicknameLonger ? "overflow-hidden min-w-0 shrink" : "shrink-0"),
											children: [(0, import_jsx_runtime$25.jsx)(Play, {
												size: 35,
								...
								(0, import_jsx_runtime$25.jsxs)("div", {
									...
									}), reply.image_list && reply.image_list.length > 0 && reply.image_list.filter(Boolean).map((img, idx) => (0, import_jsx_runtime$25.jsx)("div", {
										className: "my-4 overflow-hidden shadow-sm rounded-xl max-w-[600px]",
										children: (0, import_jsx_runtime$25.jsx)("img", {
									...
									children: (0, import_jsx_runtime$25.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$25.jsxs)("div", {
												...
												children: [(0, import_jsx_runtime$25.jsx)(Heart, {
													size: 40,
					...
					}), reply.children.length > 0 && (0, import_jsx_runtime$25.jsx)("div", {
						className: "flex relative flex-col",
						children: (0, import_jsx_runtime$25.jsx)("div", { children: reply.children.map((child, index) => (0, import_jsx_runtime$25.jsx)(ReplyItemComponent, {
							reply: child,
							depth: depth + 1,
	...
	CommentItemComponent$2 = (props) => (0, import_jsx_runtime$25.jsx)("div", {
		...
		children: (0, import_jsx_runtime$25.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$25.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$25.jsx)("div", {
						className: "w-[140px] h-[140px] shrink-0 z-10 relative",
						children: (0, import_jsx_runtime$25.jsx)("img", {
							src: props.userimageurl,
							className: "w-[140px] h-[140px] rounded-full object-cover shadow-md bg-background",
							alt: "用户头像"
						})
					}), props.replyComment && props.replyComment.length > 0 && (0, import_jsx_runtime$25.jsx)("div", { className: "w-0.5 bg-default-300 h-full grow mt-4 rounded-t-full" })]
				}), (0, import_jsx_runtime$25.jsxs)("div", {
					className: "flex flex-col pb-4 pl-4 min-w-0",
					children: [
						(0, import_jsx_runtime$25.jsxs)("div", {
							className: "flex flex-wrap gap-4 items-center mb-3 text-5xl select-text text-foreground-700 min-h-[140px] content-center",
							children: [
								(0, import_jsx_runtime$25.jsx)("span", {
									className: "font-medium",
									children: props.nickname
								}),
								props.label_type === 1 && (0, import_jsx_runtime$25.jsx)("div", {
									className: "inline-flex items-center px-3 py-1 rounded-lg text-3xl bg-[#fe2c55] text-white",
									children: "作者"
								}),
								props.is_author_digged && props.status_label !== "作者赞过" && (0, import_jsx_runtime$25.jsx)("div", {
									className: "inline-flex items-center px-3 py-1 text-3xl font-light rounded-lg bg-content2 text-foreground-700",
									children: "作者赞过"
								}),
								props.status_label && (0, import_jsx_runtime$25.jsx)("div", {
									className: "inline-flex items-center px-3 py-1 text-3xl font-light rounded-lg bg-content2 text-foreground-700",
						...
						(props.commentimage || props.sticker) && (0, import_jsx_runtime$25.jsx)("div", {
							className: "my-6 overflow-hidden shadow-sm rounded-2xl max-w-[800px]",
							children: (0, import_jsx_runtime$25.jsx)("img", {
			...
			}), props.replyComment && props.replyComment.length > 0 && (0, import_jsx_runtime$25.jsxs)("div", {
				className: "flex relative flex-col mt-8 ml-5",
				children: [(0, import_jsx_runtime$25.jsx)("div", { className: "absolute -top-8 left-[50px] w-0.5 h-8 bg-default-300 -ml-px" }), organizeReplies(props.replyComment, props.cid || "", props.maxDepth).map((reply, index, arr) => (0, import_jsx_runtime$25.jsx)(ReplyItemComponent, {
					reply,
					depth: 1,
	...
	DouyinComment = import_react$27.memo((props) => {
		const randomSuggestWord = import_react$27.useMemo(() => {
		...
		return (0, import_jsx_runtime$25.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$25.jsxs)("div", {
				className: "p-5",
				children: [
					(0, import_jsx_runtime$25.jsx)("div", { className: "h-20" }),
					(0, import_jsx_runtime$25.jsx)(VideoInfoHeader$1, {
						...props.data,
						qrCodeDataUrl: props.qrCodeDataUrl
					}),
					randomSuggestWord && (0, import_jsx_runtime$25.jsx)("div", {
						...
						children: (0, import_jsx_runtime$25.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$25.jsx)("span", {
								...
								children: [randomSuggestWord, (0, import_jsx_runtime$25.jsx)(IoSearch, {
									size: 32,
					...
					(0, import_jsx_runtime$25.jsx)("div", {
						...
						children: props.data.CommentsData.length > 0 ? (0, import_jsx_runtime$25.jsx)(import_jsx_runtime$25.Fragment, { children: props.data.CommentsData.map((comment, index) => (0, import_jsx_runtime$25.jsx)(CommentItemComponent$2, {
							...comment,
							isLast: index === props.data.CommentsData.length - 1,
							maxDepth: props.data.maxDepth
						}, comment.cid || index)) }) : (0, import_jsx_runtime$25.jsx)("div", {
							className: "flex justify-center items-center py-20 text-foreground-400",
							children: (0, import_jsx_runtime$25.jsx)("div", {
								className: "text-center",
								children: (0, import_jsx_runtime$25.jsx)("p", {
									className: "text-xl",
									children: "暂无评论数据"
								})
							})
...
var import_react$26, import_jsx_runtime$24, DouyinHeader$1, CoverSection$1, InfoSection, UserInfoSection$1, CoCreatorsInfo, DouyinDynamic, Dynamic_default;
var init_Dynamic = __esmMin(() => {
	...
	DouyinHeader$1 = ({ useDarkTheme }) => (0, import_jsx_runtime$24.jsxs)("div", {
	...
	CoverSection$1 = ({ imageUrl }) => (0, import_jsx_runtime$24.jsx)("div", {
	...
	InfoSection = (props) => (0, import_jsx_runtime$24.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime$24.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$24.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$24.jsx)(Heart, { className: "w-11 h-11 text-like" }), (0, import_jsx_runtime$24.jsxs)("span", { children: [props.data.dianzan, "点赞"] })]
					}),
					(0, import_jsx_runtime$24.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$24.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$24.jsx)(MessageCircle, { className: "w-11 h-11 text-comment" }), (0, import_jsx_runtime$24.jsxs)("span", { children: [props.data.pinglun, "评论"] })]
					}),
					(0, import_jsx_runtime$24.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$24.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$24.jsx)(Bookmark, { className: "w-11 h-11" }), (0, import_jsx_runtime$24.jsxs)("span", { children: [props.data.shouchang, "收藏"] })]
					}),
					(0, import_jsx_runtime$24.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$24.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$24.jsx)(Share2, { className: "w-11 h-11 text-success" }), (0, import_jsx_runtime$24.jsxs)("span", { children: [props.data.share, "分享"] })]
					})
				]
			}),
			(0, import_jsx_runtime$24.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$24.jsx)(Clock, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$24.jsxs)("span", { children: ["发布于: ", props.data.create_time] })]
			}),
			(0, import_jsx_runtime$24.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$24.jsx)(LuFullscreen, { className: "w-11 h-11 text-time text-time" }), (0, import_jsx_runtime$24.jsxs)("span", { children: ["图片生成于: ", format(/* @__PURE__ */ new Date(), "yyyy-MM-dd HH:mm:ss")] })]
			})
		]
	});
	UserInfoSection$1 = (props) => (0, import_jsx_runtime$24.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$24.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$24.jsx)("div", {
				...
				children: [(0, import_jsx_runtime$24.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$24.jsx)(Hash, {
						size: 32,
			...
			children: [
				(0, import_jsx_runtime$24.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$24.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$24.jsx)(Heart, {
								size: 28,
								className: "text-like"
							}), (0, import_jsx_runtime$24.jsx)("span", {
								className: "text-default-400",
						...
						(0, import_jsx_runtime$24.jsx)("div", { className: "w-full h-px bg-default-300" }),
						(0, import_jsx_runtime$24.jsx)("span", {
				...
				(0, import_jsx_runtime$24.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$24.jsxs)("div", {
							className: "flex gap-1 items-center",
							children: [(0, import_jsx_runtime$24.jsx)(Eye, {
								size: 28,
								className: "text-view"
							}), (0, import_jsx_runtime$24.jsx)("span", {
								className: "text-default-400",
				...
				(0, import_jsx_runtime$24.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$24.jsxs)("div", {
							className: "flex gap-1 items-center",
							children: [(0, import_jsx_runtime$24.jsx)(Users, {
								size: 28,
	...
	CoCreatorsInfo = ({ info }) => {
		...
		const listRef = import_react$26.useRef(null);
		const [visibleCount, setVisibleCount] = import_react$26.useState(items.length);
		...
		return (0, import_jsx_runtime$24.jsx)("div", {
			...
			children: (0, import_jsx_runtime$24.jsxs)("div", {
				...
				}), items.length > visibleCount && (0, import_jsx_runtime$24.jsxs)("div", {
					className: "flex flex-col items-center min-w-[152px] w-[152px] shrink-0",
					children: [
						(0, import_jsx_runtime$24.jsx)("div", {
	...
	DouyinDynamic = (props) => {
		...
		return (0, import_jsx_runtime$24.jsx)(DefaultLayout, {
			...props,
			children: (0, import_jsx_runtime$24.jsxs)("div", { children: [
				(0, import_jsx_runtime$24.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$24.jsx)(DouyinHeader$1, { useDarkTheme: props.data.useDarkTheme }),
				(0, import_jsx_runtime$24.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$24.jsx)(CoverSection$1, { imageUrl: props.data.image_url }),
				(0, import_jsx_runtime$24.jsx)("div", { className: "h-[20px]" }),
				(0, import_jsx_runtime$24.jsx)(InfoSection, { ...props }),
				(0, import_jsx_runtime$24.jsx)("div", { className: "h-[100px]" }),
				(0, import_jsx_runtime$24.jsxs)("div", {
					className: "flex flex-col gap-10 px-0 pt-25",
					children: [(0, import_jsx_runtime$24.jsxs)("div", {
						className: "w-full",
						children: [coCreatorCount && coCreatorCount > 0 && (0, import_jsx_runtime$24.jsx)("div", {
							className: "px-16 pb-8",
							children: (0, import_jsx_runtime$24.jsxs)("div", {
								className: "gap-2 inline-flex items-center rounded-2xl bg-default-100 text-foreground-700 px-6 py-3",
								children: [(0, import_jsx_runtime$24.jsx)(Users, { className: "w-7 h-7" }), (0, import_jsx_runtime$24.jsxs)("span", {
									className: "text-3xl font-medium leading-none select-text text-foreground-700",
									children: [coCreatorCount, "人共创"]
								})]
							})
						}), (0, import_jsx_runtime$24.jsx)(CoCreatorsInfo, { info: props.data.cooperation_info })]
					}), (0, import_jsx_runtime$24.jsxs)("div", {
						className: "flex justify-between items-start px-20 pb-20",
						children: [(0, import_jsx_runtime$24.jsx)(UserInfoSection$1, { ...props }), (0, import_jsx_runtime$24.jsx)("div", {
							className: "flex flex-col items-center gap-4",
							children: props.qrCodeDataUrl ? (0, import_jsx_runtime$24.jsx)("img", {
...
}, 1), import_jsx_runtime$23, CoverSection, UserInfoSection, QRCodeSection$2, DouyinLive, Live_default;
var init_Live = __esmMin(() => {
	init_lucide_react();
	__toESM(require_react(), 1);
	init_DefaultLayout();
	import_jsx_runtime$23 = __toESM(require_jsx_runtime(), 1);
	CoverSection = ({ imageUrl }) => (0, import_jsx_runtime$23.jsx)("div", {
		className: "py-10",
	...
	UserInfoSection = ({ avater_url, username, fans }) => (0, import_jsx_runtime$23.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$23.jsx)("div", {
						...
						children: (0, import_jsx_runtime$23.jsx)("span", { children: username })
					}),
					(0, import_jsx_runtime$23.jsx)("div", { className: "w-4" }),
				...
				className: "flex gap-2 items-center",
				children: [(0, import_jsx_runtime$23.jsx)(Users, { className: "w-8 h-8 text-follow" }), (0, import_jsx_runtime$23.jsxs)("span", {
	...
	QRCodeSection$2 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$23.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$23.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$23.jsx)(QrCode, { className: "w-12 h-12" }), (0, import_jsx_runtime$23.jsx)("span", { children: "直播分享链接" })]
		}), (0, import_jsx_runtime$23.jsx)("div", {
	...
	DouyinLive = (props) => {
		...
		return (0, import_jsx_runtime$23.jsxs)(DefaultLayout, {
			...props,
			children: [(0, import_jsx_runtime$23.jsx)(CoverSection, { imageUrl: props.data.image_url }), (0, import_jsx_runtime$23.jsxs)("div", {
				className: "flex flex-col px-20",
				children: [
					(0, import_jsx_runtime$23.jsx)("div", { className: "h-2.5" }),
					(0, import_jsx_runtime$23.jsx)("div", {
					...
					(0, import_jsx_runtime$23.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$23.jsxs)("div", {
								className: "flex gap-2 items-center",
								children: [(0, import_jsx_runtime$23.jsx)(Eye, { className: "w-11 h-11 text-view" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["观看总人数", props.data.总观看次数] })]
							}),
							(0, import_jsx_runtime$23.jsx)("span", { children: "|" }),
							(0, import_jsx_runtime$23.jsxs)("div", {
								className: "flex gap-2 items-center",
								children: [(0, import_jsx_runtime$23.jsx)(Users, { className: "w-11 h-11 text-follow" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["在线观众", props.data.在线观众] })]
							})
						]
					}),
					(0, import_jsx_runtime$23.jsx)("div", { className: "h-20" }),
					(0, import_jsx_runtime$23.jsx)(UserInfoSection, {
						avater_url: props.data.avater_url,
						username: props.data.username,
						fans: props.data.fans,
						useDarkTheme: props.data.useDarkTheme
					}),
					(0, import_jsx_runtime$23.jsx)("div", { className: "h-[120px]" }),
					(0, import_jsx_runtime$23.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$23.jsxs)("div", {
							...
							}), (0, import_jsx_runtime$23.jsx)(QRCodeSection$2, {
								qrCodeDataUrl,
								useDarkTheme: props.data.useDarkTheme
							})]
						})]
...
}, 1), import_jsx_runtime$22, DouyinHeader, MusicCoverSection, MusicInfoSection, MusicAuthorInfoSection, MusicQRCodeSection, DouyinMusicInfo, MusicInfo_default;
var init_MusicInfo = __esmMin(() => {
	...
	DouyinHeader = ({ useDarkTheme }) => (0, import_jsx_runtime$22.jsxs)("div", {
		className: "flex items-center px-12 py-15",
	...
	MusicCoverSection = ({ imageUrl }) => (0, import_jsx_runtime$22.jsx)("div", {
		className: "flex flex-col items-center my-5",
		children: (0, import_jsx_runtime$22.jsx)("div", {
			className: "flex flex-col items-center overflow-hidden shadow-large rounded-[25px] w-[90%] relative",
			children: (0, import_jsx_runtime$22.jsx)("img", {
	...
	MusicInfoSection = ({ desc, musicId, userCount, createTime }) => (0, import_jsx_runtime$22.jsxs)("div", {
		className: "flex flex-col px-16 py-5",
		children: [
			...
			(0, import_jsx_runtime$22.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$22.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$22.jsx)(Music, { className: "w-11 h-11" }), (0, import_jsx_runtime$22.jsxs)("span", { children: ["音乐ID: ", musicId] })]
				}), (0, import_jsx_runtime$22.jsxs)("div", {
					className: "flex gap-2 items-center select-text",
					children: [(0, import_jsx_runtime$22.jsx)(Users, { className: "w-11 h-11 text-follow" }), (0, import_jsx_runtime$22.jsxs)("span", { children: [userCount, " 人使用过"] })]
				})]
			}),
			(0, import_jsx_runtime$22.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-default-500 font-light select-text",
				children: [(0, import_jsx_runtime$22.jsx)(LuFullscreen, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$22.jsxs)("span", { children: ["图片生成于: ", createTime] })]
			})
		]
	});
	MusicAuthorInfoSection = ({ avatarUrl, username, userShortId, totalFavorited, followingCount, fans }) => (0, import_jsx_runtime$22.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$22.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$22.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$22.jsx)(Hash, { className: "w-8 h-8" }), (0, import_jsx_runtime$22.jsxs)("span", { children: ["ID: ", userShortId] })]
				}),
				(0, import_jsx_runtime$22.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$22.jsx)(Heart, { className: "w-8 h-8 text-like" }), (0, import_jsx_runtime$22.jsxs)("span", { children: ["获赞: ", totalFavorited] })]
				}),
				(0, import_jsx_runtime$22.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$22.jsx)(UserPlus, { className: "w-8 h-8" }), (0, import_jsx_runtime$22.jsxs)("span", { children: ["关注: ", followingCount] })]
				}),
				(0, import_jsx_runtime$22.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$22.jsx)(Users, { className: "w-8 h-8 text-follow" }), (0, import_jsx_runtime$22.jsxs)("span", { children: ["粉丝: ", fans] })]
				})
			]
		})]
	});
	MusicQRCodeSection = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$22.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$22.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$22.jsx)(QrCode, { className: "w-11 h-11" }), (0, import_jsx_runtime$22.jsx)("span", { children: "文件直链：永久有效" })]
		}), (0, import_jsx_runtime$22.jsx)("div", {
	...
	DouyinMusicInfo = (props) => {
		...
		return (0, import_jsx_runtime$22.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$22.jsxs)("div", { children: [
				(0, import_jsx_runtime$22.jsx)(DouyinHeader, { useDarkTheme: data.useDarkTheme }),
				(0, import_jsx_runtime$22.jsx)(MusicCoverSection, {
					imageUrl: data.image_url,
					description: data.desc,
					useDarkTheme: data.useDarkTheme
				}),
				(0, import_jsx_runtime$22.jsx)("div", { className: "h-[90px]" }),
				(0, import_jsx_runtime$22.jsx)(MusicInfoSection, {
					desc: data.desc,
				...
				(0, import_jsx_runtime$22.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$22.jsx)(MusicAuthorInfoSection, {
						...
						fans: data.fans,
						useDarkTheme: data.useDarkTheme
					}), (0, import_jsx_runtime$22.jsx)(MusicQRCodeSection, {
						qrCodeDataUrl,
						useDarkTheme: data.useDarkTheme
					})]
				})
...
var import_react$23, import_jsx_runtime$21, formatCount, formatDuration$1, VideoCard, DouyinUserVideoList;
var init_UserVideoList = __esmMin(() => {
	...
	VideoCard = ({ video }) => {
		const [titleLineCount, setTitleLineCount] = import_react$23.useState(2);
		const titleRef = import_react$23.useRef(null);
		...
		return (0, import_jsx_runtime$21.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$21.jsxs)("div", {
				...
				children: [
					...
					video.music && (0, import_jsx_runtime$21.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$21.jsx)("span", { children: "♫" }), (0, import_jsx_runtime$21.jsx)("span", {
						...
						children: (0, import_jsx_runtime$21.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$21.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$21.jsx)(AiFillHeart, { size: 34 }), (0, import_jsx_runtime$21.jsx)("span", { children: formatCount(video.statistics.like_count) })]
								}),
								(0, import_jsx_runtime$21.jsxs)("div", {
									className: "flex items-center gap-2 text-default-600",
									children: [(0, import_jsx_runtime$21.jsx)(FaCommentDots, { size: 34 }), (0, import_jsx_runtime$21.jsx)("span", { children: formatCount(video.statistics.comment_count) })]
								}),
								(0, import_jsx_runtime$21.jsxs)("div", {
									className: "flex items-center gap-2 text-default-600",
									children: [(0, import_jsx_runtime$21.jsx)(AiFillStar, { size: 34 }), (0, import_jsx_runtime$21.jsx)("span", { children: formatCount(video.statistics.collect_count) })]
								}),
								(0, import_jsx_runtime$21.jsxs)("div", {
									className: "flex items-center gap-2 text-default-600",
									children: [(0, import_jsx_runtime$21.jsx)(RiShareForwardFill, { size: 34 }), (0, import_jsx_runtime$21.jsx)("span", { children: formatCount(video.statistics.share_count) })]
								})
							]
						})
					})
	...
	DouyinUserVideoList = (prpos) => (0, import_jsx_runtime$21.jsxs)(DefaultLayout, {
		...prpos,
		children: [prpos.data.user.head_image && (0, import_jsx_runtime$21.jsxs)("div", {
			className: "relative w-full overflow-hidden",
			children: [(0, import_jsx_runtime$21.jsx)("img", {
				src: prpos.data.user.head_image,
				alt: "头部背景",
				className: "w-full h-auto object-cover"
			}), (0, import_jsx_runtime$21.jsx)("div", { className: "absolute inset-0 bg-linear-to-b from-transparent via-default-50/40 to-default-50" })]
		}), (0, import_jsx_runtime$21.jsx)("div", {
			...
			children: (0, import_jsx_runtime$21.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$21.jsx)("img", {
							...
							children: [
								(0, import_jsx_runtime$21.jsxs)("div", {
									...
									}), prpos.data.user.verified && (0, import_jsx_runtime$21.jsx)("span", {
								...
								(0, import_jsx_runtime$21.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$21.jsxs)("span", { children: ["抖音号：", prpos.data.user.short_id] }), prpos.data.user.ip_location && (0, import_jsx_runtime$21.jsx)("span", { children: prpos.data.user.ip_location })]
								}),
								(0, import_jsx_runtime$21.jsxs)("div", {
									className: "flex gap-8 text-3xl",
									children: [
										(0, import_jsx_runtime$21.jsxs)("div", { children: [(0, import_jsx_runtime$21.jsx)("span", {
											className: "text-default-500",
											children: "关注"
										}), (0, import_jsx_runtime$21.jsxs)("span", {
				...
				}), prpos.data.videos.length > 0 ? (0, import_jsx_runtime$21.jsx)(import_jsx_runtime$21.Fragment, { children: (0, import_jsx_runtime$21.jsx)("div", {
					className: "grid grid-cols-2 gap-6 mb-8",
					children: prpos.data.videos.map((video) => (0, import_jsx_runtime$21.jsx)(VideoCard, { video }, video.aweme_id))
				}) }) : (0, import_jsx_runtime$21.jsx)("div", {
					className: "text-center py-20",
					children: (0, import_jsx_runtime$21.jsx)("p", {
...
var UserList_exports$1 = __export({ default: () => UserList_default$1 }, 1), import_jsx_runtime$20, DouyinUserItem, DouyinUserList, UserList_default$1;
var init_UserList$1 = __esmMin(() => {
	...
	DouyinUserItem = (props) => (0, import_jsx_runtime$20.jsxs)("li", {
		...
		children: [(0, import_jsx_runtime$20.jsx)("img", {
			...
			children: [(0, import_jsx_runtime$20.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$20.jsxs)("span", {
					...
					children: [(0, import_jsx_runtime$20.jsx)(User, {
				...
				}), (0, import_jsx_runtime$20.jsx)(chip_default, {
					color: props.switch ? "success" : "default",
					variant: "flat",
					size: "lg",
					startContent: (0, import_jsx_runtime$20.jsx)(Power, {
						className: "w-4 h-4",
						"aria-hidden": "true"
					}),
				...
				children: [
					(0, import_jsx_runtime$20.jsxs)("span", {
						...
						children: [(0, import_jsx_runtime$20.jsx)(Hash, {
					...
					(0, import_jsx_runtime$20.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$20.jsx)(Users, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$20.jsxs)("span", {
							className: "truncate",
					...
					(0, import_jsx_runtime$20.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$20.jsx)(Heart, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$20.jsxs)("span", {
							className: "truncate",
					...
					(0, import_jsx_runtime$20.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$20.jsx)(UserPlus, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$20.jsxs)("span", {
							className: "truncate",
	...
	DouyinUserList = (prop) => (0, import_jsx_runtime$20.jsx)(DefaultLayout, {
		...prop,
		children: (0, import_jsx_runtime$20.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$20.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$20.jsx)("h2", {
				...
				"aria-label": "抖音用户列表",
				children: prop.data.renderOpt.map((user, index) => (0, import_jsx_runtime$20.jsx)(DouyinUserItem, { ...user }, `${user.short_id}-${index}`))
			})]
		})
	});
...
var import_react$21, import_jsx_runtime$19, DEFAULT_MUSIC_COVER, formatNumber$3, formatDate$2, formatDuration, StatBlock, DouyinVideoInfo, videoInfo_default$1;
var init_videoInfo$1 = __esmMin(() => {
	...
	formatDate$2 = (timestamp) => (/* @__PURE__ */ new Date(timestamp * 1e3)).toLocaleDateString("en-US", {
		year: "numeric",
		month: "short",
		day: "numeric"
	}).toUpperCase();
	...
	StatBlock = ({ label, value, icon }) => (0, import_jsx_runtime$19.jsxs)("div", {
		className: "flex flex-col gap-1 items-center",
		children: [
			(0, import_jsx_runtime$19.jsx)("div", {
				className: "p-4 mb-1 rounded-full bg-default-100",
				children: icon
			}),
	...
	DouyinVideoInfo = import_react$21.memo((props) => {
		const formattedDate = (0, import_react$21.useMemo)(() => formatDate$2(props.data.create_time), [props.data.create_time]);
		const duration = (0, import_react$21.useMemo)(() => props.data.video ? formatDuration(props.data.video.duration) : null, [props.data.video]);
		const mainTag = (0, import_react$21.useMemo)(() => "DOUYIN", []);
		const musicCover = (0, import_react$21.useMemo)(() => props.data.music?.cover || DEFAULT_MUSIC_COVER, [props.data.music?.cover]);
		const featureText = (0, import_react$21.useMemo)(() => props.data.video?.ratio?.toUpperCase() || "VIDEO", [props.data.video]);
		const { coverStyle, blurLayerStyle, contentStyle } = (0, import_react$21.useMemo)(() => {
			...
			return {
				coverStyle: {
					...
					height: "auto",
					display: "block",
					maskImage: `linear-gradient(to bottom, \n            black 0%, \n            black calc(100% - ${gradientHeight}px), \n            rgba(0,0,0,0.8) calc(100% - ${gradientHeight * .7}px),\n            rgba(0,0,0,0.5) calc(100% - ${gradientHeight * .4}px),\n            rgba(0,0,0,0.2) calc(100% - ${gradientHeight * .15}px),\n            transparent 100%\n          )`,
				...
				contentStyle: { marginTop: `-120px` }
			};
		}, []);
		return (0, import_jsx_runtime$19.jsx)(DefaultLayout, {
			...props,
			children: (0, import_jsx_runtime$19.jsxs)("div", {
				className: "overflow-hidden relative w-full font-sans bg-default-50 text-default-900",
				children: [
					(0, import_jsx_runtime$19.jsxs)("div", {
						className: "flex absolute top-0 left-0 z-40 justify-between items-start p-16 w-full mix-blend-screen text-default-500",
						children: [(0, import_jsx_runtime$19.jsxs)("div", {
							className: "flex flex-col gap-2",
							children: [(0, import_jsx_runtime$19.jsxs)("div", {
								className: "flex gap-6 items-center",
								children: [(0, import_jsx_runtime$19.jsx)("span", {
									className: "px-6 py-2 text-3xl font-bold tracking-wider uppercase rounded-full border backdrop-blur-sm border-default-500",
									children: featureText
								}), duration && (0, import_jsx_runtime$19.jsxs)("div", {
									className: "flex gap-3 items-center font-mono text-3xl font-medium",
									children: [(0, import_jsx_runtime$19.jsx)(Clock, { size: 40 }), (0, import_jsx_runtime$19.jsx)("span", { children: duration })]
								})]
							}), (0, import_jsx_runtime$19.jsx)("div", {
								className: "pr-8 pb-4 mt-6 text-9xl italic font-black tracking-tighter bg-clip-text from-default-900 bg-linear-to-r to-default-500",
								children: mainTag
							})]
						}), (0, import_jsx_runtime$19.jsx)("div", {
					...
					(0, import_jsx_runtime$19.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$19.jsx)("img", {
							...
							className: "overflow-hidden absolute top-0 left-0 w-full h-full pointer-events-none -z-10",
							children: (0, import_jsx_runtime$19.jsx)("img", {
								src: props.data.image_url,
								alt: "Atmosphere",
								className: "blur-3xl saturate-150 opacity-95 scale-[1.02]",
								style: blurLayerStyle
							})
						})]
					}),
					(0, import_jsx_runtime$19.jsxs)("div", {
						className: "flex relative z-30 flex-col gap-12 p-16 pb-10 w-full",
						style: contentStyle,
						children: [
							(0, import_jsx_runtime$19.jsx)("div", {
								className: "relative",
								children: (0, import_jsx_runtime$19.jsx)("h2", {
									className: "text-6xl font-bold leading-snug overflow-hidden text-justify text-default-900",
									children: props.data.desc
								})
							}),
							props.data.music && (0, import_jsx_runtime$19.jsxs)("div", {
								className: "flex flex-row-reverse gap-8 items-center self-end mb-4 text-right",
								children: [(0, import_jsx_runtime$19.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$19.jsx)("span", {
										className: "text-4xl font-bold line-clamp-1 max-w-[800px] text-default-900",
										children: props.data.music.title
									}), (0, import_jsx_runtime$19.jsx)("span", {
										className: "text-3xl font-medium text-default-500",
										children: props.data.music.author
									})]
								})]
							}),
							(0, import_jsx_runtime$19.jsxs)("div", {
								className: "flex gap-8 items-center py-8 my-4 border-t border-b border-default-200",
								children: [(0, import_jsx_runtime$19.jsxs)("div", {
									className: "relative",
									children: [(0, import_jsx_runtime$19.jsx)("img", {
										src: props.data.author.avatar,
										alt: props.data.author.name,
										className: "object-cover w-32 h-auto rounded-full border-5 border-white"
									}), (0, import_jsx_runtime$19.jsx)("div", {
										className: "absolute -bottom-3.5 left-1/2 -translate-x-1/2 bg-danger text-white p-1.5 rounded-full",
										children: (0, import_jsx_runtime$19.jsx)(Plus, {
											size: 26,
											strokeWidth: 3
										})
									})]
									...
									children: [(0, import_jsx_runtime$19.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$19.jsx)("span", {
											className: "text-5xl font-bold max-w-[600px] truncate",
											children: props.data.author.name
										}), props.data.user_profile?.ip_location && (0, import_jsx_runtime$19.jsx)("span", {
											className: "px-3 py-1 text-2xl font-medium rounded-full border backdrop-blur-sm bg-default-100 border-default-200 text-default-500",
											children: props.data.user_profile.ip_location.replace("IP属地：", "")
										})]
									}), (0, import_jsx_runtime$19.jsxs)("div", {
										className: "flex flex-wrap gap-y-2 gap-x-6 items-center font-mono text-3xl text-default-400",
										children: [(0, import_jsx_runtime$19.jsxs)("span", { children: ["抖音号: ", props.data.author.short_id] }), props.data.user_profile && (0, import_jsx_runtime$19.jsxs)(import_jsx_runtime$19.Fragment, { children: [
											(0, import_jsx_runtime$19.jsx)("span", { children: "•" }),
											(0, import_jsx_runtime$19.jsxs)("span", { children: [formatNumber$3(props.data.user_profile.follower_count), " 粉丝"] }),
											(0, import_jsx_runtime$19.jsx)("span", { children: "•" }),
											(0, import_jsx_runtime$19.jsxs)("span", { children: [formatNumber$3(props.data.user_profile.total_favorited), " 获赞"] })
										] })]
									})]
								})]
							}),
							(0, import_jsx_runtime$19.jsxs)("div", {
								className: "grid grid-cols-4 gap-8 mt-4",
								children: [
									(0, import_jsx_runtime$19.jsx)(StatBlock, {
										label: "LIKES",
										value: props.data.statistics.digg_count,
										icon: (0, import_jsx_runtime$19.jsx)(Heart, {
											size: 48,
									...
									(0, import_jsx_runtime$19.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$19.jsx)("div", {
												className: "p-5 mb-1 rounded-full bg-default-100",
												children: (0, import_jsx_runtime$19.jsx)(MessageCircle, {
													size: 42,
													className: "text-default-900"
												})
											}),
											(0, import_jsx_runtime$19.jsx)("span", {
												className: "font-mono text-4xl font-bold tracking-tighter",
												children: formatNumber$3(props.data.statistics.comment_count)
											}),
											(0, import_jsx_runtime$19.jsx)("span", {
												className: "text-sm font-bold tracking-widest uppercase opacity-40",
												children: "COMMENTS"
									...
									(0, import_jsx_runtime$19.jsx)(StatBlock, {
										...
										icon: (0, import_jsx_runtime$19.jsx)(Star, {
											size: 48,
											className: "text-default-900"
										})
									}),
									(0, import_jsx_runtime$19.jsx)(StatBlock, {
										...
										icon: (0, import_jsx_runtime$19.jsx)(Share2, {
											size: 48,
											className: "text-default-900 pr-2"
										})
									})
								]
							})
...
var import_react$20, import_jsx_runtime$18, DouyinQrcodeImg, qrcodeImg_default$1;
var init_qrcodeImg$1 = __esmMin(() => {
	init_lucide_react();
	import_react$20 = __toESM(require_react(), 1);
	init_DefaultLayout();
	import_jsx_runtime$18 = __toESM(require_jsx_runtime(), 1);
	DouyinQrcodeImg = import_react$20.memo((props) => {
		const disclaimer = [
			"免责声明:",
			...
			children: (0, import_jsx_runtime$18.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$18.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$18.jsxs)("div", {
							className: "flex gap-4 items-center",
							children: [(0, import_jsx_runtime$18.jsx)(QrCode, { className: "w-12 h-12 text-foreground-600" }), (0, import_jsx_runtime$18.jsx)("h1", {
								className: "text-6xl font-bold text-foreground",
								children: "抖音扫码登录"
							})]
						}), (0, import_jsx_runtime$18.jsxs)("div", {
							className: "flex gap-3 items-center text-3xl text-default-600",
							children: [(0, import_jsx_runtime$18.jsx)(Clock, { className: "w-8 h-8" }), (0, import_jsx_runtime$18.jsx)("span", { children: "请在120秒内通过抖音APP扫码进行登录" })]
						})]
					}),
					(0, import_jsx_runtime$18.jsx)("div", { className: "h-12" }),
					(0, import_jsx_runtime$18.jsx)("div", {
						...
						children: (0, import_jsx_runtime$18.jsx)("div", {
							...
							children: props.data.qrCodeDataUrl ? (0, import_jsx_runtime$18.jsx)("div", {
								...
								children: [(0, import_jsx_runtime$18.jsx)(QrCode, { className: "w-16 h-16 text-default-500" }), (0, import_jsx_runtime$18.jsx)("span", {
					...
					(0, import_jsx_runtime$18.jsx)("div", { className: "h-10" }),
					(0, import_jsx_runtime$18.jsxs)("div", {
						className: "p-8 rounded-3xl border-2 shadow-lg bg-warning-50 border-warning-200",
						children: [(0, import_jsx_runtime$18.jsxs)("h3", {
							className: "flex gap-4 items-center mb-6 text-4xl font-semibold text-warning-700",
							children: [(0, import_jsx_runtime$18.jsx)(Shield, { className: "w-10 h-10 text-warning-600" }), "注意事项与免责声明"]
						}), (0, import_jsx_runtime$18.jsx)("div", {
							className: "space-y-4",
							children: disclaimer.split("\n").map((line, index) => (0, import_jsx_runtime$18.jsx)("p", {
...
var import_react$19, import_jsx_runtime$17, processCommentHTML$1, ImageWithSkeleton, QRCodeSection$1, VideoInfoHeader, CommentItemComponent$1, BilibiliComment, Comment_default$2;
var init_Comment$2 = __esmMin(() => {
	...
	ImageWithSkeleton = ({ src, alt, className = "", placeholder }) => {
		const [hasError, setHasError] = (0, import_react$19.useState)(false);
		const handleError = () => {
			setHasError(true);
		};
		...
		if (hasError) return (0, import_jsx_runtime$17.jsx)("div", {
		...
		return (0, import_jsx_runtime$17.jsx)("img", {
			src,
			alt,
	...
	QRCodeSection$1 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$17.jsx)("div", {
		className: "flex flex-col items-center",
		children: (0, import_jsx_runtime$17.jsx)("div", {
			className: "flex justify-center items-center w-[400px] h-[400px] p-4",
			children: qrCodeDataUrl ? (0, import_jsx_runtime$17.jsx)("img", {
				src: qrCodeDataUrl,
				alt: "二维码",
				className: "object-contain w-full h-full rounded-lg"
	...
	VideoInfoHeader = (props) => (0, import_jsx_runtime$17.jsx)("div", {
		className: "max-w-[1400px] mx-auto px-10 py-8",
			...
			children: [(0, import_jsx_runtime$17.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$17.jsx)("div", {
					...
					children: (0, import_jsx_runtime$17.jsxs)("div", {
						...
						}), props.Type === "视频" && props.Resolution && (0, import_jsx_runtime$17.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$17.jsx)("span", {
								className: "flex-shrink-0 mr-4 text-foreground-400",
								children: "类型"
							}), (0, import_jsx_runtime$17.jsx)("span", {
								className: "font-medium text-foreground-600",
								children: props.Type
						...
						props.Type === "视频" ? (0, import_jsx_runtime$17.jsxs)(import_jsx_runtime$17.Fragment, { children: [(0, import_jsx_runtime$17.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text whitespace-nowrap",
							children: [(0, import_jsx_runtime$17.jsx)("span", {
								className: "flex-shrink-0 mr-4 text-foreground-400",
								children: "大小"
						...
						})] }) : (0, import_jsx_runtime$17.jsx)(import_jsx_runtime$17.Fragment, { children: (0, import_jsx_runtime$17.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text whitespace-nowrap",
							children: [(0, import_jsx_runtime$17.jsx)("span", {
								className: "flex-shrink-0 mr-4 text-foreground-400",
								children: "图片"
				...
				className: "flex-shrink-0",
				children: (0, import_jsx_runtime$17.jsx)(QRCodeSection$1, { qrCodeDataUrl: props.qrCodeDataUrl })
			})]
		})
	});
	CommentItemComponent$1 = ({ isLast = false, ...props }) => (0, import_jsx_runtime$17.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$17.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$17.jsx)(ImageWithSkeleton, {
				...
				props.frame && (0, import_jsx_runtime$17.jsx)(ImageWithSkeleton, {
					src: props.frame,
					alt: "头像框",
					className: "absolute inset-0 transform scale-120",
					placeholder: "头像框"
				}),
				props.vipstatus === 1 && (0, import_jsx_runtime$17.jsx)("div", {
			...
			children: [
					...
					children: [
						(0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [
								...
								props.level !== void 0 && props.level >= 0 && props.level <= 7 && (0, import_jsx_runtime$17.jsx)("img", {
									src: `/image/bilibili/level/lv${props.level}.svg`,
									alt: `等级${props.level}`,
									className: "inline-block flex-shrink-0 w-24 h-24 align-middle"
								}),
								props.isUP && (0, import_jsx_runtime$17.jsx)("img", {
						...
						props.fanCard && props.fanCard.image && (0, import_jsx_runtime$17.jsx)("div", {
						...
						props.label_type === 1 && (0, import_jsx_runtime$17.jsx)("div", {
						...
						props.status_label && (0, import_jsx_runtime$17.jsx)("div", {
				...
				(props.img_src || props.sticker) && (0, import_jsx_runtime$17.jsx)("div", {
					className: "flex my-5 overflow-hidden rounded-[25px] w-[95%] shadow-large",
					children: (0, import_jsx_runtime$17.jsx)(ImageWithSkeleton, {
					...
					children: [(0, import_jsx_runtime$17.jsx)("div", {
						...
						children: (0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [
								...
								" · ",
								props.location,
								props.replylength > 0 ? (0, import_jsx_runtime$17.jsxs)("span", {
						...
						children: (0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$17.jsx)(ThumbsUp, { className: "w-[60px] h-[60px] text-foreground-500" }), (0, import_jsx_runtime$17.jsx)("span", {
				...
				props.replies && props.replies.length > 0 && (0, import_jsx_runtime$17.jsx)("div", {
					className: "mt-10",
					children: props.replies.map((subReply, index) => (0, import_jsx_runtime$17.jsx)("div", { children: (0, import_jsx_runtime$17.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [
								...
								subReply.frame && (0, import_jsx_runtime$17.jsx)(ImageWithSkeleton, {
									src: subReply.frame,
									alt: "头像框",
									className: "absolute inset-0 transform scale-90",
									placeholder: "头像框"
								}),
								subReply.vipstatus === 1 && (0, import_jsx_runtime$17.jsx)("div", {
							...
							children: [
								(0, import_jsx_runtime$17.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$17.jsxs)("div", {
										...
										children: [
											...
											subReply.level !== void 0 && subReply.level >= 0 && subReply.level <= 7 && (0, import_jsx_runtime$17.jsx)("img", {
												src: `/image/bilibili/level/lv${subReply.level}.svg`,
												alt: `等级${subReply.level}`,
												className: "inline-block flex-shrink-0 w-24 h-24 align-middle"
											}),
											subReply.isUP && (0, import_jsx_runtime$17.jsx)("img", {
												src: "/image/bilibili/up_pb.svg",
												alt: "UP主标签",
												className: "inline-block flex-shrink-0 align-middle w-23 h-23"
											})
										]
									}), subReply.fanCard && subReply.fanCard.image && (0, import_jsx_runtime$17.jsx)("div", {
										className: "absolute -top-10 right-0 h-[180px] z-10 pointer-events-none",
										children: (0, import_jsx_runtime$17.jsxs)("div", {
											className: "inline-block relative h-full",
											children: [(0, import_jsx_runtime$17.jsx)("img", {
								...
								subReply.img_src && (0, import_jsx_runtime$17.jsx)("div", {
									className: "flex my-5 overflow-hidden rounded-[25px] w-[95%] shadow-large",
									children: (0, import_jsx_runtime$17.jsx)(ImageWithSkeleton, {
	...
	BilibiliComment = import_react$19.memo((props) => {
		const processedData = (0, import_react$19.useMemo)(() => {
		...
		return (0, import_jsx_runtime$17.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$17.jsxs)("div", {
				className: "p-5",
				children: [
					(0, import_jsx_runtime$17.jsx)("div", { className: "h-20" }),
					(0, import_jsx_runtime$17.jsx)(VideoInfoHeader, {
						...processedData,
						qrCodeDataUrl: props.qrCodeDataUrl
					}),
					(0, import_jsx_runtime$17.jsx)("div", {
						className: "overflow-hidden mt-8",
						children: processedData.CommentsData.length > 0 ? processedData.CommentsData.map((comment, index) => (0, import_jsx_runtime$17.jsx)(CommentItemComponent$1, {
							isLast: index === processedData.CommentsData.length - 1,
							...comment
						}, index)) : (0, import_jsx_runtime$17.jsx)("div", {
							className: "flex justify-center items-center py-20 text-foreground-400",
							children: (0, import_jsx_runtime$17.jsx)("div", {
								className: "text-center",
								children: (0, import_jsx_runtime$17.jsx)("p", {
									className: "text-xl",
									children: "暂无评论数据"
								})
							})
...
var import_react$18, import_jsx_runtime$16, processCommentHTML, CommentText, EnhancedImage, proxyImageUrl, processHtmlImages, DecorationCard;
var init_shared = __esmMin(() => {
	...
	CommentText = ({ content, className, style }) => (0, import_jsx_runtime$16.jsx)("div", {
		className,
		style,
		dangerouslySetInnerHTML: { __html: processCommentHTML(content) }
	});
	EnhancedImage = ({ src, alt, className = "", placeholder, isCircular = false }) => {
		const [hasError, setHasError] = (0, import_react$18.useState)(false);
		const handleError = () => {
			setHasError(true);
		};
		if (!src || hasError) return (0, import_jsx_runtime$16.jsx)("div", {
	...
	proxyImageUrl = (url$1) => {
		if (!url$1 || !url$1.startsWith("http")) return url$1;
		return `https://images.weserv.nl/?url=${encodeURIComponent(url$1)}`;
	};
	processHtmlImages = (html) => {
		let processed = html;
		processed = processed.replace(/background-image:\s*url\(['"]?(https?:\/\/[^'")\s]+)['"]?\)/gi, (match, url$1) => `background-image: url('${proxyImageUrl(url$1)}')`);
		processed = processed.replace(/<img([^>]*?)src=['"]?(https?:\/\/[^'">\s]+)['"]?([^>]*?)>/gi, (match, before, url$1, after) => `<img${before}src="${proxyImageUrl(url$1)}"${after} referrerpolicy="no-referrer" crossorigin="anonymous">`);
		return processed;
	};
	DecorationCard = ({ html }) => (0, import_jsx_runtime$16.jsx)("div", {
		className: "font-bilifont",
		dangerouslySetInnerHTML: { __html: processHtmlImages(html) }
	});
});
var UserList_exports = __export({ default: () => UserList_default }, 1), import_jsx_runtime$15, BilibiliUserItem, BilibiliUserList, UserList_default;
var init_UserList = __esmMin(() => {
	...
	BilibiliUserItem = (props) => (0, import_jsx_runtime$15.jsxs)("li", {
		className: "flex items-center p-8 gap-8 rounded-3xl shadow-large bg-content1 select-text",
		children: [(0, import_jsx_runtime$15.jsx)(EnhancedImage, {
			...
			children: [(0, import_jsx_runtime$15.jsxs)("div", {
				className: "flex items-center gap-5 mb-3",
				children: [(0, import_jsx_runtime$15.jsxs)("span", {
					className: "text-4xl font-medium text-foreground select-text inline-flex items-center gap-2.5 truncate",
					children: [(0, import_jsx_runtime$15.jsx)(User, {
						className: "w-8 h-8 opacity-80 flex-shrink-0",
						"aria-hidden": "true"
				...
				}), (0, import_jsx_runtime$15.jsx)(chip_default, {
					color: props.switch ? "success" : "default",
					variant: "flat",
					size: "lg",
					startContent: (0, import_jsx_runtime$15.jsx)(Power, {
						className: "w-5 h-5",
						"aria-hidden": "true"
					}),
					className: "flex-shrink-0",
				...
				children: [
					...
					(0, import_jsx_runtime$15.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$15.jsx)(UserPlus, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$15.jsxs)("span", {
							className: "truncate",
	...
	BilibiliUserList = (prop) => (0, import_jsx_runtime$15.jsx)(DefaultLayout, {
		...prop,
		children: (0, import_jsx_runtime$15.jsxs)("div", {
			className: "w-full px-10 py-16",
			children: [(0, import_jsx_runtime$15.jsxs)("div", {
				className: "mb-8 p-7 rounded-3xl bg-content2 shadow-medium",
				children: [
					(0, import_jsx_runtime$15.jsx)("h2", {
						className: "text-5xl font-bold text-foreground mb-2 select-text",
						children: prop.data.groupInfo.groupName
					}),
					(0, import_jsx_runtime$15.jsxs)("p", {
						className: "text-2xl text-foreground/70 select-text",
						children: ["群号: ", prop.data.groupInfo.groupId]
					}),
					(0, import_jsx_runtime$15.jsxs)("p", {
			...
			}), (0, import_jsx_runtime$15.jsx)("ul", {
				className: "grid grid-cols-2 gap-7 list-none p-0",
				"aria-label": "B站用户列表",
				children: prop.data.renderOpt.map((user, index) => (0, import_jsx_runtime$15.jsx)(BilibiliUserItem, { ...user }, `${user.host_mid}-${index}`))
			})]
		})
	});
...
var import_react$16, import_jsx_runtime$14, formatNumber$2, formatDateParts, formatDateTime, BangumiBilibiliHeader, BangumiBilibiliEpisodes, BangumiBilibili, bangumi_default;
var init_bangumi = __esmMin(() => {
			...
			children: (0, import_jsx_runtime$14.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$14.jsxs)("div", {
					...
					children: [
						...
						props.upInfo && (0, import_jsx_runtime$14.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$14.jsxs)("div", {
								...
								children: [
									...
									props.upInfo.avatar_subscript_url && (0, import_jsx_runtime$14.jsx)(EnhancedImage, {
										className: "absolute -right-1 -bottom-1 w-8 h-8 select-text",
										src: props.upInfo.avatar_subscript_url,
										alt: "头像角标"
									}),
									props.upInfo.pendant?.image && (0, import_jsx_runtime$14.jsx)(EnhancedImage, {
								...
								children: [
									(0, import_jsx_runtime$14.jsxs)("div", {
										...
										children: [
											...
											props.upInfo.verify_type > 0 && (0, import_jsx_runtime$14.jsx)("div", {
												className: "flex items-center",
												children: props.upInfo.verify_type === 1 ? (0, import_jsx_runtime$14.jsx)(Shield, {
													size: 20,
													className: "text-warning"
												}) : (0, import_jsx_runtime$14.jsx)(Crown, {
													size: 20,
													className: "text-primary"
												})
											}),
											props.upInfo.vip_status === 1 && props.upInfo.vip_label?.text && (0, import_jsx_runtime$14.jsx)(chip_default, {
												size: "sm",
									...
									(0, import_jsx_runtime$14.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$14.jsx)(Users, { size: 30 }),
											(0, import_jsx_runtime$14.jsxs)("span", { children: [formatNumber$2(props.upInfo.follower), "粉丝"] }),
											props.upInfo.is_follow === 1 && (0, import_jsx_runtime$14.jsx)(chip_default, {
												size: "sm",
												color: "primary",
												variant: "flat",
									...
									(0, import_jsx_runtime$14.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$14.jsx)(Hash, { size: 20 }), (0, import_jsx_runtime$14.jsxs)("span", { children: ["UID: ", props.upInfo.mid] })]
									})
								]
							})]
						}),
						(0, import_jsx_runtime$14.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$14.jsx)("span", { children: "提示：请在120秒内发送" }),
								(0, import_jsx_runtime$14.jsx)(code_default, {
									size: "lg",
									color: "danger",
									children: " 第 ？ 集 "
								}),
								(0, import_jsx_runtime$14.jsx)("span", { children: "选择集数" })
							]
						})
					]
				}), (0, import_jsx_runtime$14.jsxs)("div", {
					className: "flex flex-col flex-1 justify-between text-foreground",
					children: [(0, import_jsx_runtime$14.jsxs)("div", { children: [
						(0, import_jsx_runtime$14.jsx)("div", {
							className: "mb-8 text-8xl font-bold leading-tight select-text",
							children: props.title
						}),
						props.subtitle && (0, import_jsx_runtime$14.jsx)("div", {
							className: "mb-12 text-4xl select-text text-foreground",
							children: props.subtitle
						}),
						props.styles && props.styles.length > 0 && (0, import_jsx_runtime$14.jsx)("div", {
							className: "flex flex-wrap gap-8 mb-12",
							children: props.styles.map((style, index) => (0, import_jsx_runtime$14.jsx)(chip_default, {
								radius: "sm",
								size: "lg",
						...
						actorList.length > 0 && (0, import_jsx_runtime$14.jsxs)("div", {
							className: "mb-12",
							children: [(0, import_jsx_runtime$14.jsxs)("div", {
								className: "flex gap-6 items-center mb-6 text-3xl select-text text-foreground",
								children: [(0, import_jsx_runtime$14.jsx)(Users, { size: 30 }), (0, import_jsx_runtime$14.jsx)("span", { children: "声优阵容" })]
							}), (0, import_jsx_runtime$14.jsxs)("div", {
								className: "flex flex-wrap gap-8",
								children: [actorList.slice(0, 6).map((actor, index) => (0, import_jsx_runtime$14.jsx)("div", {
									className: "text-3xl select-text text-foreground",
									children: actor
								}, index)), actorList.length > 6 && (0, import_jsx_runtime$14.jsxs)("div", {
									className: "text-3xl select-text text-foreground",
									children: [
										"等",
										actorList.length,
						...
						props.evaluate && (0, import_jsx_runtime$14.jsxs)("div", {
							className: "mb-12",
							children: [(0, import_jsx_runtime$14.jsxs)("div", {
								className: "flex gap-6 items-center mb-6 text-3xl select-text text-foreground",
								children: [(0, import_jsx_runtime$14.jsx)(Star, { size: 30 }), (0, import_jsx_runtime$14.jsx)("span", { children: "评价" })]
							}), (0, import_jsx_runtime$14.jsx)("div", {
	...
	BangumiBilibiliEpisodes = (props) => {
		...
		return (0, import_jsx_runtime$14.jsxs)("div", {
			className: "px-10",
			children: [(0, import_jsx_runtime$14.jsxs)("div", {
				className: "flex gap-8 items-center mb-20 text-5xl font-bold select-text text-foreground",
				children: [
					(0, import_jsx_runtime$14.jsx)(Play, { size: 46 }),
					(0, import_jsx_runtime$14.jsx)("span", { children: "剧集列表" }),
					(0, import_jsx_runtime$14.jsxs)(chip_default, {
						size: "lg",
						color: "danger",
						variant: "flat",
			...
			}), (0, import_jsx_runtime$14.jsx)("div", { children: flattenedEpisodes.map((item) => {
				...
				return (0, import_jsx_runtime$14.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$14.jsx)("div", {
						...
						children: isFirstOfDate ? (0, import_jsx_runtime$14.jsxs)(import_jsx_runtime$14.Fragment, { children: [
							(0, import_jsx_runtime$14.jsx)("div", {
							...
							!isLastOfAll && (0, import_jsx_runtime$14.jsx)("div", { className: clsx_default("mt-8 w-1 bg-divider", episodesInSameDate > 1 ? "h-110" : "h-95") })
						] }) : (0, import_jsx_runtime$14.jsxs)(import_jsx_runtime$14.Fragment, { children: [
							(0, import_jsx_runtime$14.jsx)("div", { className: "w-1 h-10 bg-divider" }),
							(0, import_jsx_runtime$14.jsx)("div", { className: "my-2 w-4 h-4 rounded-full bg-divider" }),
							(!isLastOfAll || episodesInSameDate > 1) && (0, import_jsx_runtime$14.jsx)("div", { className: clsx_default("w-1 bg-divider", isLastOfDate ? "h-110" : "h-130") })
						] })
					}), (0, import_jsx_runtime$14.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$14.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$14.jsx)("div", {
									...
									children: [(0, import_jsx_runtime$14.jsx)("div", {
										...
										children: [(0, import_jsx_runtime$14.jsx)(Calendar, { size: 30 }), (0, import_jsx_runtime$14.jsx)("span", { children: "发布了内容" })]
									})]
								})]
							}), (0, import_jsx_runtime$14.jsx)("div", {
								...
								children: [(0, import_jsx_runtime$14.jsx)("div", {
									...
									children: (0, import_jsx_runtime$14.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$14.jsx)(EnhancedImage, {
											...
											className: "object-cover w-full h-full select-text"
										}), episode.badge && (0, import_jsx_runtime$14.jsx)(chip_default, {
											radius: "lg",
											size: "lg",
									...
									children: [(0, import_jsx_runtime$14.jsx)("div", {
										...
										children: [
											(0, import_jsx_runtime$14.jsxs)("div", {
												...
												children: [(0, import_jsx_runtime$14.jsx)(Hash, { size: 36 }), (0, import_jsx_runtime$14.jsx)("span", {
													className: "truncate",
											...
											(0, import_jsx_runtime$14.jsxs)("div", {
												className: "flex gap-6 items-center select-text text-foreground-600",
												children: [(0, import_jsx_runtime$14.jsx)(Clock, { size: 36 }), (0, import_jsx_runtime$14.jsx)("span", {
											...
											(0, import_jsx_runtime$14.jsxs)("div", {
												className: "flex gap-6 items-center select-text text-foreground-600",
												children: [(0, import_jsx_runtime$14.jsx)(Share2, { size: 36 }), (0, import_jsx_runtime$14.jsx)("span", {
													className: "truncate",
	...
	BangumiBilibili = import_react$16.memo((props) => (0, import_jsx_runtime$14.jsx)(DefaultLayout, {
		...props,
		children: (0, import_jsx_runtime$14.jsxs)("div", {
			className: "p-4",
			children: [(0, import_jsx_runtime$14.jsx)(BangumiBilibiliHeader, {
			...
			}), (0, import_jsx_runtime$14.jsx)(BangumiBilibiliEpisodes, { ...props.data })]
		})
	}));
...
var import_react$15, import_jsx_runtime$13, BilibiliDynamicUserInfo, BilibiliDynamicContent, BilibiliDynamicStatus, BilibiliDynamicFooter, BilibiliDrawDynamic, DYNAMIC_TYPE_DRAW_default;
var init_DYNAMIC_TYPE_DRAW = __esmMin(() => {
	...
	BilibiliDynamicUserInfo = (props) => (0, import_jsx_runtime$13.jsxs)("div", {
		...
		children: [
			...
			props.decoration_card && (0, import_jsx_runtime$13.jsx)("div", {
				className: "pl-40",
				children: (0, import_jsx_runtime$13.jsx)("div", { dangerouslySetInnerHTML: { __html: props.decoration_card } })
			})
		]
	});
	BilibiliDynamicContent = (props) => {
		...
		return (0, import_jsx_runtime$13.jsxs)(import_jsx_runtime$13.Fragment, { children: [(0, import_jsx_runtime$13.jsxs)("div", {
		...
		}), props.image_url && Array.isArray(props.image_url) && props.image_url.length > 0 && (0, import_jsx_runtime$13.jsxs)("div", {
			className: "px-20",
			children: [
				layoutType === "grid" && (0, import_jsx_runtime$13.jsx)("div", {
					className: "grid grid-cols-3 gap-4 w-full",
					children: props.image_url.slice(0, 9).map((img, index) => (0, import_jsx_runtime$13.jsx)("div", {
				...
				layoutType === "waterfall" && (0, import_jsx_runtime$13.jsxs)("div", {
				...
				layoutType === "vertical" && props.image_url.map((img, index) => (0, import_jsx_runtime$13.jsxs)(import_react$15.Fragment, { children: [(0, import_jsx_runtime$13.jsx)("div", {
					className: "flex flex-col items-center",
					children: (0, import_jsx_runtime$13.jsx)("div", {
				...
				}), (0, import_jsx_runtime$13.jsx)("div", { className: "h-18" })] }, index)),
				(layoutType === "waterfall" || layoutType === "grid") && (0, import_jsx_runtime$13.jsx)("div", { className: "h-18" })
			]
		})] });
	};
	BilibiliDynamicStatus = (props) => (0, import_jsx_runtime$13.jsxs)("div", {
		...
		children: [
			(0, import_jsx_runtime$13.jsxs)("div", {
				...
				children: [
					...
					(0, import_jsx_runtime$13.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$13.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [
							(0, import_jsx_runtime$13.jsx)(MessageCircle, {
								size: 48,
					...
					(0, import_jsx_runtime$13.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [
							(0, import_jsx_runtime$13.jsx)(Share2, {
								size: 48,
			...
			(0, import_jsx_runtime$13.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$13.jsx)(LuFullscreen, {
						size: 48,
						className: "text-time"
					}),
					"图片生成于: ",
	...
	BilibiliDynamicFooter = (props) => (0, import_jsx_runtime$13.jsxs)("div", {
		className: "flex justify-between items-start px-20 pb-20",
	...
	BilibiliDrawDynamic = import_react$15.memo((props) => (0, import_jsx_runtime$13.jsx)(DefaultLayout, {
		...props,
		children: (0, import_jsx_runtime$13.jsxs)("div", {
			className: "p-4",
			children: [
				(0, import_jsx_runtime$13.jsx)("div", { className: "h-25" }),
				(0, import_jsx_runtime$13.jsx)(BilibiliDynamicUserInfo, {
				...
				(0, import_jsx_runtime$13.jsx)("div", { className: "h-15" }),
				(0, import_jsx_runtime$13.jsx)(BilibiliDynamicContent, {
					text: props.data.text,
					image_url: props.data.image_url,
					imageLayout: props.data.imageLayout
				}),
				(0, import_jsx_runtime$13.jsx)(BilibiliDynamicStatus, {
					dianzan: props.data.dianzan,
					pinglun: props.data.pinglun,
					share: props.data.share,
					render_time: props.data.render_time
				}),
				(0, import_jsx_runtime$13.jsx)("div", { className: "h-23" }),
				(0, import_jsx_runtime$13.jsx)(BilibiliDynamicFooter, {
					avatar_url: props.data.avatar_url,
					frame: props.data.frame,
					username: props.data.username,
...
var import_react$14, import_jsx_runtime$12, BilibiliVideoDynamicHeader, BilibiliVideoDynamicContent, BilibiliVideoDynamicFooter, BilibiliVideoDynamic, DYNAMIC_TYPE_AV_default;
var init_DYNAMIC_TYPE_AV = __esmMin(() => {
	...
	BilibiliVideoDynamicHeader = () => (0, import_jsx_runtime$12.jsxs)(import_jsx_runtime$12.Fragment, { children: [
		(0, import_jsx_runtime$12.jsx)("div", { className: "h-20" }),
	...
	BilibiliVideoDynamicContent = (props) => (0, import_jsx_runtime$12.jsxs)(import_jsx_runtime$12.Fragment, { children: [props.image_url && (0, import_jsx_runtime$12.jsxs)(import_jsx_runtime$12.Fragment, { children: [(0, import_jsx_runtime$12.jsx)("div", {
		className: "flex flex-col items-center",
	...
	}), (0, import_jsx_runtime$12.jsx)("div", { className: "h-5" })] }), (0, import_jsx_runtime$12.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime$12.jsx)("div", { className: "h-10" }),
			(0, import_jsx_runtime$12.jsx)("div", {
			...
			(0, import_jsx_runtime$12.jsx)("div", { className: "h-30" }),
			(0, import_jsx_runtime$12.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$12.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$12.jsxs)("div", {
						...
						children: [
							...
							(0, import_jsx_runtime$12.jsxs)("div", {
								className: "flex gap-3 items-center",
								children: [(0, import_jsx_runtime$12.jsx)(MessageCircle, {
									size: 48,
							...
							(0, import_jsx_runtime$12.jsxs)("div", {
								className: "flex gap-3 items-center",
								children: [(0, import_jsx_runtime$12.jsx)(Share2, {
									size: 48,
									className: "text-success"
								}), (0, import_jsx_runtime$12.jsxs)("span", {
									className: "select-text",
						...
						children: [
							(0, import_jsx_runtime$12.jsxs)("div", {
								className: "flex gap-3 items-center",
								children: [(0, import_jsx_runtime$12.jsx)(Coins, {
									size: 48,
									className: "text-warning"
								}), (0, import_jsx_runtime$12.jsxs)("span", {
									className: "select-text",
					...
					children: [
						...
						(0, import_jsx_runtime$12.jsxs)("div", {
							className: "flex gap-3 items-center whitespace-nowrap",
							children: [(0, import_jsx_runtime$12.jsx)(LuFullscreen, {
								size: 32,
								className: "text-time"
							}), (0, import_jsx_runtime$12.jsxs)("span", { children: ["图片生成于: ", format(/* @__PURE__ */ new Date(), "yyyy-MM-dd HH:mm:ss")] })]
						}),
						(0, import_jsx_runtime$12.jsxs)("div", {
							className: "flex gap-3 items-center",
			...
			(0, import_jsx_runtime$12.jsx)("div", { className: "h-40" })
		]
	})] });
	BilibiliVideoDynamicFooter = (props) => (0, import_jsx_runtime$12.jsxs)(import_jsx_runtime$12.Fragment, { children: [(0, import_jsx_runtime$12.jsx)("div", { className: "h-15" }), (0, import_jsx_runtime$12.jsxs)("div", {
		className: "flex justify-between items-start px-20 pb-20",
		children: [(0, import_jsx_runtime$12.jsxs)("div", {
			className: "flex flex-col gap-12",
			children: [(0, import_jsx_runtime$12.jsxs)("div", {
	...
	BilibiliVideoDynamic = import_react$14.memo((props) => (0, import_jsx_runtime$12.jsx)(DefaultLayout, {
		...props,
		children: (0, import_jsx_runtime$12.jsxs)("div", {
			className: "p-4",
			children: [
				(0, import_jsx_runtime$12.jsx)(BilibiliVideoDynamicHeader, {}),
				(0, import_jsx_runtime$12.jsx)(BilibiliVideoDynamicContent, {
					text: props.data.text,
				...
				(0, import_jsx_runtime$12.jsx)(BilibiliVideoDynamicFooter, {
					avatar_url: props.data.avatar_url,
					frame: props.data.frame,
					username: props.data.username,
					user_shortid: props.data.user_shortid,
...
var import_react$13, import_jsx_runtime$11, BilibiliForwardUserInfo, OriginalUserInfo, OriginalAVContent, OriginalDrawContent, OriginalWordContent, OriginalLiveRcmdContent, BilibiliForwardContent, BilibiliForwardStatus, BilibiliForwardFooter, BilibiliForwardDynamic, DYNAMIC_TYPE_FORWARD_default;
var init_DYNAMIC_TYPE_FORWARD = __esmMin(() => {
	...
	BilibiliForwardUserInfo = (props) => (0, import_jsx_runtime$11.jsxs)("div", {
		className: "flex gap-10 items-center px-0 pb-0 pl-24",
		children: [
	...
	OriginalUserInfo = (props) => (0, import_jsx_runtime$11.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$11.jsxs)("div", {
			...
			className: "shrink-0",
			children: (0, import_jsx_runtime$11.jsx)(DecorationCard, { html: props.decoration_card })
		})]
	});
	OriginalAVContent = ({ content }) => (0, import_jsx_runtime$11.jsxs)("div", {
		className: "px-12 py-8 mt-4 w-full rounded-3xl bg-default-200/60",
		children: [
			(0, import_jsx_runtime$11.jsx)(OriginalUserInfo, {
			...
			(0, import_jsx_runtime$11.jsx)("div", {
				...
				children: (0, import_jsx_runtime$11.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$11.jsx)(EnhancedImage, {
							src: content.cover,
							alt: "视频封面",
							className: "object-cover object-center absolute"
						}),
						(0, import_jsx_runtime$11.jsx)("div", { className: "absolute right-0 bottom-0 left-0 h-1/2 bg-linear-to-t to-transparent pointer-events-none from-black/75" }),
						(0, import_jsx_runtime$11.jsxs)("div", {
			...
			(0, import_jsx_runtime$11.jsx)("div", {
				...
				children: (0, import_jsx_runtime$11.jsx)("span", { dangerouslySetInnerHTML: { __html: content.title } })
			})
		]
	});
	OriginalDrawContent = ({ content }) => (0, import_jsx_runtime$11.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime$11.jsx)("div", {
				...
				children: (0, import_jsx_runtime$11.jsxs)("div", {
					...
					children: [content.title && (0, import_jsx_runtime$11.jsx)("span", {
						className: "text-6xl font-bold",
						children: content.title
					}), (0, import_jsx_runtime$11.jsx)(CommentText, {
			...
			content.image_url && content.image_url.length === 1 ? (0, import_jsx_runtime$11.jsx)("div", {
				...
				children: content.image_url?.map((img, index) => (0, import_jsx_runtime$11.jsx)("div", {
			...
			(0, import_jsx_runtime$11.jsx)("div", { className: "h-4" })
		]
	});
	OriginalWordContent = ({ content }) => (0, import_jsx_runtime$11.jsxs)("div", {
		className: "px-12 py-8 mt-4 w-full rounded-2xl bg-default-200/60",
		children: [(0, import_jsx_runtime$11.jsx)(OriginalUserInfo, {
			avatar_url: content.avatar_url,
			frame: content.frame,
			username: content.username,
			create_time: content.create_time,
	...
	OriginalLiveRcmdContent = ({ content }) => (0, import_jsx_runtime$11.jsxs)("div", {
		className: "px-12 py-8 mt-4 w-full rounded-2xl bg-default-200/60",
		children: [
			(0, import_jsx_runtime$11.jsx)(OriginalUserInfo, {
				avatar_url: content.avatar_url,
	...
	BilibiliForwardContent = (props) => (0, import_jsx_runtime$11.jsxs)(import_jsx_runtime$11.Fragment, { children: [
		(0, import_jsx_runtime$11.jsxs)("div", {
			className: "flex flex-col px-20 w-full leading-relaxed",
			children: [(0, import_jsx_runtime$11.jsx)("div", {
				className: "relative items-center text-5xl tracking-wider wrap-break-word text-foreground",
				children: (0, import_jsx_runtime$11.jsx)(CommentText, {
					className: clsx_default("text-[65px] tracking-[1.5px] leading-normal whitespace-pre-wrap text-foreground mb-[20px] select-text", "[&_svg]:inline [&_svg]:mb-4!", "[&_img]:mb-3 [&_img]:inline [&_img]:mx-1"),
					content: props.text,
					style: {
						wordBreak: "break-word",
						overflowWrap: "break-word"
			...
			}), props.imgList && props.imgList.length === 0 && (0, import_jsx_runtime$11.jsx)("div", { className: "h-15" })]
		}),
		props.imgList && props.imgList.length > 0 && (0, import_jsx_runtime$11.jsx)("div", {
			className: "flex flex-col items-center px-20 w-full",
			children: props.imgList.map((img, idx) => (0, import_jsx_runtime$11.jsxs)(import_react$13.Fragment, { children: [(0, import_jsx_runtime$11.jsx)("div", {
			...
			}), (0, import_jsx_runtime$11.jsx)("div", { className: "h-10" })] }, `${img}-${idx}`))
		}),
		(0, import_jsx_runtime$11.jsxs)("div", {
			className: "flex px-20",
			children: [
				props.original_content.DYNAMIC_TYPE_AV && (0, import_jsx_runtime$11.jsx)(OriginalAVContent, { content: props.original_content.DYNAMIC_TYPE_AV }),
				props.original_content.DYNAMIC_TYPE_DRAW && (0, import_jsx_runtime$11.jsx)(OriginalDrawContent, { content: props.original_content.DYNAMIC_TYPE_DRAW }),
				props.original_content.DYNAMIC_TYPE_WORD && (0, import_jsx_runtime$11.jsx)(OriginalWordContent, { content: props.original_content.DYNAMIC_TYPE_WORD }),
				props.original_content.DYNAMIC_TYPE_LIVE_RCMD && (0, import_jsx_runtime$11.jsx)(OriginalLiveRcmdContent, { content: props.original_content.DYNAMIC_TYPE_LIVE_RCMD })
			]
		})
	] });
	BilibiliForwardStatus = (props) => (0, import_jsx_runtime$11.jsxs)("div", {
		className: "flex flex-col gap-10 px-20 w-full leading-relaxed",
		children: [
			(0, import_jsx_runtime$11.jsxs)("div", {
				className: "flex gap-6 items-center text-5xl font-light tracking-normal select-text text-foreground-600",
			...
			(0, import_jsx_runtime$11.jsxs)("div", {
				className: "flex gap-2 items-center text-5xl font-light tracking-normal select-text text-foreground-600",
				children: [
					(0, import_jsx_runtime$11.jsx)(LuFullscreen, {
						size: 48,
						className: "text-time"
					}),
					"图片生成于: ",
	...
	BilibiliForwardFooter = (props) => (0, import_jsx_runtime$11.jsxs)("div", {
		className: "flex justify-between items-start px-20 pb-20",
		children: [(0, import_jsx_runtime$11.jsxs)("div", {
			className: "flex flex-col gap-12",
			children: [(0, import_jsx_runtime$11.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$11.jsxs)("div", {
						...
						children: [
							...
							(0, import_jsx_runtime$11.jsx)("div", { className: "w-full h-px bg-default-300" }),
							(0, import_jsx_runtime$11.jsx)("span", {
								className: "select-text font-medium text-4xl",
								children: props.total_favorited
							})
	...
	BilibiliForwardDynamic = import_react$13.memo((props) => (0, import_jsx_runtime$11.jsx)(DefaultLayout, {
		...props,
		children: (0, import_jsx_runtime$11.jsxs)("div", {
			className: "p-4",
			children: [
				(0, import_jsx_runtime$11.jsx)("div", { className: "h-15" }),
				(0, import_jsx_runtime$11.jsx)(BilibiliForwardUserInfo, {
					avatar_url: props.data.avatar_url,
					frame: props.data.frame,
					username: props.data.username,
					create_time: props.data.create_time,
				...
				(0, import_jsx_runtime$11.jsx)("div", { className: "h-15" }),
				(0, import_jsx_runtime$11.jsx)(BilibiliForwardContent, { ...props.data }),
				(0, import_jsx_runtime$11.jsx)("div", { className: "h-25" }),
				(0, import_jsx_runtime$11.jsx)(BilibiliForwardStatus, {
					dianzan: props.data.dianzan,
					pinglun: props.data.pinglun,
					share: props.data.share,
					render_time: props.data.render_time
				...
				(0, import_jsx_runtime$11.jsx)(BilibiliForwardFooter, {
					avatar_url: props.data.avatar_url,
					frame: props.data.frame,
					username: props.data.username,
					user_shortid: props.data.user_shortid,
...
var import_react$12, import_jsx_runtime$10, BilibiliLiveDynamicHeader, BilibiliLiveDynamicContent, BilibiliLiveDynamicFooter, BilibiliLiveDynamic, DYNAMIC_TYPE_LIVE_RCMD_default;
var init_DYNAMIC_TYPE_LIVE_RCMD = __esmMin(() => {
	...
	BilibiliLiveDynamicHeader = () => (0, import_jsx_runtime$10.jsxs)(import_jsx_runtime$10.Fragment, { children: [
		(0, import_jsx_runtime$10.jsx)("div", { className: "h-5" }),
	...
	BilibiliLiveDynamicContent = (props) => (0, import_jsx_runtime$10.jsxs)(import_jsx_runtime$10.Fragment, { children: [
		(0, import_jsx_runtime$10.jsx)("div", { className: "h-15" }),
		props.image_url && (0, import_jsx_runtime$10.jsxs)(import_jsx_runtime$10.Fragment, { children: [(0, import_jsx_runtime$10.jsx)("div", {
			className: "flex flex-col items-center",
		...
		(0, import_jsx_runtime$10.jsxs)("div", {
			...
			children: [
				...
				(0, import_jsx_runtime$10.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$10.jsx)(Radio, {
						size: 48,
						className: "text-primary"
					}), (0, import_jsx_runtime$10.jsx)("span", {
						className: "select-text",
				...
				(0, import_jsx_runtime$10.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$10.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$10.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$10.jsx)("div", {
								className: "text-6xl font-bold select-text text-foreground",
								children: (0, import_jsx_runtime$10.jsx)(CommentText, { content: props.username })
							}), (0, import_jsx_runtime$10.jsx)("img", {
				...
				(0, import_jsx_runtime$10.jsx)("div", { className: "h-50" })
			]
		})
	] });
	BilibiliLiveDynamicFooter = (props) => (0, import_jsx_runtime$10.jsxs)(import_jsx_runtime$10.Fragment, { children: [(0, import_jsx_runtime$10.jsxs)("div", {
		...
		children: (0, import_jsx_runtime$10.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$10.jsx)("div", {
				...
				children: (0, import_jsx_runtime$10.jsx)(BilibiliLiveDynamicHeader, {})
			}), (0, import_jsx_runtime$10.jsxs)("div", {
	...
	BilibiliLiveDynamic = import_react$12.memo((props) => (0, import_jsx_runtime$10.jsx)(DefaultLayout, {
		...props,
		children: (0, import_jsx_runtime$10.jsxs)("div", {
			className: "p-4",
			children: [(0, import_jsx_runtime$10.jsx)(BilibiliLiveDynamicContent, {
				image_url: props.data.image_url,
				text: props.data.text,
				...
				frame: props.data.frame,
				fans: props.data.fans
			}), (0, import_jsx_runtime$10.jsx)(BilibiliLiveDynamicFooter, {
				avatar_url: props.data.avatar_url,
				frame: props.data.frame,
				username: props.data.username,
				fans: props.data.fans,
...
var import_react$11, import_jsx_runtime$9, getFontLevelClass, renderTextNode, renderParagraphContent, parseOpusContent, sanitizeHtmlContent, BilibiliArticleUserInfo, BilibiliArticleContent, BilibiliArticleStatus, BilibiliArticleFooter, BilibiliArticleDynamic, DYNAMIC_TYPE_ARTICLE_default;
var init_DYNAMIC_TYPE_ARTICLE = __esmMin(() => {
	...
	renderTextNode = (node, nodeIndex) => {
		...
		if (style.link) return (0, import_jsx_runtime$9.jsx)("a", {
			href: style.link,
		...
		if (style.header) return (0, import_jsx_runtime$9.jsx)(`h${Math.min(Math.max(1, style.header), 6)}`, {
			className: classNames.join(" "),
			style: inlineStyle,
			children: words
		}, nodeIndex);
		if (style.blockquote) return (0, import_jsx_runtime$9.jsx)("blockquote", {
			className: classNames.join(" "),
			style: inlineStyle,
			children: words
		}, nodeIndex);
		if (style.list) return (0, import_jsx_runtime$9.jsx)(style.list === "ordered" ? "ol" : "ul", {
			className: classNames.join(" "),
			style: inlineStyle,
			children: (0, import_jsx_runtime$9.jsx)("li", { children: words })
		}, nodeIndex);
		return (0, import_jsx_runtime$9.jsx)("span", {
			className: classNames.join(" "),
			style: inlineStyle,
			children: words
		}, nodeIndex);
	...
	BilibiliArticleUserInfo = import_react$11.memo((props) => (0, import_jsx_runtime$9.jsxs)("div", {
		className: "flex gap-10 items-center px-0 pb-0 pl-24",
		children: [
			(0, import_jsx_runtime$9.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$9.jsx)(EnhancedImage, {
					...
					className: "w-32 h-32 rounded-full shadow-medium",
					isCircular: true
				}), props.data.frame && (0, import_jsx_runtime$9.jsx)(EnhancedImage, {
			...
			(0, import_jsx_runtime$9.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$9.jsx)("div", {
					className: "text-6xl font-bold select-text text-foreground",
					children: (0, import_jsx_runtime$9.jsx)("span", { dangerouslySetInnerHTML: { __html: props.data.username } })
				}), (0, import_jsx_runtime$9.jsxs)("div", {
					className: "flex gap-2 items-center text-4xl font-normal whitespace-nowrap text-foreground-500",
			...
			props.data.decoration_card && (0, import_jsx_runtime$9.jsx)("div", {
				className: "pl-40",
				children: (0, import_jsx_runtime$9.jsx)("div", { dangerouslySetInnerHTML: { __html: props.data.decoration_card.card_url } })
			})
		]
	}));
	BilibiliArticleContent = import_react$11.memo((props) => {
		const articleContentElements = import_react$11.useMemo(() => {
			if (props.data.opus) return parseOpusContent(props.data.opus);
			return null;
		}, [props.data.opus]);
		const sanitizedHtmlContent = import_react$11.useMemo(() => {
			const isJson = (() => {
				try {
		...
		return (0, import_jsx_runtime$9.jsxs)("div", {
			className: "flex flex-col px-20 w-full leading-relaxed",
			children: [
				(0, import_jsx_runtime$9.jsx)("div", {
					className: "mb-8",
					children: (0, import_jsx_runtime$9.jsx)("h1", {
						className: "text-[60px] font-bold leading-[1.4] tracking-[0.5px] text-foreground select-text",
						children: (0, import_jsx_runtime$9.jsx)(CommentText, { content: props.data.title })
					})
				}),
				props.data.banner_url && (0, import_jsx_runtime$9.jsx)("div", {
					className: "mb-8",
					children: (0, import_jsx_runtime$9.jsx)(EnhancedImage, {
				...
				props.data.summary && (0, import_jsx_runtime$9.jsx)("div", {
					className: "mb-8",
				...
				articleContentElements && (0, import_jsx_runtime$9.jsx)("div", {
					className: "flex-col items-center mb-8 select-text",
					children: articleContentElements
				}),
				sanitizedHtmlContent && (0, import_jsx_runtime$9.jsx)("div", {
					className: "flex-col items-center mb-8 select-text",
	...
	BilibiliArticleStatus = import_react$11.memo((props) => (0, import_jsx_runtime$9.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$9.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$9.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$9.jsx)(Heart, { size: 32 }),
				...
				(0, import_jsx_runtime$9.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$9.jsx)(MessageCircle, { size: 32 }),
						(0, import_jsx_runtime$9.jsx)("span", {
							className: "font-medium",
				...
				(0, import_jsx_runtime$9.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$9.jsx)(Share2, { size: 32 }),
						(0, import_jsx_runtime$9.jsx)("span", {
							className: "font-medium",
			...
			children: [
				(0, import_jsx_runtime$9.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [
						(0, import_jsx_runtime$9.jsx)(Eye, {
							size: 28,
							className: "text-view"
						}),
						(0, import_jsx_runtime$9.jsx)("span", {
				...
				(0, import_jsx_runtime$9.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [
						(0, import_jsx_runtime$9.jsx)(BookOpen, {
							size: 28,
							className: "text-coin"
						}),
						(0, import_jsx_runtime$9.jsx)("span", {
	...
	BilibiliArticleFooter = import_react$11.memo((props) => (0, import_jsx_runtime$9.jsxs)("div", {
		className: "flex justify-between items-start px-20 pb-20",
		children: [(0, import_jsx_runtime$9.jsxs)("div", {
			className: "flex flex-col gap-12",
			children: [(0, import_jsx_runtime$9.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$9.jsxs)("div", {
						...
						children: [
							...
							(0, import_jsx_runtime$9.jsx)("div", { className: "w-full h-px bg-default-300" }),
							(0, import_jsx_runtime$9.jsx)("span", {
								className: "select-text font-medium text-4xl",
	...
	BilibiliArticleDynamic = import_react$11.memo((props) => (0, import_jsx_runtime$9.jsx)(DefaultLayout, {
		data: props.data,
		...
		children: (0, import_jsx_runtime$9.jsxs)("div", {
			...
			children: [
				...
				(0, import_jsx_runtime$9.jsx)(BilibiliArticleUserInfo, { ...props }),
				(0, import_jsx_runtime$9.jsx)("div", { className: "h-15" }),
				(0, import_jsx_runtime$9.jsx)(BilibiliArticleContent, { ...props }),
				(0, import_jsx_runtime$9.jsx)(BilibiliArticleStatus, { ...props }),
				(0, import_jsx_runtime$9.jsx)("div", { className: "h-23" }),
				(0, import_jsx_runtime$9.jsx)(BilibiliArticleFooter, { ...props })
			]
		})
	}));
...
var import_react$10, import_jsx_runtime$8, formatNumber$1, formatDate$1, StatItem$1, BilibiliVideoInfo, videoInfo_default;
var init_videoInfo = __esmMin(() => {
	...
	StatItem$1 = import_react$10.memo(({ icon, value, label, iconColor = "text-foreground-500" }) => (0, import_jsx_runtime$8.jsxs)("div", {
		className: "flex gap-4 items-center",
		children: [
	...
	BilibiliVideoInfo = import_react$10.memo((props) => {
		const formattedDate = (0, import_react$10.useMemo)(() => formatDate$1(props.data.ctime), [props.data.ctime]);
		const statsData = (0, import_react$10.useMemo)(() => [
			{
				icon: (0, import_jsx_runtime$8.jsx)(Eye, { size: 48 }),
				...
				children: [
					(0, import_jsx_runtime$8.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$8.jsx)(EnhancedImage, {
							...
							className: "object-cover w-full h-full",
							placeholder: "视频封面"
						}), (0, import_jsx_runtime$8.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t to-transparent from-black/20" })]
					}),
					(0, import_jsx_runtime$8.jsxs)("div", {
						className: "p-20 pb-36",
						children: [
							(0, import_jsx_runtime$8.jsx)("h1", {
								className: "mb-8 text-7xl font-bold leading-tight text-foreground-900",
								children: props.data.title
							}),
							(0, import_jsx_runtime$8.jsx)("p", {
					...
					(0, import_jsx_runtime$8.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$8.jsx)("div", {
								...
								children: statsData.map((stat, index) => (0, import_jsx_runtime$8.jsx)(StatItem$1, {
									icon: stat.icon,
									value: stat.value,
									label: stat.label,
							...
							(0, import_jsx_runtime$8.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$8.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$8.jsxs)("div", {
										className: "flex gap-2 items-center",
										children: [(0, import_jsx_runtime$8.jsx)(Coins, { size: 48 }), (0, import_jsx_runtime$8.jsx)("span", {
											className: "font-medium",
											children: props.data.stat.coin
										})]
									}), (0, import_jsx_runtime$8.jsxs)("div", {
										className: "flex gap-2 items-center",
										children: [(0, import_jsx_runtime$8.jsx)(Share2, { size: 48 }), (0, import_jsx_runtime$8.jsx)("span", {
											className: "font-medium",
					...
					(0, import_jsx_runtime$8.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$8.jsxs)("div", {
							...
							children: (0, import_jsx_runtime$8.jsxs)(button_default, {
								size: "sm",
								className: "bg-[#FF6699] text-default-100 dark:text-default-900",
								children: [(0, import_jsx_runtime$8.jsx)(ExternalLink, { className: "mr-1 w-4 h-4" }), "观看"]
							})
						})]
					})
				]
...
var import_react$9, import_jsx_runtime$7, BilibiliQrcodeImg, qrcodeImg_default;
var init_qrcodeImg = __esmMin(() => {
	...
	BilibiliQrcodeImg = import_react$9.memo((props) => {
		const { data, qrCodeDataUrl } = props;
			...
			children: (0, import_jsx_runtime$7.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$7.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$7.jsxs)("div", {
							className: "flex gap-4 items-center",
							children: [(0, import_jsx_runtime$7.jsx)(QrCode, { className: "w-12 h-12 text-foreground-600" }), (0, import_jsx_runtime$7.jsx)("h1", {
								className: "text-6xl font-bold text-foreground",
								children: "B站扫码登录"
							})]
						}), (0, import_jsx_runtime$7.jsxs)("div", {
							className: "flex gap-3 items-center text-3xl text-default-600",
							children: [(0, import_jsx_runtime$7.jsx)(Clock, { className: "w-8 h-8" }), (0, import_jsx_runtime$7.jsx)("span", { children: "请在120秒内通过哔哩哔哩APP扫码进行登录" })]
						})]
					}),
					(0, import_jsx_runtime$7.jsx)("div", { className: "h-12" }),
					(0, import_jsx_runtime$7.jsx)("div", {
						className: "flex flex-col items-center",
						children: (0, import_jsx_runtime$7.jsxs)("div", {
							className: "flex overflow-hidden flex-col justify-center items-center p-12",
							children: [qrCodeDataUrl ? (0, import_jsx_runtime$7.jsx)("div", {
								className: "flex justify-center items-center w-120 h-120",
								...
								className: "flex flex-col gap-4 justify-center items-center w-120 h-120",
								children: [(0, import_jsx_runtime$7.jsx)(QrCode, { className: "w-16 h-16 text-default-500" }), (0, import_jsx_runtime$7.jsx)("span", {
									className: "text-2xl text-default-500",
									children: "未提供二维码图片"
								})]
							}), (0, import_jsx_runtime$7.jsxs)("div", {
								...
								}), (0, import_jsx_runtime$7.jsx)("pre", {
					...
					(0, import_jsx_runtime$7.jsx)("div", { className: "h-10" }),
					(0, import_jsx_runtime$7.jsxs)("div", {
						className: "p-8 rounded-3xl border-2 shadow-lg bg-warning-50 border-warning-200",
						children: [(0, import_jsx_runtime$7.jsxs)("h3", {
							className: "flex gap-4 items-center mb-6 text-4xl font-semibold text-warning-700",
							children: [(0, import_jsx_runtime$7.jsx)(Shield, { className: "w-10 h-10 text-warning-600" }), "注意事项与免责声明"]
						}), (0, import_jsx_runtime$7.jsx)("div", {
							className: "space-y-4",
							children: disclaimer.split("\n").map((line, index) => (0, import_jsx_runtime$7.jsx)("p", {
								className: `text-2xl leading-relaxed ${index === 0 ? "font-semibold text-warning-700" : "text-foreground-600"}`,
								children: line
							}, index))
						})]
...
var import_react$8, import_jsx_runtime$6, KuaishouQRCodeSection, KuaishouVideoInfoHeader, KuaishouCommentItemComponent, KuaishouComment, Comment_default$1;
var init_Comment$1 = __esmMin(() => {
	init_lucide_react();
	import_react$8 = __toESM(require_react(), 1);
	init_DefaultLayout();
	import_jsx_runtime$6 = __toESM(require_jsx_runtime(), 1);
	KuaishouQRCodeSection = ({ qrCodeDataUrl, type, imageLength }) => (0, import_jsx_runtime$6.jsxs)("div", {
	...
	KuaishouVideoInfoHeader = ({ type, commentLength, videoSize, likeCount, viewCount, imageLength }) => (0, import_jsx_runtime$6.jsx)("div", {
		...
		children: (0, import_jsx_runtime$6.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$6.jsx)("div", {
				...
				children: [
					...
					type === "视频" && (0, import_jsx_runtime$6.jsxs)(import_jsx_runtime$6.Fragment, { children: [
						(0, import_jsx_runtime$6.jsxs)("div", {
							className: "flex items-center p-2.5 tracking-[6px] text-[45px] text-left",
							children: [
								"视频大小：",
					...
					type === "图集" && (0, import_jsx_runtime$6.jsxs)("div", {
						className: "flex items-center p-2.5 tracking-[6px] text-[45px] text-left",
						children: [
							"图片数量：",
							imageLength,
	...
	KuaishouCommentItemComponent = ({ comment, isLast = false }) => (0, import_jsx_runtime$6.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$6.jsx)("img", {
			...
			children: [
				...
				(comment.commentimage || comment.sticker) && (0, import_jsx_runtime$6.jsx)("div", {
				...
				(0, import_jsx_runtime$6.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$6.jsxs)("div", {
						...
						children: [
							...
							comment.ip_label && (0, import_jsx_runtime$6.jsx)("span", {
								className: "text-[45px] select-text",
								children: comment.ip_label
							}),
							comment.reply_comment_total && comment.reply_comment_total > 0 ? (0, import_jsx_runtime$6.jsxs)("span", {
						...
						children: [(0, import_jsx_runtime$6.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$6.jsx)(Heart, {
								size: 60,
							...
							children: (0, import_jsx_runtime$6.jsx)(MessageCircle, {
								size: 60,
								className: "stroke-current"
							})
						})]
	...
	KuaishouComment = import_react$8.memo((props) => {
		const processedData = (0, import_react$8.useMemo)(() => {
			if (!props.data) return {
				commentsArray: [],
				type: "未知",
				commentLength: 0,
		...
		return (0, import_jsx_runtime$6.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$6.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$6.jsxs)("div", {
					className: "flex justify-between items-center max-w-[1200px] mx-auto p-5",
					children: [(0, import_jsx_runtime$6.jsx)(KuaishouVideoInfoHeader, {
					...
					}), (0, import_jsx_runtime$6.jsx)(KuaishouQRCodeSection, {
						qrCodeDataUrl: props.qrCodeDataUrl || "",
						type: processedData.type,
						imageLength: processedData.imageLength,
						useDarkTheme: processedData.useDarkTheme
					...
					children: processedData.commentsArray.length > 0 ? processedData.commentsArray.map((comment, index) => (0, import_jsx_runtime$6.jsx)(KuaishouCommentItemComponent, {
						comment,
						isLast: index === processedData.commentsArray.length - 1
					}, index)) : (0, import_jsx_runtime$6.jsx)("div", {
...
var import_react$7, import_jsx_runtime$5, formatNumber, formatDate, StatItem, XiaohongshuNoteInfo, noteInfo_default;
var init_noteInfo = __esmMin(() => {
	...
	StatItem = import_react$7.memo(({ icon, value, label, iconColor = "text-foreground-500" }) => (0, import_jsx_runtime$5.jsxs)("div", {
		className: "flex gap-4 items-center",
		children: [
	...
	XiaohongshuNoteInfo = import_react$7.memo((props) => {
		const formattedDate = (0, import_react$7.useMemo)(() => formatDate(props.data.time), [props.data.time]);
		const statsData = (0, import_react$7.useMemo)(() => [
			{
				icon: (0, import_jsx_runtime$5.jsx)(Heart, { size: 48 }),
				value: props.data.statistics.liked_count,
				label: "点赞",
				iconColor: "text-red-500"
			},
			{
				icon: (0, import_jsx_runtime$5.jsx)(MessageCircle, { size: 48 }),
				value: props.data.statistics.comment_count,
				label: "评论",
				iconColor: "text-blue-500"
			},
			{
				icon: (0, import_jsx_runtime$5.jsx)(Star, { size: 48 }),
				value: props.data.statistics.collected_count,
				label: "收藏",
				iconColor: "text-yellow-500"
			},
			{
				icon: (0, import_jsx_runtime$5.jsx)(Share2, { size: 48 }),
				value: props.data.statistics.share_count,
				label: "分享",
		...
		return (0, import_jsx_runtime$5.jsx)(DefaultLayout, {
			...props,
			children: (0, import_jsx_runtime$5.jsx)("div", { children: (0, import_jsx_runtime$5.jsxs)("div", {
				className: "overflow-hidden transition-all",
				children: [
					(0, import_jsx_runtime$5.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$5.jsx)("img", {
							...
							alt: props.data.desc,
							className: "object-cover w-full h-full"
						}), (0, import_jsx_runtime$5.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t to-transparent from-black/30" })]
					}),
					(0, import_jsx_runtime$5.jsxs)("div", {
						className: "p-20 pb-36",
						children: [
							props.data.title && (0, import_jsx_runtime$5.jsx)("h1", {
							...
							(0, import_jsx_runtime$5.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$5.jsxs)("div", {
									className: "flex gap-2 items-center",
									children: [(0, import_jsx_runtime$5.jsx)(Calendar, { size: 32 }), (0, import_jsx_runtime$5.jsx)("span", { children: formattedDate })]
								}), props.data.ip_location && (0, import_jsx_runtime$5.jsxs)("div", {
									className: "flex gap-2 items-center",
									children: [(0, import_jsx_runtime$5.jsx)(MapPin, { size: 32 }), (0, import_jsx_runtime$5.jsx)("span", { children: props.data.ip_location })]
								})]
							})
						]
					}),
					(0, import_jsx_runtime$5.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$5.jsx)("div", {
								className: "grid grid-cols-2 text-5xl gap-18",
								children: statsData.map((stat, index) => (0, import_jsx_runtime$5.jsx)(StatItem, {
									icon: stat.icon,
									value: stat.value,
									label: stat.label,
									iconColor: stat.iconColor
							...
							(0, import_jsx_runtime$5.jsx)("div", { className: "h-18" }),
							(0, import_jsx_runtime$5.jsxs)("div", {
								className: "flex justify-between items-center mb-8 text-5xl text-foreground-500",
								children: [(0, import_jsx_runtime$5.jsx)("div", { className: "flex gap-16 items-center" }), (0, import_jsx_runtime$5.jsx)("div", {
									className: "transform-gpu scale-[2.5] origin-right mb-8",
									children: (0, import_jsx_runtime$5.jsxs)(chip_default, {
										color: "danger",
										variant: "flat",
										size: "lg",
										radius: "sm",
					...
					(0, import_jsx_runtime$5.jsx)("div", { className: "h-18" }),
					(0, import_jsx_runtime$5.jsx)("div", { className: "h-0.5 bg-default-300" }),
					(0, import_jsx_runtime$5.jsxs)("div", {
						className: "flex justify-between items-center px-16 py-12 pb-0",
						children: [(0, import_jsx_runtime$5.jsxs)("div", {
							className: "flex gap-8 items-center",
							...
							className: "transform-gpu scale-[3.5] origin-right",
							children: (0, import_jsx_runtime$5.jsx)(button_default, {
								size: "sm",
								className: "text-white bg-[#FF2442]",
								children: (0, import_jsx_runtime$5.jsxs)("div", {
									className: "flex items-center",
									children: [(0, import_jsx_runtime$5.jsx)(ExternalLink, { className: "mr-1 w-4 h-4" }), (0, import_jsx_runtime$5.jsx)("span", { children: "查看原文" })]
								})
							})
						})]
					})
...
var import_react$6, import_jsx_runtime$4, QRCodeSection, NoteInfoHeader, CommentItemComponent, XiaohongshuComment, Comment_default;
var init_Comment = __esmMin(() => {
	init_lucide_react();
	import_react$6 = __toESM(require_react(), 1);
	init_DefaultLayout();
	import_jsx_runtime$4 = __toESM(require_jsx_runtime(), 1);
	QRCodeSection = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$4.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$4.jsx)("div", {
			...
			children: qrCodeDataUrl ? (0, import_jsx_runtime$4.jsx)("img", {
				src: qrCodeDataUrl,
				alt: "二维码",
				className: "object-contain"
			}) : (0, import_jsx_runtime$4.jsx)(QrCode, {
				size: 200,
	...
	NoteInfoHeader = ({ type, commentLength, imageLength, qrCodeDataUrl }) => (0, import_jsx_runtime$4.jsxs)("div", {
		className: "flex justify-between items-center max-w-[1200px] mx-auto p-5",
		children: [(0, import_jsx_runtime$4.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$4.jsx)("div", {
				...
				children: [
					...
					type === "图文" && imageLength && (0, import_jsx_runtime$4.jsxs)("div", {
						className: "tracking-[6px] text-[45px] select-text",
						children: [
							"图片数量：",
							imageLength,
		...
		}), (0, import_jsx_runtime$4.jsx)(QRCodeSection, { qrCodeDataUrl })]
	});
	CommentItemComponent = ({ comment, isLast = false }) => (0, import_jsx_runtime$4.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$4.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$4.jsx)("span", {
						...
						if (tag === "is_author") return (0, import_jsx_runtime$4.jsx)("div", {
							className: "inline-block px-6 py-3 ml-3 text-4xl rounded-full bg-default-100 text-default-500",
							children: "作者"
						}, index);
						else if (tag === "user_top") return (0, import_jsx_runtime$4.jsx)("div", {
				...
				comment.pictures && comment.pictures.length > 0 && (0, import_jsx_runtime$4.jsx)("div", {
					className: "flex my-5 overflow-hidden shadow-md rounded-2xl w-[95%] flex-1",
					children: (0, import_jsx_runtime$4.jsx)("img", {
						className: "object-contain w-full h-full rounded-2xl",
				...
				(0, import_jsx_runtime$4.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$4.jsxs)("div", {
						...
						children: [
							...
							parseInt(comment.sub_comment_count) > 0 ? (0, import_jsx_runtime$4.jsxs)("span", {
								className: "text-[40px] text-foreground-600",
								children: [
									"共",
						...
						children: [(0, import_jsx_runtime$4.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$4.jsx)(Heart, {
								size: 60,
							...
							children: (0, import_jsx_runtime$4.jsx)(MessageCircle, {
								size: 60,
				...
				comment.sub_comments && comment.sub_comments.length > 0 && (0, import_jsx_runtime$4.jsx)("div", {
					className: "pl-6 mt-6",
					children: comment.sub_comments.map((subComment, index) => (0, import_jsx_runtime$4.jsx)("div", {
							...
							children: [(0, import_jsx_runtime$4.jsx)("img", {
								...
								children: [
									(0, import_jsx_runtime$4.jsxs)("div", {
										...
										}), subComment.show_tags && subComment.show_tags.length > 0 && subComment.show_tags.map((tag, tagIndex) => tag === "is_author" ? (0, import_jsx_runtime$4.jsx)("div", {
	...
	XiaohongshuComment = import_react$6.memo((props) => (0, import_jsx_runtime$4.jsxs)(DefaultLayout, {
		...props,
		children: [
			(0, import_jsx_runtime$4.jsx)("div", { className: "h-30" }),
			(0, import_jsx_runtime$4.jsx)(NoteInfoHeader, {
			...
			(0, import_jsx_runtime$4.jsx)("div", {
				...
				children: props.data.CommentsData.length > 0 ? (0, import_jsx_runtime$4.jsx)("div", {
					className: "divide-y divide-divider",
					children: props.data.CommentsData.map((comment, index) => (0, import_jsx_runtime$4.jsx)(CommentItemComponent, {
						comment,
						isLast: index === props.data.CommentsData.length - 1
					}, comment.id))
				}) : (0, import_jsx_runtime$4.jsx)("div", {
...
var import_react$5, import_jsx_runtime$3, ICON_MAP, MenuItemComponent, MenuGroupComponent, Help, Help_default;
var init_Help = __esmMin(() => {
	...
	MenuItemComponent = ({ item }) => (0, import_jsx_runtime$3.jsx)(SmartGlowBorder, {
		className: "block",
		...
		children: (0, import_jsx_runtime$3.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$3.jsx)("div", {
				...
				children: (0, import_jsx_runtime$3.jsx)(GlowIcon, {
				...
				className: "flex-1 min-w-0",
				children: [(0, import_jsx_runtime$3.jsx)("h3", {
	...
	MenuGroupComponent = ({ group, startIndex }) => {
		...
		return (0, import_jsx_runtime$3.jsx)("div", {
			className: "px-10 py-10 rounded-2xl bg-muted/50",
			children: (0, import_jsx_runtime$3.jsxs)("div", { children: [
				(0, import_jsx_runtime$3.jsx)("h2", {
					className: "m-0 mb-8 text-[3rem] font-bold text-foreground",
					children: group.title
				}),
				(0, import_jsx_runtime$3.jsx)("div", {
					className: "grid grid-cols-2 gap-6",
					children: group.items.map((item, idx) => (0, import_jsx_runtime$3.jsx)(MenuItemComponent, {
						item,
						index: itemIndex++
					}, idx))
				}),
				group.subGroups?.map((sub, i) => (0, import_jsx_runtime$3.jsxs)("div", {
					className: "mt-10",
					children: [(0, import_jsx_runtime$3.jsx)("h3", {
						...
						className: "grid grid-cols-2 gap-6",
						children: sub.items.map((item, idx) => (0, import_jsx_runtime$3.jsx)(MenuItemComponent, {
							item,
							index: itemIndex++
						}, idx))
					})]
	...
	Help = import_react$5.memo((props) => {
		...
		return (0, import_jsx_runtime$3.jsxs)(DefaultLayout, {
			...props,
			children: [
				(0, import_jsx_runtime$3.jsx)("div", { className: "h-12" }),
				(0, import_jsx_runtime$3.jsx)("div", {
				...
				(0, import_jsx_runtime$3.jsx)("div", { className: "h-8" }),
				(0, import_jsx_runtime$3.jsx)("div", {
					...
					children: menuData.map((group, index) => {
						...
						return (0, import_jsx_runtime$3.jsx)(MenuGroupComponent, {
							group,
							startIndex
						}, index);
					})
...
var import_react$4, import_jsx_runtime$2, ansiColorMap, ansi256ToColor, convertAnsiToHtml, seededRandom, generateBugPositions, getLogLevelTheme, ADAPTER_LOGO_MAP, getAdapterLogo, ErrorHeader, VerificationQrCode, BusinessErrorDetails, handlerError, handlerError_default;
var init_handlerError = __esmMin(() => {
	...
	getAdapterLogo = (adapterName) => {
		...
		for (const [key, logoPath] of Object.entries(ADAPTER_LOGO_MAP)) if (nameLower.includes(key)) return (0, import_jsx_runtime$2.jsx)("img", {
			src: logoPath,
			className: "h-auto w-17",
			alt: adapterName
		});
		return (0, import_jsx_runtime$2.jsx)(Plug2, { className: "w-9 h-9 text-secondary" });
	};
	ErrorHeader = ({ method, timestamp, businessName }) => {
		const displayMethod = businessName || method;
		const errorEmojiUrl = import_react$4.useMemo(() => {
			const withoutSuffix = [
				343,
				1,
				342,
			...
			return `https://koishi.js.org/QFace/assets/qq_emoji/${num}/png/${num}${withoutSuffix.includes(num) ? "" : "_0"}.png`;
		}, []);
		const errorTitle = import_react$4.useMemo(() => {
			const titles = [
				"哎呀！出错啦~",
				"糟糕，翻车了！",
				"呜呜，坏掉惹",
		...
		return (0, import_jsx_runtime$2.jsx)("div", {
			className: "px-20 py-20 mx-auto",
			children: (0, import_jsx_runtime$2.jsx)("div", {
				className: "pl-12 border-l-4 border-danger",
					...
					children: [(0, import_jsx_runtime$2.jsx)("img", {
						...
						children: [
							(0, import_jsx_runtime$2.jsx)("h1", {
								className: "mb-6 text-8xl font-bold text-foreground",
								children: errorTitle
							}),
							...
							(0, import_jsx_runtime$2.jsxs)("div", {
								className: "mt-2",
								children: [(0, import_jsx_runtime$2.jsx)("div", {
									className: "mb-2 text-3xl text-default-400",
									children: "触发时间"
								}), (0, import_jsx_runtime$2.jsxs)("div", {
									className: "flex gap-3 items-center",
									children: [(0, import_jsx_runtime$2.jsx)(Clock, { className: "w-10 h-10 text-warning" }), (0, import_jsx_runtime$2.jsx)("span", {
	...
	VerificationQrCode = ({ qrCodeDataUrl, verificationUrl }) => {
		if (!qrCodeDataUrl) return null;
		return (0, import_jsx_runtime$2.jsx)("div", {
			className: "w-full max-w-[1440px] mx-auto px-20 py-8",
			children: (0, import_jsx_runtime$2.jsxs)("div", {
				className: "pl-8 border-l-4 border-warning",
				children: [(0, import_jsx_runtime$2.jsxs)("h3", {
					className: "flex gap-3 items-center mb-6 text-4xl font-medium text-foreground",
					children: [(0, import_jsx_runtime$2.jsx)(QrCode, { className: "w-10 h-10 text-warning" }), "人机验证"]
				}), (0, import_jsx_runtime$2.jsx)("div", {
					className: "p-8 rounded-lg border bg-warning/10 border-warning/30",
					children: (0, import_jsx_runtime$2.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$2.jsx)("div", {
							...
							children: [
								...
								(0, import_jsx_runtime$2.jsx)("p", {
									...
									children: "请在 120 秒内完成以下步骤"
								}),
								(0, import_jsx_runtime$2.jsxs)("div", {
									className: "space-y-3 text-3xl text-foreground",
									children: [
										(0, import_jsx_runtime$2.jsx)("p", { children: "1. 使用手机扫描左侧二维码" }),
										(0, import_jsx_runtime$2.jsx)("p", { children: "2. 在网页中完成人机验证" }),
										(0, import_jsx_runtime$2.jsx)("p", { children: "3. 将验证结果发送至此对话" })
									]
								}),
								verificationUrl && (0, import_jsx_runtime$2.jsx)("div", {
									className: "p-4 mt-6 rounded-lg bg-default/20",
									children: (0, import_jsx_runtime$2.jsx)("p", {
										className: "text-2xl break-all text-default-500",
	...
	BusinessErrorDetails = ({ error, logs, triggerCommand }) => (0, import_jsx_runtime$2.jsx)("div", {
		className: "w-full max-w-[1440px] mx-auto px-20 py-8",
		children: (0, import_jsx_runtime$2.jsxs)("div", {
			className: "space-y-12",
			children: [
				triggerCommand && (0, import_jsx_runtime$2.jsxs)("div", {
					className: "pl-8 border-l-2 border-default-200",
					children: [(0, import_jsx_runtime$2.jsxs)("h3", {
						className: "flex gap-3 items-center mb-8 text-4xl font-medium text-foreground",
						children: [(0, import_jsx_runtime$2.jsx)(Terminal, { className: "w-10 h-10" }), "触发命令"]
					}), (0, import_jsx_runtime$2.jsx)("div", {
						className: "p-10 font-bold rounded-lg",
						children: (0, import_jsx_runtime$2.jsx)("pre", {
				...
				(0, import_jsx_runtime$2.jsxs)("div", {
					className: "pl-8 border-l-2 border-danger",
					children: [(0, import_jsx_runtime$2.jsxs)("h3", {
						className: "flex gap-3 items-center mb-6 text-3xl font-medium text-foreground",
						children: [(0, import_jsx_runtime$2.jsx)(CircleAlert, { className: "w-8 h-8" }), "错误堆栈"]
					}), (0, import_jsx_runtime$2.jsx)("div", {
						className: "p-8 rounded-lg border bg-danger/5 border-danger/20",
						children: (0, import_jsx_runtime$2.jsx)("pre", {
				...
				logs && logs.length > 0 && (0, import_jsx_runtime$2.jsxs)("div", {
					className: "pl-8 border-l-2 border-default-200",
					children: [(0, import_jsx_runtime$2.jsxs)("h3", {
						className: "flex gap-3 items-center mb-6 text-3xl font-medium text-foreground",
						children: [(0, import_jsx_runtime$2.jsx)(FileText, { className: "w-8 h-8" }), "相关执行日志"]
					}), (0, import_jsx_runtime$2.jsx)("div", {
						className: "space-y-3",
						children: logs.map((log, index) => {
							const theme = getLogLevelTheme(log.level);
							return (0, import_jsx_runtime$2.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$2.jsx)("div", {
									...
									children: (0, import_jsx_runtime$2.jsx)("span", {
										className: `font-black text-6xl tracking-tight uppercase opacity-15 ${theme.textClass}`,
										children: log.level
									})
								}), (0, import_jsx_runtime$2.jsx)("div", {
									className: "p-5",
									children: (0, import_jsx_runtime$2.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$2.jsxs)("div", {
											className: "flex gap-2 items-center",
											children: [(0, import_jsx_runtime$2.jsx)(Clock, {
												size: 22,
												className: `shrink-0 mb-1 ${theme.iconClass}`
											}), (0, import_jsx_runtime$2.jsx)("span", {
												className: `text-xl font-mono font-semibold ${theme.textClass}`,
	...
	handlerError = (props) => {
		...
		const bugPositions = import_react$4.useMemo(() => generateBugPositions(50), []);
		return (0, import_jsx_runtime$2.jsxs)(DefaultLayout, {
			...props,
			children: [(0, import_jsx_runtime$2.jsx)("div", {
				className: "overflow-hidden fixed inset-0 pointer-events-none",
				style: { zIndex: 0 },
				children: bugPositions.map((pos, index) => (0, import_jsx_runtime$2.jsx)(FaBug, {
					className: "absolute",
					style: {
						width: `${pos.size}px`,
						height: `${pos.size}px`,
				...
				style: { zIndex: 1 },
				children: [
					(0, import_jsx_runtime$2.jsx)("div", { className: "h-[60px]" }),
					(0, import_jsx_runtime$2.jsx)(ErrorHeader, {
						type,
						platform,
						method,
						timestamp,
					...
					isVerification && (0, import_jsx_runtime$2.jsx)(VerificationQrCode, {
						qrCodeDataUrl,
						verificationUrl
					}),
					(0, import_jsx_runtime$2.jsx)(BusinessErrorDetails, {
						error: businessError,
						logs,
						triggerCommand
					}),
					(0, import_jsx_runtime$2.jsxs)("div", {
						className: "px-20 py-16 mx-auto space-y-8 w-full",
						children: [(0, import_jsx_runtime$2.jsxs)("div", {
							className: "space-y-5 tracking-widest",
							children: [
								(0, import_jsx_runtime$2.jsxs)("div", {
									...
									children: [
										...
										amagiVersion && (0, import_jsx_runtime$2.jsxs)("div", {
											className: "flex gap-4 items-center",
											children: [(0, import_jsx_runtime$2.jsx)("img", {
								...
								adapterInfo && (0, import_jsx_runtime$2.jsxs)("div", {
									className: "flex gap-4 items-center",
									children: [getAdapterLogo(adapterInfo.name), (0, import_jsx_runtime$2.jsxs)("div", { children: [(0, import_jsx_runtime$2.jsxs)("div", {
										className: "inline-flex gap-2 items-center text-2xl text-default-400",
										children: [(0, import_jsx_runtime$2.jsx)("span", { children: "适配器名称" }), (0, import_jsx_runtime$2.jsx)(chip_default, {
											color: "secondary",
											variant: "flat",
											size: "md",
											children: (0, import_jsx_runtime$2.jsx)("span", {
												className: "font-bold",
												children: adapterInfo.version.startsWith("v") ? adapterInfo.version : `v${adapterInfo.version}`
											})
										})]
									}), (0, import_jsx_runtime$2.jsx)("div", {
										className: "text-4xl font-bold text-foreground",
										children: adapterInfo.name
									})] })]
								}),
								(0, import_jsx_runtime$2.jsxs)("div", {
									className: "pt-3 space-y-2 border-t border-default-200",
									children: [data.buildTime && (0, import_jsx_runtime$2.jsxs)("div", {
										className: "flex gap-2 items-center text-2xl text-default-400",
										children: [(0, import_jsx_runtime$2.jsx)(MdAccessTime, { className: "w-5 h-5" }), (0, import_jsx_runtime$2.jsxs)("span", { children: ["插件编译于 ", data.buildTime] })]
									}), data.commitHash && (0, import_jsx_runtime$2.jsxs)("div", {
										className: "flex gap-2 items-center text-2xl text-default-400",
										children: [(0, import_jsx_runtime$2.jsx)(FaCodeBranch, { className: "w-5 h-5" }), (0, import_jsx_runtime$2.jsxs)("span", { children: ["Commit ", data.commitHash] })]
									})]
								})
							]
						}), (0, import_jsx_runtime$2.jsxs)("div", {
							className: "pl-8 border-l-2 text-default-400 border-primary",
							children: [
								(0, import_jsx_runtime$2.jsx)("p", {
									className: "mb-6 text-3xl leading-relaxed text-foreground",
									children: "需要帮助？请提供以下信息以便开发者快速定位问题："
								}),
								(0, import_jsx_runtime$2.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$2.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$2.jsx)("span", {
											...
											children: "1."
										}), (0, import_jsx_runtime$2.jsxs)("p", {
											className: "flex-1 text-3xl leading-relaxed",
											children: [(0, import_jsx_runtime$2.jsx)("span", {
												className: "font-semibold text-primary",
												children: "完整的错误截图"
											}), " - 包含本页面所有内容（错误堆栈、执行日志、版本信息等）"]
										})]
									}), (0, import_jsx_runtime$2.jsxs)("div", {
										className: "flex gap-3 items-baseline",
										children: [(0, import_jsx_runtime$2.jsx)("span", {
								...
								(0, import_jsx_runtime$2.jsxs)("div", {
									className: "pt-6 border-t border-default-200",
									children: [(0, import_jsx_runtime$2.jsx)("p", {
										className: "mb-4 text-3xl leading-relaxed text-foreground",
										children: "联系方式："
									}), (0, import_jsx_runtime$2.jsxs)("div", {
										className: "space-y-3",
										children: [(0, import_jsx_runtime$2.jsxs)("p", {
											className: "text-3xl",
											children: [
												"· 提交 ",
												(0, import_jsx_runtime$2.jsx)("span", {
											...
											className: "text-3xl",
											children: ["· 加入 QQ 群：", (0, import_jsx_runtime$2.jsx)("span", {
												className: "font-semibold text-primary",
												children: "795874649"
											})]
										})]
...
var import_react$3, import_jsx_runtime$1, Changelog, changelog_default;
var init_changelog = __esmMin(() => {
	init_dist();
	init_lucide_react();
	import_react$3 = __toESM(require_react(), 1);
	init_react_markdown();
	init_rehype_highlight();
	init_GlowImage();
	init_DefaultLayout();
	import_jsx_runtime$1 = __toESM(require_jsx_runtime(), 1);
	Changelog = import_react$3.memo((props) => (0, import_jsx_runtime$1.jsx)(DefaultLayout, {
		...props,
		style: {
		...
		children: (0, import_jsx_runtime$1.jsxs)("div", {
			...
			children: [props.data.Tip === true ? (0, import_jsx_runtime$1.jsxs)(import_jsx_runtime$1.Fragment, { children: [
				(0, import_jsx_runtime$1.jsxs)("div", {
					className: "inline-block relative mt-20",
					children: [
						(0, import_jsx_runtime$1.jsx)("div", { className: "absolute inset-0 bg-black rounded-2xl opacity-50 blur-xl translate-y-6 -z-10" }),
				...
				(0, import_jsx_runtime$1.jsxs)("div", {
					...
					children: [
						...
						(0, import_jsx_runtime$1.jsx)(GlowText, {
				...
				props.data.buildTime && (0, import_jsx_runtime$1.jsxs)("div", {
					className: "flex gap-4 opacity-50",
					children: [(0, import_jsx_runtime$1.jsxs)("div", {
						className: "text-4xl ml-17",
						children: ["更新频道:", (0, import_jsx_runtime$1.jsx)("span", {
							className: "font-bold text-warning-200",
							children: " 正式版"
						})]
					}), (0, import_jsx_runtime$1.jsxs)("div", {
						className: "text-4xl ml-15",
						children: ["编译于:", (0, import_jsx_runtime$1.jsxs)("span", {
							className: "font-bold text-warning-200",
							children: [" ", props.data.buildTime]
						})]
					})]
				})
			] }) : null, (0, import_jsx_runtime$1.jsx)(Markdown, {
				rehypePlugins: [rehypeHighlight],
				components: {
					h1: ({ children, ...props$1 }) => (0, import_jsx_runtime$1.jsx)("h1", {
						className: "text-[5.28em] font-semibold mb-8 pb-2 border-b-2 border-default-400 text-default-900",
						...props$1,
						children
					}),
					h2: ({ children, ...props$1 }) => (0, import_jsx_runtime$1.jsxs)("div", {
					...
					a: ({ children, href, ...props$1 }) => (0, import_jsx_runtime$1.jsxs)("a", {
						...
						children: [(0, import_jsx_runtime$1.jsx)(GlowText, {
							...
							glowStrength: 3,
							scale: 1.2,
							children: (0, import_jsx_runtime$1.jsx)(ExternalLink, { className: "w-[1.1em] h-[1.1em] -mb-[0.1em]" })
						})]
					}),
					img: ({ ...props$1 }) => (0, import_jsx_runtime$1.jsx)("img", {
						className: "max-w-full h-auto rounded",
						...props$1
					}),
					table: ({ children, ...props$1 }) => (0, import_jsx_runtime$1.jsx)("table", {
						className: "w-full border-collapse mb-[1.8em] text-default-900",
						...props$1,
						children
					}),
					th: ({ children, ...props$1 }) => (0, import_jsx_runtime$1.jsx)("th", {
						className: "px-5 py-3 font-semibold text-left border text-default-900 bg-default-200 border-default-400",
						...props$1,
						children
					}),
					td: ({ children, ...props$1 }) => (0, import_jsx_runtime$1.jsx)("td", {
...
var VersionWarning_exports = __export({ VersionWarning: () => VersionWarning }, 1), import_jsx_runtime, VersionWarning;
	...
	VersionWarning = (props) => {
		...
		return (0, import_jsx_runtime.jsxs)(DefaultLayout, {
			...
			children: [
				...
				(0, import_jsx_runtime.jsxs)("div", {
					className: "absolute bottom-[100px] right-[72px] pointer-events-none select-none opacity-[0.03]",
				...
				(0, import_jsx_runtime.jsxs)("div", {
					className: "relative z-10 flex flex-col justify-between h-full p-[72px]",
					children: [
						(0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									(0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											(0, import_jsx_runtime.jsx)("div", {
												className: "w-[2px] rounded-full mx-10",
									...
									}), (0, import_jsx_runtime.jsxs)("code", {
							...
							children: [(0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									(0, import_jsx_runtime.jsx)("svg", {
										...
										stroke: mutedColor,
										strokeWidth: "1.5",
										children: (0, import_jsx_runtime.jsx)("path", { d: "M12 2L22 20H2L12 2Z" })
									}),
									(0, import_jsx_runtime.jsx)("svg", {
								...
								children: [(0, import_jsx_runtime.jsxs)("div", {
									className: "flex flex-col items-end justify-end h-[100px]",
									children: [(0, import_jsx_runtime.jsx)("span", {
...
}), getPackageLogsPath, getLogLevel, CustomLogger, logger;
var init_logger = __esmMin(() => {
	...
	logger = new CustomLogger("default");
});
	...
	ResourcePathManager = class ResourcePathManager {
		...
		findDevelopmentDir(cwd) {
			...
			while (currentDir !== path.dirname(currentDir)) {
				...
				if (fs.existsSync(renderDir)) {
					if (!ResourcePathManager.initialized) logger.debug("开发模式：找到 render 目录:", renderDir);
					return currentDir;
				}
		...
		getPackageDirFromImportMeta() {
			try {
				...
				if (pluginDir) {
					if (!ResourcePathManager.initialized) logger.debug("从 pnpm 路径提取的插件目录:", pluginDir);
					return pluginDir;
				}
				const fallbackDir = this.findPluginDirByScanning();
				if (fallbackDir) {
					if (!ResourcePathManager.initialized) logger.debug("通过扫描找到的插件目录:", fallbackDir);
					return fallbackDir;
				}
				if (!ResourcePathManager.initialized) logger.debug(logger.yellow("无法找到插件目录，使用当前项目工作目录"));
				return process.cwd();
			} catch (error) {
		...
		extractPluginDirFromPnpmPath(pnpmPath) {
			...
			if (!ResourcePathManager.initialized) logger.debug("从 pnpm 路径提取的项目根目录:", projectRoot);
			const pluginsDir = path.join(projectRoot, "plugins");
			if (!fs.existsSync(pluginsDir)) {
				if (!ResourcePathManager.initialized) logger.debug("plugins 目录不存在:", pluginsDir);
				return null;
			}
		...
		findPluginDirByScanning() {
			...
			if (!fs.existsSync(pluginsDir)) {
				if (!ResourcePathManager.initialized) logger.debug("当前工作目录下没有 plugins 目录");
				return null;
			}
			return this.findKarinPluginInDir(pluginsDir);
		}
			...
			try {
				...
				for (const pluginDir of pluginDirs) {
					...
					if (fs.existsSync(karinPluginPath)) {
						if (!ResourcePathManager.initialized) logger.debug("找到包含 karin-plugin-kkk 的插件目录:", pluginPath);
						return pluginPath;
					}
				}
			} catch (error) {
				if (!ResourcePathManager.initialized) logger.debug("扫描插件目录失败:", error);
			}
			return null;
		}
		isPluginMode() {
