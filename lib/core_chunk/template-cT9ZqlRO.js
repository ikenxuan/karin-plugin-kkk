...
var init_DYNAMIC_TYPE_DRAW = __esmMin(() => {
	...
	BilibiliReserveCard = ({ reserve }) => {
		...
		return (0, import_jsx_runtime$14.jsx)("div", {
			...
			children: (0, import_jsx_runtime$14.jsx)("div", {
				className: "overflow-hidden rounded-2xl bg-default-100 shadow-medium",
					...
					children: [(0, import_jsx_runtime$14.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$14.jsx)("div", {
								className: "text-5xl font-medium text-foreground select-text leading-tight",
						...
						children: (0, import_jsx_runtime$14.jsx)(button_default, {
							startContent: (0, import_jsx_runtime$14.jsx)(Bell, { className: "scale-180 mr-4" }),
