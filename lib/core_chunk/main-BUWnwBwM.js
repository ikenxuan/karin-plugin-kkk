	...
	createQrCodePlugin = () => ({
		...
		async beforeRender(ctx) {
			...
			const toDataUrl = async (url) => {
				const svg = await import_browser.toString(url, {
					type: "svg",
					width: 600,
