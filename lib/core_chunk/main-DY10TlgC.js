...
import { C as Client, D as DynamicType, g as getBilibiliData, b as bilibiliApiUrls, w as wbi_sign, M as MajorType, a as getDouyinData, h as heicConvertExports, l as logger$1 } from "./vendor-DwKwWgoP.js";
import karin, { copyConfigSync, filesByExt, watch, logger, requireFileSync, segment, createNotFoundResponse, ffmpeg, ffprobe, karinPathHtml, render, common, createBadRequestResponse, createServerErrorResponse, createSuccessResponse, getBot, defineConfig, components, mkdirSync, config, range } from "node-karin";
import axios, { AxiosError } from "node-karin/axios";
import { pipeline } from "stream/promises";
import path, { join } from "node:path";
import reactServerRender from "./template.js";
import { getDouyinDB, getBilibiliDB, cleanOldDynamicCache, bilibiliDBInstance, douyinDBInstance } from "./db-vwsD-h_V.js";
