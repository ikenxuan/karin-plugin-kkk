...
import { $ as RefreshCw, At as BookOpen, B as Zap, C as zhCN, Ct as CircleFadingArrowUp, Dt as Calendar, E as init_date_fns, Et as CircleAlert, F as HeroUIProvider, Ft as require_react, G as TrendingUp, H as User, I as require_jsx_runtime, J as Star, K as ThumbsUp, L as IoSearch, M as code_default, Mt as clsx_default, N as chip_default, Nt as init_clsx, O as formatDistanceToNow, Ot as Bot, P as button_default, Pt as require_server_node, Q as Send, R as init_io5, S as init_locale, St as CircleQuestionMark, T as init_lu, Tt as CircleCheckBig, U as UserPlus, V as Users, W as TriangleAlert, X as Shield, Xt as Chalk, Y as Sparkles, Z as Share2, _ as FaCommentDots, _t as Crown, at as Music, b as AiFillStar, bt as Code, c as rehypeHighlight, ct as LogIn, d as MdAccessTime, dt as Info, et as Radio, f as init_md, ft as Heart, g as FaCodeBranch, gt as ExternalLink, h as FaBug, ht as Eye, it as Play, j as init_dist, jt as Bell, k as format$1, kt as Bookmark, l as init_react_markdown, lt as List, m as init_ri, mt as FileText, nt as Power, o as init_chalk, ot as MessageCircle, p as RiShareForwardFill, pt as Hash, q as Terminal, rt as Plug2, s as init_rehype_highlight, st as MapPin, tt as QrCode, u as Markdown, ut as Link, v as init_fa6, vt as CornerDownLeft, w as LuFullscreen, wt as CircleEllipsis, x as init_ai, xt as Clock, y as AiFillHeart, yt as Coins, z as init_lucide_react } from "./vendor-D4p_Su1W.js";
...
var init_Dynamic = __esmMin(() => {
	...
	InfoSection = (props) => (0, import_jsx_runtime$23.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime$23.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$23.jsx)(LuFullscreen, { className: "w-11 h-11 text-time text-time" }), (0, import_jsx_runtime$23.jsxs)("span", { children: ["图片生成于: ", format$1(/* @__PURE__ */ new Date(), "yyyy-MM-dd HH:mm:ss")] })]
			})
		]
	});
					...
					children: [
						...
						(0, import_jsx_runtime$11.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$11.jsx)(LuFullscreen, {
								size: 32,
								className: "text-time"
							}), (0, import_jsx_runtime$11.jsxs)("span", { children: ["图片生成于: ", format$1(/* @__PURE__ */ new Date(), "yyyy-MM-dd HH:mm:ss")] })]
						}),
						(0, import_jsx_runtime$11.jsxs)("div", {
							className: "flex gap-3 items-center",
