...
import { C as Client, D as DynamicType, g as getBilibiliData, b as bilibiliApiUrls, w as wbi_sign, M as MajorType, a as getDouyinData, h as heicConvertExports, l as logger$1 } from "./vendor-D_YWRBp0.js";
...
import { getDouyinDB, getBilibiliDB, cleanOldDynamicCache, bilibiliDBInstance, douyinDBInstance } from "./db-BgoXvLKr.js";
...
function bilibiliComments(commentsData, host_mid) {
  ...
  if (commentsData.data.top && commentsData.data.top.upper) {
    ...
    const ctime = getRelativeTimeFromTimestamp$2(topReply.ctime);
  ...
  for (const [i, reply] of commentsData.data.replies.entries()) {
    const ctime = getRelativeTimeFromTimestamp$2(reply.ctime);
