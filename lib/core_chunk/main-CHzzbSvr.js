		...
		async RESOURCES(iddata) {
			...
			switch (this.Type) {
				case "one_video": {
					...
					else await this.getvideo(Config.bilibili.videoQuality > 64 ? { playUrlData: nockData.data } : {
