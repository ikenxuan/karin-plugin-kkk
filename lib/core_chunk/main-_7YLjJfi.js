...
import { A as format, Bt as init_source, C as init_locale, D as init_date_fns, Gt as init_esm, Ht as init_axios, Kt as init_zod, Lt as require_express, O as fromUnixTime, Rt as require_protobufjs, Ut as axios_default, Vt as AxiosError$1, Wt as Xhshow, a as require_qr_code_styling, i as require_lib, j as differenceInSeconds, k as formatDistanceToNow, n as require_dist, o as init_lib, qt as zod_default, r as require_lib$1, s as Window, t as require_heic_convert, w as zhCN, zt as Chalk } from "./vendor-A43RycNj.js";
import { n as init_client, r as reactServerRender } from "./template-Ce1vIG1w.js";
...
var init_getdata$3 = __esmMin(() => {
	...
	DouyinData = async (data$1, cookie, requestConfig) => {
		...
		switch (data$1.methodType) {
			...
			case "imageAlbumWork":
			case "slidesWork": {
				const url$1 = douyinApiUrls$1.getWorkDetail({ aweme_id: data$1.aweme_id });
			...
			case "userProfile": {
				const url$1 = douyinApiUrls$1.getUserProfile({ sec_uid: data$1.sec_uid });
				const customConfig = {
					...baseRequestConfig,
					headers: {
			...
			case "emojiList": {
				const url$1 = douyinApiUrls$1.getEmojiList();
				return await GlobalGetData$3(data$1.methodType, {
					...baseRequestConfig,
					url: url$1
				});
			...
			case "userVideoList": {
				const url$1 = douyinApiUrls$1.getUserVideoList({ sec_uid: data$1.sec_uid });
				const customConfig = {
					...baseRequestConfig,
					headers: {
						...baseRequestConfig.headers,
			...
			case "suggestWords": {
				const url$1 = douyinApiUrls$1.getSuggestWords({ query: data$1.query });
				const customConfig = {
					...baseRequestConfig,
					headers: {
						...baseRequestConfig.headers,
			...
			case "dynamicEmojiList": {
				const url$1 = douyinApiUrls$1.getDynamicEmojiList();
				return await GlobalGetData$3(data$1.methodType, {
					...baseRequestConfig,
					url: buildSignedUrl(url$1, signType, userAgent)
				});
			...
			case "musicInfo": {
				const url$1 = douyinApiUrls$1.getMusicInfo({ music_id: data$1.music_id });
				return await GlobalGetData$3(data$1.methodType, {
					...baseRequestConfig,
					url: buildSignedUrl(url$1, signType, userAgent)
				});
			...
			case "liveRoomInfo": {
				let url$1 = douyinApiUrls$1.getLiveRoomInfo({
			...
			case "loginQrcode": {
				const url$1 = douyinApiUrls$1.getLoginQrcode({ verify_fp: data$1.verify_fp });
				return await GlobalGetData$3(data$1.methodType, {
					...baseRequestConfig,
					url: buildSignedUrl(url$1, signType, userAgent)
				});
			...
			case "danmakuList": {
				...
				if (totalDuration <= MAX_SEGMENT_DURATION) {
					const url$1 = douyinApiUrls$1.getDanmakuList({
						aweme_id: data$1.aweme_id,
...
}), SimpleLogger, logger$1, logMiddleware;
...
var init_getdata = __esmMin(() => {
	...
	fetchBilibili = async (data$1, cookie, requestConfig) => {
		...
		switch (data$1.methodType) {
			...
			case "videoDanmaku": {
				const url$1 = bilibiliApiUrls.getVideoDanmaku({
					cid: data$1.cid,
