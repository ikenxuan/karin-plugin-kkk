...
import { $ as Coins, A as Star, B as MessageCircle, C as User, D as ThumbsUp, E as TrendingUp, F as RefreshCw, G as Info, H as LogIn, I as Radio, It as Chalk, J as FileText, K as Heart, L as QrCode, M as Shield, N as Share2, O as ThumbsDown, P as Send, Q as CornerDownLeft, R as Play, S as Users, T as TriangleAlert, U as List, V as MapPin, W as Link, X as ExternalLink, Y as Eye, Z as Crown, _ as button_default, a as remarkGfm, at as Calendar, b as init_lucide_react, c as init_rehype_raw, ct as BookOpen, d as rehypeHighlight, dt as init_clsx, et as Code, f as init_react_markdown, ft as require_server_node, g as chip_default, gt as init_dedent, h as code_default, ht as dedent_default, i as init_remark_gfm, it as CircleAlert, j as Sparkles, k as Terminal, l as rehypeRaw, lt as Bell, m as init_dist, mt as require_js, nt as CircleQuestionMark, o as init_remark_breaks, ot as Bot, p as Markdown, pt as require_react, q as Hash, r as init_chalk, rt as CircleCheckBig, s as remarkBreaks, st as Bookmark, tt as Clock, u as init_rehype_highlight, ut as clsx_default, v as HeroUIProvider, w as UserPlus, x as Zap, y as require_jsx_runtime, z as Music } from "./vendor-DFVZL9Sg.js";
...
var import_react$25, import_jsx_runtime$24, GlowImage, GlowText, GlowIcon, GlowBorderContainer, SmartGlowBorder;
var init_GlowImage = __esmMin(() => {
	import_react$25 = __toESM(require_react());
	...
	GlowImage = ({ src, alt, className, imgClassName, mode = "blur-layer", blurRadius = 18, glowStrength = .6, scale = 1.06, shadowRadius = 28, crossOrigin }) => {
		const [shadowColor, setShadowColor] = import_react$25.useState("rgba(255,255,255,0.5)");
		...
		if (mode === "dominant-shadow") return (0, import_jsx_runtime$24.jsx)("img", {
			src,
			alt,
	...
	GlowText = ({ children, className, glowClassName, blurRadius = 12, glowStrength = .6, scale = 1.02 }) => (0, import_jsx_runtime$24.jsxs)("span", {
		className,
		style: {
			position: "relative",
			display: "inline-block"
	...
	GlowIcon = ({ Icon, iconProps = {}, className, glowColor, glowStrength = .8, glowRadius = 12, glowLayers = 3, glowSpread = 4 }) => {
		const dropShadow = import_react$25.useMemo(() => Array.from({ length: glowLayers }, (_, i) => {
		...
		return (0, import_jsx_runtime$24.jsx)("div", {
			...
			children: (0, import_jsx_runtime$24.jsx)(Icon, {
				...iconProps,
				style: {
					filter: dropShadow,
					...iconProps.style
	...
	SmartGlowBorder = ({ children, className, glowColor, glowStrength = .5, borderWidth = 1, borderRadius = "1.5rem", glowPosition = "left-top", lightInfluenceRange = .3, enableDynamicGlow = true }) => {
		const containerRef = import_react$25.useRef(null);
		const [detectedGlowColor, setDetectedGlowColor] = import_react$25.useState("rgb(245, 158, 11)");
		import_react$25.useEffect(() => {
		...
		return (0, import_jsx_runtime$24.jsx)("div", {
			ref: containerRef,
			children: (0, import_jsx_runtime$24.jsx)(GlowBorderContainer, {
				className,
...
}), import_jsx_runtime$23, DefaultLayout;
var init_DefaultLayout = __esmMin(() => {
	...
	DefaultLayout = ({ children, version, data, scale = 3, className = "", style = {} }) => {
		...
		return (0, import_jsx_runtime$23.jsx)(HeroUIProvider, { children: (0, import_jsx_runtime$23.jsxs)("div", {
			...
			children: [children, version ? (0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$23.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$23.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$23.jsx)(GlowImage, {
							src: "/image/logo.png",
							alt: "logo",
							...
							children: [(0, import_jsx_runtime$23.jsx)("div", {
								...
								children: (0, import_jsx_runtime$23.jsx)("span", { children: "karin-plugin" })
						...
						children: [(0, import_jsx_runtime$23.jsxs)("div", {
							...
							children: [version.releaseType === "Stable" ? (0, import_jsx_runtime$23.jsx)(CircleCheckBig, {
								strokeWidth: 3,
								className: "w-4 h-4 text-success/90"
							}) : version.releaseType === "Preview" ? (0, import_jsx_runtime$23.jsx)(TriangleAlert, {
								strokeWidth: 3,
								className: "w-4 h-4 text-warning"
							}) : (0, import_jsx_runtime$23.jsx)(Info, {
								strokeWidth: 3,
								className: "w-4 h-4"
							}), version.releaseType === "Stable" ? (0, import_jsx_runtime$23.jsx)("span", {
							...
							children: version.releaseType === "Stable" ? (0, import_jsx_runtime$23.jsxs)("span", {
								className: "text-success/90",
					...
					children: [
						(0, import_jsx_runtime$23.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$23.jsx)(GlowImage, {
								...
								children: [(0, import_jsx_runtime$23.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [(0, import_jsx_runtime$23.jsx)(Zap, {
										strokeWidth: 3,
						...
						(0, import_jsx_runtime$23.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }),
						(0, import_jsx_runtime$23.jsxs)("div", {
							className: "flex items-end space-x-8",
							children: [(0, import_jsx_runtime$23.jsx)(GlowImage, {
								src: "/image/vite.svg",
								...
								children: [(0, import_jsx_runtime$23.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [
										(0, import_jsx_runtime$23.jsx)(Code, {
											strokeWidth: 3,
											className: "w-4 h-4"
										}),
										(0, import_jsx_runtime$23.jsx)("span", { children: "Built with" }),
										(0, import_jsx_runtime$23.jsx)(GlowImage, {
			...
			}) : (0, import_jsx_runtime$23.jsx)("div", { className: "h-24" })]
		}) });
	};
});
...
var import_react$23, import_jsx_runtime$22, QRCodeSection$5, VideoInfoHeader$1, CommentItemComponent$2, DouyinComment, Comment_default$3;
var init_Comment$3 = __esmMin(() => {
	...
	QRCodeSection$5 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$22.jsx)("div", {
		...
		children: (0, import_jsx_runtime$22.jsx)("div", {
			...
			children: qrCodeDataUrl ? (0, import_jsx_runtime$22.jsx)("img", {
				...
				children: [(0, import_jsx_runtime$22.jsx)(QrCode, {
					size: 80,
					className: "mb-4"
	...
	VideoInfoHeader$1 = ({ type, commentLength, videoSize, videoFPS, imageLength, qrCodeDataUrl, useDarkTheme }) => (0, import_jsx_runtime$22.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$22.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$22.jsx)("div", {
				...
				children: [
					...
					type === "视频" && (0, import_jsx_runtime$22.jsxs)(import_jsx_runtime$22.Fragment, { children: [(0, import_jsx_runtime$22.jsxs)("div", {
						className: "flex items-center p-2.5 tracking-[6px] text-[45px] text-left select-text",
						children: [
							"视频大小：",
							videoSize,
					...
					(type === "图集" || type === "合辑") && (0, import_jsx_runtime$22.jsxs)("div", {
						className: "flex items-center p-2.5 tracking-[6px] text-[45px] text-left select-text",
						children: [
							"图片数量：",
							imageLength,
		...
		}), (0, import_jsx_runtime$22.jsx)(QRCodeSection$5, { qrCodeDataUrl })]
	});
	CommentItemComponent$2 = ({ comment, isLast = false }) => (0, import_jsx_runtime$22.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$22.jsxs)("div", {
					...
					children: [
						...
						comment.label_type === 1 && (0, import_jsx_runtime$22.jsx)("div", {
							className: "inline-block px-4 py-3 rounded-xl ml-3 text-4xl bg-[#fe2c55] text-white",
							children: "作者"
						}),
						comment.status_label && (0, import_jsx_runtime$22.jsx)("div", {
				...
				(comment.commentimage || comment.sticker) && (0, import_jsx_runtime$22.jsx)("div", {
				...
				(0, import_jsx_runtime$22.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$22.jsxs)("div", {
						...
						children: [
							...
							comment.reply_comment_total > 0 ? (0, import_jsx_runtime$22.jsxs)("span", {
						...
						children: [(0, import_jsx_runtime$22.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$22.jsx)(Heart, {
								size: 60,
							...
							children: (0, import_jsx_runtime$22.jsx)(MessageCircle, {
								size: 60,
				...
				comment.replyComment && Object.keys(comment.replyComment).length > 0 && (0, import_jsx_runtime$22.jsx)("div", {
							...
							children: [(0, import_jsx_runtime$22.jsx)("img", {
								...
								children: [
									(0, import_jsx_runtime$22.jsxs)("div", {
										...
										}), comment.replyComment.label_text !== "" && (0, import_jsx_runtime$22.jsx)("div", {
				...
				comment.replyComment && Object.keys(comment.replyComment).length > 0 && (0, import_jsx_runtime$22.jsx)("div", { className: "mx-auto mt-4 border-b-1 border-divider" })
			]
		})]
	});
	DouyinComment = import_react$23.memo((props) => {
		const processedData = (0, import_react$23.useMemo)(() => {
		...
		return (0, import_jsx_runtime$22.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$22.jsxs)("div", {
				className: "p-5",
				children: [(0, import_jsx_runtime$22.jsx)(VideoInfoHeader$1, {
					...
					children: processedData.commentsArray.length > 0 ? processedData.commentsArray.map((comment, index) => (0, import_jsx_runtime$22.jsx)(CommentItemComponent$2, {
						comment,
...
var import_react$22, import_jsx_runtime$21, DouyinHeader$1, CoverSection$1, InfoSection, UserInfoSection$1, QRCodeSection$4, CoCreatorsInfo, DouyinDynamic, Dynamic_default;
var init_Dynamic = __esmMin(() => {
	init_lucide_react();
	import_react$22 = __toESM(require_react());
	init_DefaultLayout();
	import_jsx_runtime$21 = __toESM(require_jsx_runtime());
	DouyinHeader$1 = ({ useDarkTheme }) => (0, import_jsx_runtime$21.jsxs)("div", {
	...
	CoverSection$1 = ({ imageUrl }) => (0, import_jsx_runtime$21.jsx)("div", {
	...
	InfoSection = ({ desc, dianzan, pinglun, shouchang, share, createTime }) => (0, import_jsx_runtime$21.jsxs)("div", {
			...
			(0, import_jsx_runtime$21.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$21.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$21.jsx)(Heart, { className: "w-11 h-11 text-like" }), (0, import_jsx_runtime$21.jsxs)("span", { children: [dianzan, "点赞"] })]
					}),
					(0, import_jsx_runtime$21.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$21.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$21.jsx)(MessageCircle, { className: "w-11 h-11 text-comment" }), (0, import_jsx_runtime$21.jsxs)("span", { children: [pinglun, "评论"] })]
					}),
					(0, import_jsx_runtime$21.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$21.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$21.jsx)(Bookmark, { className: "w-11 h-11" }), (0, import_jsx_runtime$21.jsxs)("span", { children: [shouchang, "收藏"] })]
					}),
					(0, import_jsx_runtime$21.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$21.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$21.jsx)(Share2, { className: "w-11 h-11 text-success" }), (0, import_jsx_runtime$21.jsxs)("span", { children: [share, "分享"] })]
					})
				]
			}),
			(0, import_jsx_runtime$21.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$21.jsx)(Clock, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$21.jsxs)("span", { children: ["发布于", createTime] })]
			})
		]
	});
	UserInfoSection$1 = ({ avater_url, username, douyinId, likes, following, followers, coCreatorCount }) => (0, import_jsx_runtime$21.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$21.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$21.jsx)("div", {
				...
				children: [(0, import_jsx_runtime$21.jsxs)("span", {
					...
					children: ["@", username]
				}), coCreatorCount && coCreatorCount > 0 && (0, import_jsx_runtime$21.jsxs)("div", {
					className: "gap-2 mt-3 inline-flex items-center rounded-[20px] bg-foreground-200 text-foreground-700 px-6 py-3 self-start",
					children: [(0, import_jsx_runtime$21.jsx)(Users, { className: "w-8 h-8" }), (0, import_jsx_runtime$21.jsxs)("span", {
			...
			children: [
				(0, import_jsx_runtime$21.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$21.jsx)(Hash, { className: "w-8 h-8" }), (0, import_jsx_runtime$21.jsxs)("span", { children: ["抖音号: ", douyinId] })]
				}),
				(0, import_jsx_runtime$21.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$21.jsx)(Heart, { className: "w-8 h-8 text-like" }), (0, import_jsx_runtime$21.jsxs)("span", { children: ["获赞: ", likes] })]
				}),
				(0, import_jsx_runtime$21.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$21.jsx)(Eye, { className: "w-8 h-8 text-view" }), (0, import_jsx_runtime$21.jsxs)("span", { children: ["关注: ", following] })]
				}),
				(0, import_jsx_runtime$21.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$21.jsx)(Users, { className: "w-8 h-8 text-follow" }), (0, import_jsx_runtime$21.jsxs)("span", { children: ["粉丝: ", followers] })]
				})
			]
		})]
	});
	QRCodeSection$4 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$21.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$21.jsx)("div", {
			...
			children: [(0, import_jsx_runtime$21.jsx)(QrCode, { className: "w-10 h-10" }), (0, import_jsx_runtime$21.jsx)("span", {
	...
	CoCreatorsInfo = ({ info }) => {
		...
		const listRef = import_react$22.useRef(null);
		const [visibleCount, setVisibleCount] = import_react$22.useState(items.length);
		...
		return (0, import_jsx_runtime$21.jsx)("div", {
			...
			children: (0, import_jsx_runtime$21.jsxs)("div", {
				...
				}), items.length > visibleCount && (0, import_jsx_runtime$21.jsxs)("div", {
					className: "flex flex-col items-center min-w-[152px] w-[152px] flex-shrink-0",
					children: [
						(0, import_jsx_runtime$21.jsx)("div", {
	...
	DouyinDynamic = (props) => {
		...
		return (0, import_jsx_runtime$21.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$21.jsxs)("div", { children: [
				(0, import_jsx_runtime$21.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$21.jsx)(DouyinHeader$1, { useDarkTheme: data.useDarkTheme }),
				(0, import_jsx_runtime$21.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$21.jsx)(CoverSection$1, { imageUrl: data.image_url }),
				(0, import_jsx_runtime$21.jsx)("div", { className: "h-[20px]" }),
				(0, import_jsx_runtime$21.jsx)(InfoSection, {
					desc: data.desc,
				...
				(0, import_jsx_runtime$21.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$21.jsx)("div", {
						className: "w-full",
						children: (0, import_jsx_runtime$21.jsx)(CoCreatorsInfo, { info: data.cooperation_info })
					}), (0, import_jsx_runtime$21.jsxs)("div", {
						className: "flex justify-between items-start",
						children: [(0, import_jsx_runtime$21.jsx)("div", {
							className: "flex flex-col gap-8 items-start w-[960px]",
							children: (0, import_jsx_runtime$21.jsx)(UserInfoSection$1, {
						...
						}), (0, import_jsx_runtime$21.jsx)(QRCodeSection$4, {
							qrCodeDataUrl,
							useDarkTheme: data.useDarkTheme
						})]
					})]
...
}), import_jsx_runtime$20, CoverSection, UserInfoSection, QRCodeSection$3, DouyinLive, Live_default;
var init_Live = __esmMin(() => {
	init_lucide_react();
	__toESM(require_react());
	init_DefaultLayout();
	import_jsx_runtime$20 = __toESM(require_jsx_runtime());
	CoverSection = ({ imageUrl }) => (0, import_jsx_runtime$20.jsx)("div", {
		className: "py-10",
	...
	UserInfoSection = ({ avater_url, username, fans }) => (0, import_jsx_runtime$20.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$20.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$20.jsx)("div", {
						...
						children: (0, import_jsx_runtime$20.jsx)("span", { children: username })
					}),
					(0, import_jsx_runtime$20.jsx)("div", { className: "w-4" }),
				...
				className: "flex gap-2 items-center",
				children: [(0, import_jsx_runtime$20.jsx)(Users, { className: "w-8 h-8 text-follow" }), (0, import_jsx_runtime$20.jsxs)("span", {
	...
	QRCodeSection$3 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$20.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$20.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$20.jsx)(QrCode, { className: "w-12 h-12" }), (0, import_jsx_runtime$20.jsx)("span", { children: "直播分享链接" })]
		}), (0, import_jsx_runtime$20.jsx)("div", {
	...
	DouyinLive = (props) => {
		...
		return (0, import_jsx_runtime$20.jsxs)(DefaultLayout, {
			...props,
			children: [(0, import_jsx_runtime$20.jsx)(CoverSection, { imageUrl: props.data.image_url }), (0, import_jsx_runtime$20.jsxs)("div", {
				className: "flex flex-col px-20",
				children: [
					(0, import_jsx_runtime$20.jsx)("div", { className: "h-[10px]" }),
					(0, import_jsx_runtime$20.jsx)("div", {
					...
					(0, import_jsx_runtime$20.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$20.jsxs)("div", {
								className: "flex gap-2 items-center",
								children: [(0, import_jsx_runtime$20.jsx)(Eye, { className: "w-11 h-11 text-view" }), (0, import_jsx_runtime$20.jsxs)("span", { children: ["观看总人数", props.data.总观看次数] })]
							}),
							(0, import_jsx_runtime$20.jsx)("span", { children: "|" }),
							(0, import_jsx_runtime$20.jsxs)("div", {
								className: "flex gap-2 items-center",
								children: [(0, import_jsx_runtime$20.jsx)(Users, { className: "w-11 h-11 text-follow" }), (0, import_jsx_runtime$20.jsxs)("span", { children: ["在线观众", props.data.在线观众] })]
							})
						]
					}),
					(0, import_jsx_runtime$20.jsx)("div", { className: "h-20" }),
					(0, import_jsx_runtime$20.jsx)(UserInfoSection, {
						avater_url: props.data.avater_url,
						username: props.data.username,
						fans: props.data.fans,
						useDarkTheme: props.data.useDarkTheme
					}),
					(0, import_jsx_runtime$20.jsx)("div", { className: "h-[120px]" }),
					(0, import_jsx_runtime$20.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$20.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$20.jsx)("div", {
								...
								children: (0, import_jsx_runtime$20.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$20.jsx)("div", { className: `w-[130%] h-[245px] mb-[52px] bg-cover bg-center bg-fixed ${props.data.useDarkTheme ? "bg-[url(/image/douyin/dylogo-light.svg)]" : "bg-[url(/image/douyin/dylogo-dark.svg)]"}` }), (0, import_jsx_runtime$20.jsx)("div", {
										className: "flex flex-col items-start",
										children: (0, import_jsx_runtime$20.jsx)("div", {
							...
							}), (0, import_jsx_runtime$20.jsx)(QRCodeSection$3, {
								qrCodeDataUrl,
								useDarkTheme: props.data.useDarkTheme
							})]
						})]
...
}), import_jsx_runtime$19, DouyinHeader, MusicCoverSection, MusicInfoSection, MusicAuthorInfoSection, MusicQRCodeSection, DouyinMusicInfo, MusicInfo_default;
var init_MusicInfo = __esmMin(() => {
	init_lucide_react();
	__toESM(require_react());
	init_DefaultLayout();
	import_jsx_runtime$19 = __toESM(require_jsx_runtime());
	DouyinHeader = ({ useDarkTheme }) => (0, import_jsx_runtime$19.jsxs)("div", {
		className: "flex items-center px-12 py-15",
	...
	MusicCoverSection = ({ imageUrl }) => (0, import_jsx_runtime$19.jsx)("div", {
		className: "flex flex-col items-center my-5",
		children: (0, import_jsx_runtime$19.jsx)("div", {
			className: "flex flex-col items-center overflow-hidden shadow-large rounded-[25px] w-[90%] relative",
			children: (0, import_jsx_runtime$19.jsx)("img", {
	...
	MusicInfoSection = ({ desc, musicId, userCount, createTime }) => (0, import_jsx_runtime$19.jsxs)("div", {
		className: "flex flex-col px-16 py-5",
		children: [
			...
			(0, import_jsx_runtime$19.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$19.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$19.jsx)(Music, { className: "w-11 h-11" }), (0, import_jsx_runtime$19.jsxs)("span", { children: ["音乐ID: ", musicId] })]
				}), (0, import_jsx_runtime$19.jsxs)("div", {
					className: "flex gap-2 items-center select-text",
					children: [(0, import_jsx_runtime$19.jsx)(Users, { className: "w-11 h-11 text-follow" }), (0, import_jsx_runtime$19.jsxs)("span", { children: [userCount, " 人使用过"] })]
				})]
			}),
			(0, import_jsx_runtime$19.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-default-500 font-light select-text",
				children: [(0, import_jsx_runtime$19.jsx)(Clock, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$19.jsxs)("span", { children: ["图片生成于", createTime] })]
			})
		]
	});
	MusicAuthorInfoSection = ({ avatarUrl, username, userShortId, totalFavorited, followingCount, fans }) => (0, import_jsx_runtime$19.jsxs)("div", {
		className: "flex flex-col pl-16",
		children: [(0, import_jsx_runtime$19.jsxs)("div", {
			className: "flex items-center mb-6",
			children: [(0, import_jsx_runtime$19.jsx)("img", {
			...
			children: [
				(0, import_jsx_runtime$19.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$19.jsx)(Hash, { className: "w-8 h-8" }), (0, import_jsx_runtime$19.jsxs)("span", { children: ["ID: ", userShortId] })]
				}),
				(0, import_jsx_runtime$19.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$19.jsx)(Heart, { className: "w-8 h-8 text-like" }), (0, import_jsx_runtime$19.jsxs)("span", { children: ["获赞: ", totalFavorited] })]
				}),
				(0, import_jsx_runtime$19.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$19.jsx)(UserPlus, { className: "w-8 h-8" }), (0, import_jsx_runtime$19.jsxs)("span", { children: ["关注: ", followingCount] })]
				}),
				(0, import_jsx_runtime$19.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$19.jsx)(Users, { className: "w-8 h-8 text-follow" }), (0, import_jsx_runtime$19.jsxs)("span", { children: ["粉丝: ", fans] })]
				})
			]
		})]
	});
	MusicQRCodeSection = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$19.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$19.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$19.jsx)(QrCode, { className: "w-11 h-11" }), (0, import_jsx_runtime$19.jsx)("span", { children: "文件直链：永久有效" })]
		}), (0, import_jsx_runtime$19.jsx)("div", {
	...
	DouyinMusicInfo = (props) => {
		...
		return (0, import_jsx_runtime$19.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$19.jsxs)("div", { children: [
				(0, import_jsx_runtime$19.jsx)(DouyinHeader, { useDarkTheme: data.useDarkTheme }),
				(0, import_jsx_runtime$19.jsx)(MusicCoverSection, {
					imageUrl: data.image_url,
					description: data.desc,
					useDarkTheme: data.useDarkTheme
				}),
				(0, import_jsx_runtime$19.jsx)("div", { className: "h-[90px]" }),
				(0, import_jsx_runtime$19.jsx)(MusicInfoSection, {
					desc: data.desc,
				...
				(0, import_jsx_runtime$19.jsx)("div", { className: "h-[100px]" }),
				(0, import_jsx_runtime$19.jsx)("div", {
				...
				(0, import_jsx_runtime$19.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$19.jsx)(MusicAuthorInfoSection, {
						...
						fans: data.fans,
						useDarkTheme: data.useDarkTheme
					}), (0, import_jsx_runtime$19.jsx)(MusicQRCodeSection, {
						qrCodeDataUrl,
						useDarkTheme: data.useDarkTheme
					})]
				})
...
var UserList_exports$1 = __export({ default: () => UserList_default$1 }), import_jsx_runtime$18, DouyinUserItem, DouyinUserList, UserList_default$1;
var init_UserList$1 = __esmMin(() => {
	init_lucide_react();
	__toESM(require_react());
	init_DefaultLayout();
	import_jsx_runtime$18 = __toESM(require_jsx_runtime());
	DouyinUserItem = ({ user, index }) => (0, import_jsx_runtime$18.jsxs)(import_jsx_runtime$18.Fragment, { children: [(0, import_jsx_runtime$18.jsxs)("li", {
				...
				children: [(0, import_jsx_runtime$18.jsxs)("span", {
					...
					children: [
						(0, import_jsx_runtime$18.jsxs)("span", {
							...
							children: [
								(0, import_jsx_runtime$18.jsx)(Hash, {
						...
						(0, import_jsx_runtime$18.jsxs)("span", {
							className: "inline-flex items-center gap-[12px]",
							children: [
								(0, import_jsx_runtime$18.jsx)(Users, {
									className: "w-[26px] h-[26px] opacity-70",
									"aria-hidden": "true"
								}),
								"粉丝: ",
						...
						(0, import_jsx_runtime$18.jsxs)("span", {
							className: "inline-flex items-center gap-[12px]",
							children: [
								(0, import_jsx_runtime$18.jsx)(Heart, {
									className: "w-[26px] h-[26px] opacity-70",
									"aria-hidden": "true"
								}),
								"获赞: ",
						...
						(0, import_jsx_runtime$18.jsxs)("span", {
							className: "inline-flex items-center gap-[12px]",
							children: [
								(0, import_jsx_runtime$18.jsx)(UserPlus, {
									className: "w-[26px] h-[26px] opacity-70",
									"aria-hidden": "true"
								}),
								"关注: ",
	...
	}), (0, import_jsx_runtime$18.jsx)("div", { className: "h-[36px]" })] });
	DouyinUserList = (prop) => (0, import_jsx_runtime$18.jsx)(DefaultLayout, {
		...prop,
		children: (0, import_jsx_runtime$18.jsx)("ul", {
			className: "flex flex-col-reverse items-center p-0 list-none",
			"aria-label": "抖音用户列表",
			children: prop.data.renderOpt.map((user, index) => (0, import_jsx_runtime$18.jsx)(DouyinUserItem, {
				user,
				index
			}, `${user.short_id}-${index}`))
		})
...
var import_react$18, import_jsx_runtime$17, formatNumber$3, formatDate$2, StatItem$2, DouyinVideoInfo, videoInfo_default$1;
var init_videoInfo$1 = __esmMin(() => {
	...
	StatItem$2 = import_react$18.memo(({ icon, value, label, iconColor = "text-foreground-500" }) => (0, import_jsx_runtime$17.jsxs)("div", {
	...
	DouyinVideoInfo = import_react$18.memo((props) => {
		const formattedDate = (0, import_react$18.useMemo)(() => formatDate$2(props.data.create_time), [props.data.create_time]);
		const statsData = (0, import_react$18.useMemo)(() => [
			{
				icon: (0, import_jsx_runtime$17.jsx)(Heart, { size: 48 }),
				value: props.data.statistics.digg_count,
				label: "点赞",
				iconColor: "text-like"
			},
			{
				icon: (0, import_jsx_runtime$17.jsx)(MessageCircle, { size: 48 }),
				value: props.data.statistics.comment_count,
				label: "评论",
				iconColor: "text-comment"
			},
			{
				icon: (0, import_jsx_runtime$17.jsx)(Star, { size: 48 }),
				value: props.data.statistics.collect_count,
				label: "收藏",
				iconColor: "text-yellow-500"
			},
			{
				icon: (0, import_jsx_runtime$17.jsx)(Share2, { size: 48 }),
		...
		return (0, import_jsx_runtime$17.jsx)(DefaultLayout, {
			...props,
			children: (0, import_jsx_runtime$17.jsx)("div", { children: (0, import_jsx_runtime$17.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$17.jsxs)("div", {
						...
						}), (0, import_jsx_runtime$17.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t to-transparent from-black/30" })]
					}),
					(0, import_jsx_runtime$17.jsxs)("div", {
						className: "p-20 pb-36",
						children: [(0, import_jsx_runtime$17.jsx)("h1", {
							className: "mb-8 text-7xl font-bold leading-tight text-foreground-900",
							children: props.data.desc
						}), (0, import_jsx_runtime$17.jsx)("p", {
					...
					(0, import_jsx_runtime$17.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$17.jsx)("div", {
								...
								children: statsData.map((stat, index) => (0, import_jsx_runtime$17.jsx)(StatItem$2, {
									icon: stat.icon,
									value: stat.value,
									label: stat.label,
							...
							(0, import_jsx_runtime$17.jsx)("div", { className: "h-18" }),
							(0, import_jsx_runtime$17.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$17.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$17.jsxs)("div", {
										className: "flex gap-2 items-center",
										children: [
											(0, import_jsx_runtime$17.jsx)(TrendingUp, { size: 48 }),
											(0, import_jsx_runtime$17.jsx)("span", {
												className: "font-medium",
									...
									}), props.data.statistics.play_count > 0 && (0, import_jsx_runtime$17.jsxs)("div", {
										className: "flex gap-2 items-center",
										children: [
											(0, import_jsx_runtime$17.jsx)(Eye, { size: 48 }),
											(0, import_jsx_runtime$17.jsx)("span", {
												className: "font-medium",
									...
									children: (0, import_jsx_runtime$17.jsxs)(chip_default, {
										color: "primary",
										variant: "flat",
										size: "lg",
										radius: "sm",
					...
					(0, import_jsx_runtime$17.jsx)("div", { className: "h-18" }),
					(0, import_jsx_runtime$17.jsx)("div", { className: "h-0.5 bg-default-300" }),
					(0, import_jsx_runtime$17.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$17.jsx)("img", {
								...
								}), (0, import_jsx_runtime$17.jsxs)("p", {
							...
							children: (0, import_jsx_runtime$17.jsx)(button_default, {
								size: "sm",
								...
								children: (0, import_jsx_runtime$17.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$17.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$17.jsx)(ExternalLink, {
...
var import_react$17, import_jsx_runtime$16, processCommentHTML$1, CommentText$1, ImageWithSkeleton, QRCodeSection$2, InfoItem, VideoInfoHeader, CommentItemComponent$1, BilibiliComment, Comment_default$2;
var init_Comment$2 = __esmMin(() => {
	...
	CommentText$1 = ({ content, className, style }) => (0, import_jsx_runtime$16.jsx)("div", {
		className,
		style,
		...
		children: [(0, import_jsx_runtime$16.jsxs)("div", {
			...
			children: [
				...
				(0, import_jsx_runtime$16.jsxs)("div", {
					...
					children: [comment.isTop && (0, import_jsx_runtime$16.jsx)("span", {
						...
						children: "置顶"
					}), (0, import_jsx_runtime$16.jsx)(CommentText$1, {
...
var import_react$16, import_jsx_runtime$15, processCommentHTML, CommentText, EnhancedImage;
...
var import_react$9, import_jsx_runtime$8, getFontLevelClass, renderTextNode, renderParagraphContent, parseOpusContent, BilibiliArticleUserInfo, BilibiliArticleContent, BilibiliArticleStatus, BilibiliArticleFooter, BilibiliArticleDynamic, DYNAMIC_TYPE_ARTICLE_default;
...
var import_js, import_react, import_server_node, PluginContainer, ComponentRendererFactory, ResourcePathManager, HtmlWrapper, SSRRender, reactServerRender;
var init_main = __esmMin(() => {
	init_dedent();
	import_js = __toESM(require_js());
	...
	SSRRender = class {
		...
		async renderComponent(request) {
			try {
				...
				const formattedHtml = import_js.default.html(htmlContent, {
					indent_size: 2,
				...
				const fullHtml = this.htmlWrapper.wrapContent(ctx.state.html ?? formattedHtml, filePath, request.data.useDarkTheme ?? false);
