...
import { Bt as bilibiliApiUrls, D as formatDistanceToNow, E as fromUnixTime, Ft as require_lib$1, Gt as logMiddleware, Ht as createDouyinRoutes, It as require_lib, Jt as app$1, Kt as logger$1, Lt as Client, O as format, Pt as require_dist, Rt as DynamicType, S as zhCN, T as init_date_fns, Ut as createKuaishouRoutes, Vt as createBilibiliRoutes, Wt as init_default, Yt as init_dist, i as Window, k as differenceInSeconds, n as require_qr_code_styling, qt as wbi_sign, r as init_lib, t as require_heic_convert, x as init_locale, zt as MajorType } from "./vendor-BhYSy3kw.js";
import { n as init_client, r as reactServerRender } from "./template-DB1naB5J.js";
		...
		for (const awemeId in data) {
			...
			if (!skip) if (pushItem.living && "room_data" in pushItem.Detail_Data && Detail_Data.live_data) img$2 = await Render("douyin/live", {
				...
				img$2 = await Render("douyin/dynamic", {
					...
					create_time: format(fromUnixTime(pushItem.create_time / 1e3), "yyyy-MM-dd HH:mm"),
					avater_url: "https://p3-pc.douyinpic.com/aweme/1080x1080/" + Detail_Data.user_info.data.user.avatar_larger.uri,
