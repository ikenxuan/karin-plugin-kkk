...
var import_react$26, import_jsx_runtime$24, QRCodeSection$3, VideoInfoHeader$1, CommentItemComponent$2, DouyinComment, Comment_default$3;
var init_Comment$3 = __esmMin(() => {
	...
	CommentItemComponent$2 = (props) => (0, import_jsx_runtime$24.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$24.jsx)("img", {
			...
			children: [
				(0, import_jsx_runtime$24.jsxs)("div", {
					className: "flex flex-wrap gap-7 items-center mb-6 text-6xl select-text text-foreground-600",
					children: [
						(0, import_jsx_runtime$24.jsx)("span", {
						...
						props.label_type === 1 && (0, import_jsx_runtime$24.jsx)("div", {
							className: "inline-flex items-center px-4 py-2 rounded-xl text-4xl bg-[#fe2c55] text-white",
							children: "作者"
						}),
						props.is_author_digged && props.status_label !== "作者赞过" && (0, import_jsx_runtime$24.jsx)("div", {
							className: "inline-flex items-center px-4 py-2 text-4xl font-light rounded-xl bg-content2 text-foreground-700",
							children: "作者赞过"
						}),
				...
				(props.commentimage || props.sticker) && (0, import_jsx_runtime$24.jsx)("div", {
					className: "my-6 overflow-hidden shadow-lg rounded-2xl max-w-[800px]",
					children: (0, import_jsx_runtime$24.jsx)("img", {
				...
				(0, import_jsx_runtime$24.jsxs)("div", {
					className: "flex justify-between items-center mt-8 text-foreground-500",
					children: [(0, import_jsx_runtime$24.jsxs)("div", {
						className: "flex flex-wrap gap-6 items-center select-text",
						children: [(0, import_jsx_runtime$24.jsx)("span", {
							className: "text-5xl",
				...
				props.replyComment && Object.keys(props.replyComment).length > 0 && (0, import_jsx_runtime$24.jsx)("div", {
					className: "pt-8 pl-8 mt-10",
					children: (0, import_jsx_runtime$24.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$24.jsx)("img", {
							...
							children: [
								(0, import_jsx_runtime$24.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$24.jsx)("span", {
										className: "text-6xl font-medium text-foreground-600",
										children: props.replyComment.nickname
									}), props.replyComment.label_text !== "" && (0, import_jsx_runtime$24.jsx)("div", {
										className: clsx_default("inline-flex items-center px-4 py-2 text-4xl rounded-xl", props.replyComment.label_text === "作者" ? "bg-[#fe2c55] text-white" : "bg-default-100 text-default-500"),
										children: props.replyComment.label_text
									})]
								}),
								(0, import_jsx_runtime$24.jsx)("div", {
								...
								props.replyComment.image_list && props.replyComment.image_list.length > 0 && props.replyComment.image_list.filter(Boolean).map((img, idx) => (0, import_jsx_runtime$24.jsx)("div", {
									className: "my-6 overflow-hidden shadow-lg rounded-2xl max-w-[800px]",
									children: (0, import_jsx_runtime$24.jsx)("img", {
										className: "object-contain w-full h-auto rounded-2xl",
										src: img,
								...
								(0, import_jsx_runtime$24.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$24.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$24.jsx)("span", {
											className: "text-5xl",
											children: props.replyComment.create_time
										}), (0, import_jsx_runtime$24.jsx)("span", {
											className: "text-5xl",
											children: props.replyComment.ip_label
										})]
									}), (0, import_jsx_runtime$24.jsxs)("div", {
										...
										children: [(0, import_jsx_runtime$24.jsx)(Heart, {
											...
											className: "text-5xl",
											children: props.replyComment.digg_count
										})]
									})]
								})
							]
