...
import { $ as Send, A as TbPackageImport, At as Calendar, B as init_lucide_react, C as LuFullscreen, Ct as Clock, D as formatDistanceToNow, Dt as CircleCheckBig, Et as CircleEllipsis, F as button_default, Ft as clsx_default, G as TriangleAlert, H as Users, I as HeroUIProvider, It as init_clsx, J as Star, K as ThumbsUp, L as require_jsx_runtime, Lt as require_server_node, M as init_dist, Mt as Bookmark, N as code_default, Nt as BookOpen, O as format, Ot as CircleAlert, P as chip_default, Pt as Bell, Q as Share2, R as IoSearch, Rt as require_react, S as zhCN, St as Coins, T as init_date_fns, Tt as CircleFadingArrowUp, U as User, V as Zap, W as UserPlus, X as Smartphone, Y as Sparkles, Z as Shield, _ as init_fa6, _t as FileText, at as Play, b as init_ai, bt as Crown, c as rehypeHighlight, ct as MapPin, d as MdAccessTime, dt as Link, et as RefreshCw, f as init_md, ft as Info, g as FaCommentDots, gt as Gamepad2, h as FaCodeBranch, ht as Gift, it as Plug2, j as init_tb, jt as Bot, kt as ChartColumn, l as init_react_markdown, lt as LogIn, m as init_ri, mt as Hash, nt as QrCode, ot as Music, p as RiShareForwardFill, pt as Heart, q as Terminal, rt as Power, s as init_rehype_highlight, st as MessageCircle, tt as Radio, u as Markdown, ut as List, v as AiFillHeart, vt as Eye, w as init_lu, wt as CircleQuestionMark, x as init_locale, xt as CornerDownLeft, y as AiFillStar, yt as ExternalLink, z as init_io5 } from "./vendor-eXnzhLQN.js";
...
var import_react$34, import_jsx_runtime$32, GlowImage, GlowText, GlowIcon, GlowBorderContainer, SmartGlowBorder;
var init_GlowImage = __esmMin(() => {
	...
	GlowImage = ({ src, children, alt, className, imgClassName, mode = "blur-layer", blurRadius = 18, glowStrength = .6, scale = 1.06, shadowRadius = 28, crossOrigin }) => {
		const [shadowColor, setShadowColor] = import_react$34.useState("rgba(255,255,255,0.5)");
		...
		if (children) return (0, import_jsx_runtime$32.jsxs)("div", {
			className,
			style: {
				position: "relative",
		...
		if (mode === "dominant-shadow") return (0, import_jsx_runtime$32.jsx)("img", {
			src,
			alt,
			className: imgClassName,
		...
		return (0, import_jsx_runtime$32.jsxs)("div", {
			...
			}), (0, import_jsx_runtime$32.jsx)("img", {
				src,
				alt,
				className: imgClassName
			})]
	...
	GlowText = ({ children, className, glowClassName, blurRadius = 12, glowStrength = .6, scale = 1.02 }) => (0, import_jsx_runtime$32.jsxs)("span", {
		className,
		style: {
			position: "relative",
			display: "inline-block"
	...
	GlowIcon = ({ Icon, iconProps = {}, className, glowColor, glowStrength = .8, glowRadius = 12, glowLayers = 3, glowSpread = 4 }) => {
		const dropShadow = import_react$34.useMemo(() => Array.from({ length: glowLayers }, (_, i) => {
		...
		return (0, import_jsx_runtime$32.jsx)("div", {
			...
			children: (0, import_jsx_runtime$32.jsx)(Icon, {
				...iconProps,
				style: {
					filter: dropShadow,
					...iconProps.style
	...
	SmartGlowBorder = ({ children, className, glowColor, glowStrength = .5, borderWidth = 1, borderRadius = "1.5rem", glowPosition = "left-top", lightInfluenceRange = .3, enableDynamicGlow = true }) => {
		const containerRef = import_react$34.useRef(null);
		const [detectedGlowColor, setDetectedGlowColor] = import_react$34.useState("rgb(245, 158, 11)");
		import_react$34.useEffect(() => {
		...
		return (0, import_jsx_runtime$32.jsx)("div", {
			ref: containerRef,
			children: (0, import_jsx_runtime$32.jsx)(GlowBorderContainer, {
				className,
...
var init_RolldownLogo = __esmMin(() => {
	...
	RolldownLogo = ({ className = "w-auto h-10" }) => (0, import_jsx_runtime$31.jsxs)("svg", {
		...
		children: [
			...
			(0, import_jsx_runtime$31.jsx)("mask", {
				id: "mask0_rd",
				...
				width: "15",
				height: "15",
				children: (0, import_jsx_runtime$31.jsx)("path", {
					d: "M170.23 0.25C170.54 0.25 170.71 0.61 170.51 0.84L167.16 4.86C166.77 5.33 167.11 6.05 167.72 6.05H170.96C171.27 6.05 171.43 6.41 171.24 6.64L164.76 14.42C164.61 14.59 164.35 14.59 164.2 14.42L157.72 6.64C157.53 6.41 157.69 6.05 158 6.05H161.24C161.85 6.05 162.19 5.33 161.8 4.86L158.45 0.84C158.25 0.61 158.42 0.25 158.73 0.25H170.23Z",
					fill: "black"
				})
			}),
			(0, import_jsx_runtime$31.jsxs)("g", {
				mask: "url(#mask0_rd)",
				children: [
					(0, import_jsx_runtime$31.jsx)("g", {
						filter: "url(#f0_rd)",
						children: (0, import_jsx_runtime$31.jsx)("ellipse", {
							cx: "1.73",
							cy: "7.56",
							rx: "1.73",
							ry: "7.56",
			...
			(0, import_jsx_runtime$31.jsxs)("defs", { children: [
				(0, import_jsx_runtime$31.jsxs)("filter", {
					id: "f0_rd",
					x: "165.15",
					y: "-8.5",
					width: "12.61",
					...
					children: [
						(0, import_jsx_runtime$31.jsx)("feFlood", {
							floodOpacity: "0",
							result: "bg"
						}),
						(0, import_jsx_runtime$31.jsx)("feBlend", {
							in: "SourceGraphic",
							in2: "bg",
							result: "shape"
						}),
						(0, import_jsx_runtime$31.jsx)("feGaussianBlur", {
							stdDeviation: "1.1",
							result: "blur"
						})
					]
...
}), import_jsx_runtime$30, ViteLogo;
var init_ViteLogo = __esmMin(() => {
	__toESM(require_react(), 1);
	import_jsx_runtime$30 = __toESM(require_jsx_runtime(), 1);
	ViteLogo = ({ className = "w-auto h-12" }) => (0, import_jsx_runtime$30.jsxs)("svg", {
		viewBox: "0 0 87 15",
		fill: "none",
		xmlns: "http://www.w3.org/2000/svg",
		className,
		children: [
			(0, import_jsx_runtime$30.jsx)("path", {
			...
			(0, import_jsx_runtime$30.jsx)("mask", {
				id: "mask0_vite",
				style: { maskType: "alpha" },
				maskUnits: "userSpaceOnUse",
				x: "66",
			...
			(0, import_jsx_runtime$30.jsxs)("g", {
				mask: "url(#mask0_vite)",
				children: [
					(0, import_jsx_runtime$30.jsx)("g", {
						filter: "url(#f0_vite)",
						children: (0, import_jsx_runtime$30.jsx)("ellipse", {
							cx: "1.766",
							cy: "4.714",
							rx: "1.766",
							ry: "4.714",
			...
			(0, import_jsx_runtime$30.jsxs)("defs", { children: [
				(0, import_jsx_runtime$30.jsxs)("filter", {
					id: "f0_vite",
					x: "60.29",
					y: "5.42",
					width: "19.25",
					...
					colorInterpolationFilters: "sRGB",
					children: [
						(0, import_jsx_runtime$30.jsx)("feFlood", {
							floodOpacity: "0",
							result: "bg"
						}),
						(0, import_jsx_runtime$30.jsx)("feBlend", {
							in: "SourceGraphic",
							in2: "bg",
							result: "shape"
						}),
						(0, import_jsx_runtime$30.jsx)("feGaussianBlur", {
							stdDeviation: "2.46",
							result: "blur"
						})
					]
				...
				children: (0, import_jsx_runtime$29.jsxs)("div", {
					...
					children: [
						...
						version.releaseType === "Stable" && (0, import_jsx_runtime$29.jsxs)(import_jsx_runtime$29.Fragment, { children: [(0, import_jsx_runtime$29.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }), (0, import_jsx_runtime$29.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$29.jsxs)("div", {
								className: "flex items-end space-x-2",
								children: [(0, import_jsx_runtime$29.jsx)(TbPackageImport, { className: "w-4 h-4 text-warning" }), (0, import_jsx_runtime$29.jsx)(GlowImage, {
									glowStrength: useDarkTheme ? 1 : 0,
									blurRadius: 6,
									children: (0, import_jsx_runtime$29.jsx)(RolldownLogo, { className: "w-auto h-3.5" })
								})]
							}), (0, import_jsx_runtime$29.jsx)(GlowImage, {
								glowStrength: useDarkTheme ? 1 : 0,
								blurRadius: 12,
								children: (0, import_jsx_runtime$29.jsx)(ViteLogo, { className: "w-auto h-8" })
							})]
						})] })
					]
				})
