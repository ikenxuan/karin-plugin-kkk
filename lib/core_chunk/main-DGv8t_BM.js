...
import { n as init_client, r as reactServerRender } from "./template-cT9ZqlRO.js";
					...
					case DynamicType.DRAW:
						...
						img$2 = await Render("bilibili/dynamic/DYNAMIC_TYPE_DRAW", {
							...
							reserve: data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve ? {
								...
								buttonText: data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve.button.uncheck.text
							} : void 0,
							dynamicTYPE: "图文动态推送"
						});
						break;
