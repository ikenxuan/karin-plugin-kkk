...
import { $ as Users, A as init_fa6, At as CircleAlert, B as formatDistanceToNow, C as RiSendPlaneFill, Ct as Crown, D as init_ri, Dt as CircleFadingArrowUp, E as RiUserFollowLine, Et as Clock, F as zhCN, Ft as Bell, G as chip_default, I as LuFullscreen, It as clsx_default, J as require_jsx_runtime, K as button_default, L as init_lu, Lt as init_clsx, M as AiFillStar, Mt as Calendar, N as init_ai, Nt as Bookmark, O as FaCodeBranch, Ot as CircleEllipsis, P as init_locale, Pt as BookOpen, Q as Zap, R as init_date_fns, Rt as require_server_node, S as RiRobot2Fill, St as ExternalLink, T as RiSparkling2Fill, Tt as Coins, U as init_dist, V as format, W as code_default, X as init_io5, Y as IoSearch, Z as init_lucide_react, _ as RiLinkM, _t as Hash, at as Smartphone, b as RiQuestionFill, bt as FileText, c as rehypeHighlight, ct as Radio, d as MdAccessTime, dt as Play, et as UserPlus, f as init_md, ft as Music, g as RiHeart3Line, gt as Heart, h as RiHashtag, ht as Info, it as Star, j as AiFillHeart, jt as ChartColumn, k as FaCommentDots, kt as CircleCheckBig, l as init_react_markdown, lt as QrCode, m as RiGroupLine, mt as MapPin, nt as ThumbsUp, ot as Shield, p as RiBellFill, pt as MessageCircle, q as HeroUIProvider, rt as Terminal, s as init_rehype_highlight, st as Share2, tt as TriangleAlert, u as Markdown, ut as Plug2, v as RiListCheck2, vt as Gift, w as RiShareForwardFill, wt as CornerDownLeft, x as RiRefreshLine, xt as Eye, y as RiLoginCircleFill, yt as Gamepad2, zt as require_react } from "./vendor-BqUbsAth.js";
...
var import_react$34, import_jsx_runtime$32, GlowImage, GlowText;
						...
						version.releaseType === "Stable" && (0, import_jsx_runtime$29.jsxs)(import_jsx_runtime$29.Fragment, { children: [(0, import_jsx_runtime$29.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }), (0, import_jsx_runtime$29.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$29.jsx)("div", {
								...
								children: (0, import_jsx_runtime$29.jsx)(GlowImage, {
									glowStrength: useDarkTheme ? 1 : 0,
									blurRadius: 6,
									children: (0, import_jsx_runtime$29.jsx)(RolldownLogo, { className: "w-auto h-4" })
								})
			...
			(0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$23.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$23.jsx)("div", {
						...
						className: `absolute -bottom-1 -right-1 px-3 py-1 rounded-full border-2 border-background flex items-center gap-1.5 shadow-md ${props.switch ? "bg-danger text-white" : "bg-default-500 text-default-100"}`,
					...
					children: [(0, import_jsx_runtime$23.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$23.jsx)("h3", {
							...
							children: (0, import_jsx_runtime$23.jsxs)("span", {
								...
								children: [(0, import_jsx_runtime$23.jsx)(RiHashtag, { className: "w-3 h-3 opacity-70" }), props.short_id]
							})
						})]
					}), (0, import_jsx_runtime$23.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$23.jsxs)("div", {
								...
								children: [
									(0, import_jsx_runtime$23.jsx)(RiGroupLine, { className: "w-5 h-5 mb-1 text-default-500" }),
...
var init_Comment$2 = __esmMin(() => {
	...
	CommentItemComponent$1 = ({ isLast = false, ...props }) => (0, import_jsx_runtime$20.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$20.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$20.jsxs)("div", {
					className: "flex items-start gap-2.5 mb-[15px] text-[50px] relative",
					children: [
						(0, import_jsx_runtime$20.jsxs)("div", {
				...
				props.replies && props.replies.length > 0 && (0, import_jsx_runtime$20.jsx)("div", {
					...
					children: props.replies.map((subReply, index) => (0, import_jsx_runtime$20.jsx)("div", { children: (0, import_jsx_runtime$20.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$20.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$20.jsxs)("div", {
									className: "flex items-start gap-2.5 mb-[15px] text-[50px] relative overflow-visible",
									children: [(0, import_jsx_runtime$20.jsxs)("div", {
										className: "shrink-0 flex items-center gap-2 leading-[1.2] text-foreground-700 font-bold select-text",
										children: [
											(0, import_jsx_runtime$20.jsx)("div", {
			...
			(0, import_jsx_runtime$18.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$18.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$18.jsx)("div", {
						...
						className: `absolute -bottom-1 -right-1 px-3 py-1 rounded-full border-2 border-background flex items-center gap-1.5 shadow-md ${props.switch ? "bg-success text-white" : "bg-default-500 text-default-100"}`,
	...
	Help = import_react$6.memo((props) => {
		...
		return (0, import_jsx_runtime$4.jsxs)(DefaultLayout, {
			...
			children: [
				...
				(0, import_jsx_runtime$4.jsx)("div", {
					className: "absolute top-[120px] right-[60px] pointer-events-none select-none opacity-[0.03] z-0",
				...
				(0, import_jsx_runtime$4.jsxs)("div", {
					...
					children: [
						...
						(0, import_jsx_runtime$4.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$4.jsx)("div", {
								className: "absolute bottom-0 left-0 w-130 h-[400px] opacity-[0.04]",
				...
				(0, import_jsx_runtime$4.jsxs)("div", {
					className: "relative z-10 p-[72px] flex flex-col min-h-[calc(100vh-200px)]",
	...
	handlerError = (props) => {
		...
		return (0, import_jsx_runtime$3.jsxs)(DefaultLayout, {
			...
			children: [
				...
				(0, import_jsx_runtime$3.jsx)("div", {
					className: "absolute bottom-20 right-[60px] pointer-events-none select-none opacity-[0.03]",
				...
				(0, import_jsx_runtime$3.jsxs)("div", {
					...
					children: [
						...
						(0, import_jsx_runtime$3.jsxs)("div", {
							className: "absolute -bottom-20 -right-20 w-[600px] h-[600px] opacity-10 pointer-events-none",
							children: [
								(0, import_jsx_runtime$3.jsx)("div", {
								...
								(0, import_jsx_runtime$3.jsx)("div", {
									className: "absolute bottom-[140px] right-[140px] w-[calc(100%-280px)] h-[calc(100%-280px)] border-10 rounded-full",
	...
	QrLogin = import_react$2.memo((props) => {
		...
		return (0, import_jsx_runtime.jsxs)(DefaultLayout, {
			...
			children: [
				...
				(0, import_jsx_runtime.jsxs)("div", {
					className: "absolute top-20 right-[70px] pointer-events-none select-none opacity-[0.04]",
					children: [(0, import_jsx_runtime.jsx)("span", {
					...
					children: [
						...
						(0, import_jsx_runtime.jsxs)("div", {
							...
							children: [qrCodeDataUrl ? (0, import_jsx_runtime.jsx)("div", {
								className: "flex justify-center items-center w-[320px] h-80",
								...
								className: "flex flex-col gap-4 justify-center items-center w-[320px] h-80",
