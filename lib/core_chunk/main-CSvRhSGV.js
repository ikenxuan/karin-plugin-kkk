...
import { n as init_client, r as reactServerRender } from "./template-Rqr-ZlK0.js";
...
var init_EmojiReaction = __esmMin(() => {
	...
	EmojiReactionManager = class {
		...
		async replace(oldEmojiId, newEmojiId) {
...
var init_handler = __esmMin(async () => {
	...
	wrapWithErrorHandler = (fn, options) => async (e, next) => {
		...
		if (emojiManager) await emojiManager.add("PROCESSING");
