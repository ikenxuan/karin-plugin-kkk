import { DataSource, In, PrimaryColumn, CreateDateColumn, UpdateDateColumn, OneToMany, Entity, Column, ManyToOne, ManyToMany, JoinTable, JoinColumn, PrimaryGeneratedColumn, LessThan } from "typeorm";
import { D as DynamicType } from "./vendor-BBwKR2ER.js";
import { join } from "node:path";
import { logger } from "node-karin";
import { karinPathBase } from "node-karin/root";
import { Root } from "../root.js";
import "node:fs";
import { C as Config } from "./main-as6c06JP.js";
import "node-karin/axios";
import "stream/promises";
import "./template-EbCy3bSg.js";
...
__decorateClass$1([
  OneToMany(() => GroupUserSubscription$1, (subscription) => subscription.group)
], Group$1.prototype, "subscriptions", 2);
...
__decorateClass$1([
  OneToMany(() => GroupUserSubscription$1, (subscription) => subscription.bilibiliUser)
], BilibiliUser.prototype, "subscriptions", 2);
...
__decorateClass$1([
  ManyToOne(() => Group$1, (group) => group.subscriptions),
  JoinColumn({ name: "groupId", referencedColumnName: "id" })
], GroupUserSubscription$1.prototype, "group", 2);
__decorateClass$1([
  ManyToOne(() => BilibiliUser, (user) => user.subscriptions),
  JoinColumn({ name: "host_mid", referencedColumnName: "host_mid" })
], GroupUserSubscription$1.prototype, "bilibiliUser", 2);
