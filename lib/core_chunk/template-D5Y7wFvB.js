...
import { $ as List, A as Zap, B as Sparkles, C as chip_default, Ct as require_react, D as IoSearch, E as require_jsx_runtime, F as TrendingUp, G as Radio, H as Share2, I as ThumbsUp, J as Play, K as QrCode, L as ThumbsDown, M as User, N as UserPlus, O as init_io5, P as TriangleAlert, Q as LogIn, R as Terminal, S as code_default, St as require_server_node, T as HeroUIProvider, U as Send, Ut as Chalk, V as Shield, W as RefreshCw, X as MessageCircle, Y as Music, Z as MapPin, _ as FaCodeBranch, _t as Bookmark, a as remarkGfm, at as Eye, b as init_fa6, bt as clsx_default, c as init_rehype_raw, ct as CornerDownLeft, d as rehypeHighlight, dt as Clock, et as Link, f as init_react_markdown, ft as CircleQuestionMark, g as FaBug, gt as Bot, h as init_md, ht as Calendar, i as init_remark_gfm, it as FileText, j as Users, k as init_lucide_react, l as rehypeRaw, lt as Coins, m as MdAccessTime, mt as CircleAlert, nt as Heart, o as init_remark_breaks, ot as ExternalLink, p as Markdown, pt as CircleCheckBig, q as Power, r as init_chalk, rt as Hash, s as remarkBreaks, st as Crown, tt as Info, u as init_rehype_highlight, ut as Code, v as FaCube, vt as BookOpen, w as button_default, x as init_dist, xt as init_clsx, y as FaLayerGroup, yt as Bell, z as Star } from "./vendor-jZmDM4xA.js";
				...
				children: [
					...
					(0, import_jsx_runtime$1.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$1.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$1.jsxs)("div", {
									className: "flex items-center gap-8 text-3xl",
									children: [
										(0, import_jsx_runtime$1.jsxs)("div", {
											className: "flex items-center gap-3 text-default-400",
											children: [(0, import_jsx_runtime$1.jsx)(FaLayerGroup, { className: "w-7 h-7 text-primary" }), (0, import_jsx_runtime$1.jsxs)("span", { children: ["框架版本：", (0, import_jsx_runtime$1.jsx)("span", {
												className: "font-bold text-foreground",
										...
										(0, import_jsx_runtime$1.jsxs)("div", {
											className: "flex items-center gap-3 text-default-400",
											children: [(0, import_jsx_runtime$1.jsx)(FaCube, { className: "w-7 h-7 text-success" }), (0, import_jsx_runtime$1.jsxs)("span", { children: ["插件版本：", (0, import_jsx_runtime$1.jsx)("span", {
												className: "font-bold text-foreground",
								...
								data.buildTime && (0, import_jsx_runtime$1.jsxs)("div", {
									className: "flex items-center gap-3 text-3xl text-default-400",
									children: [(0, import_jsx_runtime$1.jsx)(MdAccessTime, { className: "w-7 h-7 text-warning" }), (0, import_jsx_runtime$1.jsxs)("span", { children: ["编译于：", (0, import_jsx_runtime$1.jsx)("span", {
										className: "font-bold text-foreground",
										children: data.buildTime
									})] })]
								}),
								data.commitHash && (0, import_jsx_runtime$1.jsxs)("div", {
									className: "flex items-center gap-3 text-3xl text-default-400",
									children: [(0, import_jsx_runtime$1.jsx)(FaCodeBranch, { className: "w-7 h-7 text-secondary" }), (0, import_jsx_runtime$1.jsxs)("span", { children: ["Commit：", (0, import_jsx_runtime$1.jsx)("span", {
										className: "font-mono font-bold text-foreground",
										children: data.commitHash
									})] })]
								})
							]
						}), (0, import_jsx_runtime$1.jsxs)("div", {
