    ...
    "div",
    {
      ...
      children: [
        ...
        version && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-32 pb-20 text-default-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex relative justify-center items-center space-x-12", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex relative items-center space-x-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: clsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/image/vite.svg", className: "w-auto h-14" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: clsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { strokeWidth: 3, className: "w-4 h-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Powered By" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/image/frame-logo.png", className: "w-auto h-14" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl font-black", children: version.poweredBy })
          ] })
        ] }) })
      ]
    }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col px-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col w-auto h-full", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-auto flex justify-between pt-[60px] items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(QRCodeSection$2, { qrCodeDataUrl, useDarkTheme: props.data.useDarkTheme })
        ] })
      ] })
    ] })
  ] });
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center px-16 py-12 pb-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8 items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-5xl text-foreground-500", children: "抖音创作者" })
          ] })
        ] }),
...
const BilibiliDynamicContent = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    props.image_url && Array.isArray(props.image_url) && props.image_url.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-20", children: [
      props.image_url.length >= 9 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4 w-full", children: props.image_url.slice(0, 9).map((img, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl aspect-square shadow-medium", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        EnhancedImage,
        {
          src: img.image_src,
          alt: `图片${index + 1}`,
      ...
      props.image_url.length === 6 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col flex-1 gap-4", children: [0, 2, 4].map((index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl shadow-medium", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          EnhancedImage,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col flex-1 gap-4", children: [1, 3, 5].map((index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl shadow-medium", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          EnhancedImage,
          {
            src: props.image_url[index].image_src,
            alt: `图片${index + 1}`,
      ...
      props.image_url.length < 6 || props.image_url.length > 6 && props.image_url.length < 9 ? props.image_url.map((img, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
      ...
      (props.image_url.length === 6 || props.image_url.length >= 9) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-18" })
    ] })
  ] });
};
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center px-16 py-12 pb-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8 items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-5xl text-foreground-500", children: "UP主" })
          ] })
        ] }),
...
const handlerError = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DefaultLayout, { ...props, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-[1440px] mx-auto px-20 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-16 rounded-3xl bg-primary-50 flex-1 mr-8", children: [
