...
import { c as Chalk, s as server_nodeExports, d as browserExports, r as reactExports, j as jsxRuntimeExports, H as HeroUIProvider, e as clsx, f as CircleCheckBig, T as TriangleAlert, I as Info, Z as Zap, i as Code, k as MessageCircle, m as Heart, Q as QrCode, B as Bookmark, S as Share2, n as Clock, U as Users, o as Hash, E as Eye, p as Music, q as UserPlus, t as User, u as Star, v as TrendingUp, x as chip_default, y as button_default, z as ExternalLink, A as ThumbsUp, F as ThumbsDown, G as Shield, J as Crown, K as code_default, P as Play, L as Calendar, N as Coins, R as Radio, O as MapPin, V as RefreshCw, W as Bot, X as LogIn, Y as Bell, _ as List, $ as Send, a0 as Sparkles, a1 as Link, a2 as CircleQuestionMark, a3 as CircleAlert, a4 as Terminal, a5 as FileText, a6 as Markdown, a7 as rehypeHighlight, a8 as rehypeRaw, a9 as remarkGfm, aa as remarkBreaks, ab as CornerDownLeft } from "./vendor-DaC7lVo5.js";
    ...
    case PlatformType.OTHER:
      platform.components = basePlatform.components.map((baseComponent) => {
        switch (baseComponent.id) {
          ...
          case "changelog":
            return createComponentConfig(baseComponent, {
              lazyComponent: () => Promise.resolve().then(() => changelog).then((module) => ({
...
class SSRRender {
  ...
  async renderComponent(request) {
    try {
      ...
      const htmlContent = server_nodeExports.renderToString(component);
...
const GlowText = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className, style: { position: "relative", display: "inline-block" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        "aria-hidden": "true",
...
const GlowIcon = ({
  ...
  const dropShadow = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className, style: { display: "inline-block" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Icon,
    {
      ...iconProps,
      style: {
...
const SmartGlowBorder = ({
  ...
  const [detectedGlowColor, setDetectedGlowColor] = reactExports.useState("rgb(245, 158, 11)");
  reactExports.useEffect(() => {
      ...
      comment.replyComment && Object.keys(comment.replyComment).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-6 mt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-2 space-x-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl font-medium text-foreground-600", children: comment.replyComment.nickname }),
...
const DouyinUserItem = ({ user, index }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "li",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-grow items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[52px] mb-[14px] font-medium text-foreground select-text inline-flex items-center gap-[12px]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-[36px] h-[36px] opacity-80", "aria-hidden": "true" }),
              user.username
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-[40px] gap-y-[18px] text-[26px] text-foreground select-text", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-[12px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "w-[26px] h-[26px] opacity-70", "aria-hidden": "true" }),
                "抖音号: ",
                user.short_id
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-[12px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-[26px] h-[26px] opacity-70", "aria-hidden": "true" }),
                "粉丝: ",
                user.fans
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-[12px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-[26px] h-[26px] opacity-70", "aria-hidden": "true" }),
                "获赞: ",
                user.total_favorited
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-[12px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { className: "w-[26px] h-[26px] opacity-70", "aria-hidden": "true" }),
                "关注: ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[36px]" })
  ] });
};
const DouyinUserList = (prop) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DefaultLayout, { ...prop, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col-reverse items-center p-0 list-none", "aria-label": "抖音用户列表", children: prop.data.renderOpt.map((user, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    DouyinUserItem,
    {
      user,
      index
...
const BilibiliUserList = (prop) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DefaultLayout, { ...prop, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col-reverse items-center p-0 list-none", "aria-label": "B站用户列表", children: prop.data.renderOpt.map((user, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    BilibiliUserItem,
    {
      user,
...
const OriginalUserInfo = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-10 items-center pt-5 pb-10 pl-10", children: [
    ...
    props.decoration_card && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-39", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bilifont", dangerouslySetInnerHTML: { __html: props.decoration_card } }) })
  ] });
};
const OriginalAVContent = ({ content }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-12 py-8 mt-4 w-full rounded-3xl bg-default-200/60", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      OriginalUserInfo,
      {
...
const BilibiliForwardContent = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col px-20 w-full leading-relaxed", children: [
      ...
      props.imgList && props.imgList.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-15" })
    ] }),
    props.imgList && props.imgList.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center px-20 w-full", children: props.imgList.map((img, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex overflow-hidden relative flex-col items-center rounded-3xl shadow-large", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        EnhancedImage,
        {
          src: img,
          alt: `图片${idx + 1}`,
...
const MenuItemComponent = ({ item }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    SmartGlowBorder,
    {
      ...
      glowPosition: "left-top",
      lightInfluenceRange: 0.3,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row gap-6 p-8 rounded-3xl backdrop-blur-sm bg-background", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          GlowIcon,
          {
            Icon,
            iconProps: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-4 text-4xl font-bold leading-tight text-foreground", children: item.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl leading-relaxed whitespace-pre-line text-muted-foreground", children: item.description })
        ] })
      ] })
    }
  );
...
const MenuGroupComponent = ({ group, startIndex }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-10 py-10 rounded-2xl bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "m-0 mb-8 text-[3rem] font-bold text-foreground", children: group.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-6", children: group.items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItemComponent, { item, index: itemIndex++ }, idx)) }),
    group.subGroups?.map((sub, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "m-0 mb-6 text-4xl text-foreground/90", children: sub.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-6", children: sub.items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItemComponent, { item, index: itemIndex++ }, idx)) })
    ] }, i))
  ] }) });
};
const Help = reactExports.memo((props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DefaultLayout, { ...props, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-[1440px] mx-auto px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-12 py-10 rounded-2xl backdrop-blur-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mb-2 text-7xl font-bold leading-tight text-foreground", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-medium text-muted-foreground", children: "功能说明与使用指南" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-8 mx-auto space-y-8 w-full", children: menuData.map((group, index) => {
      const startIndex = globalIndex;
      globalIndex += group.items.length + (group.subGroups?.reduce((sum, sub) => sum + sub.items.length, 0) || 0);
      return /* @__PURE__ */ jsxRuntimeExports.jsx(MenuGroupComponent, { group, startIndex }, index);
    }) })
  ] });
});
...
const Changelog = reactExports.memo((props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    DefaultLayout,
    {
      ...props,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative px-20 pt-5 pb-0 w-full max-w-none prose prose-lg prose-invert from-default-50 to-default-100", children: [
        props.data.Tip && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-10 text-5xl leading-relaxed text-center mt-30", children: [
          "引用回复此消息包含",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-7xl", children: "「" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlowText, { className: "text-7xl font-bold text-warning", blurRadius: 20, glowStrength: 2, scale: 1.2, children: "更新" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-7xl", children: "」" }),
          "字眼，即可开始更新"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Markdown,
          {
            ...
            components: {
              h1: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-[5.28em] font-semibold mb-8 pb-2 border-b-2 border-default-400 text-default-900", ...props2, children }),
              h2: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-20 mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "ml-15 relative z-10 text-[3.8em] pb-2  text-default-900 font-medium", ...props2, children }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full border-b border-default-400" })
              ] }),
              h3: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "flex items-baseline gap-3 text-[3.3em] font-semibold mb-6 text-default-900", ...props2, children: [
                children,
                /* @__PURE__ */ jsxRuntimeExports.jsx(CornerDownLeft, { strokeWidth: 2.5, className: "w-[1em] h-[1em] text-default-200" })
              ] }),
              h4: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[2.64em] font-semibold mb-5 text-default-900", ...props2, children }),
              h5: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-[2.38em] font-semibold mb-5 text-default-900", ...props2, children }),
              h6: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: "text-[2.11em] font-semibold mb-4 text-default-600", ...props2, children }),
              p: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[2.64em] leading-[1.75] mb-[2.64em] text-default-900", ...props2, children }),
              ul: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "pl-[5em] mb-[2em] list-disc text-default-900", ...props2, children }),
              ol: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "pl-[3.6em] mb-[1.8em] list-decimal text-default-900", ...props2, children }),
              li: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-[2.6em] leading-[1.6] text-default-900", ...props2, children }),
              blockquote: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "border-l-4 border-default-500 pl-[1.8em] py-[0.9em] mb-[1.8em] text-default-700 bg-default-100", ...props2, children }),
              code: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "px-[0.6em] py-[0.3em] text-[1.65em] bg-default-200 rounded text-default-900 font-mono", ...props2, children }),
              pre: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "p-[1.8em] mb-[1.8em] bg-default-200 rounded overflow-x-auto font-mono", ...props2, children }),
              a: ({ children, href, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  ...props2,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(GlowText, { blurRadius: 10, glowStrength: 3, scale: 1.2, children }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(GlowText, { blurRadius: 10, glowStrength: 3, scale: 1.2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-[1.1em] h-[1.1em] -mb-[0.1em]" }) })
                  ]
                }
              ),
              img: ({ ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "max-w-full h-auto rounded", ...props2 }),
              table: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("table", { className: "w-full border-collapse mb-[1.8em] text-default-900", ...props2, children }),
              th: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3 font-semibold text-left border text-default-900 bg-default-200 border-default-400", ...props2, children }),
              td: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 border text-default-900 border-default-400", ...props2, children })
            },
...
const changelog = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Changelog
}, Symbol.toStringTag, { value: "Module" }));
export {
