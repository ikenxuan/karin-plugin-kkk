  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    DefaultLayout,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: props.data.changeLogImg, alt: "更新日志" }),
        props.data.Tip && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-5xl leading-relaxed text-primary-900", children: [
          "引用回复此消息包含",
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlowText, { className: "text-7xl font-bold text-primary", blurRadius: 20, glowStrength: 2, scale: 1.2, children: "「更新」" }),
          "文本，即可开始更新"
        ] })
      ] })
    }
