          ...
          Markdown,
          {
            ...
            components: {
              ...
              h2: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-20 mb-5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "ml-15 relative z-10 text-[3.4em] pb-2  text-default-900 font-medium", ...props2, children }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full border-b border-default-400" })
              ] }),
              h3: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "flex items-baseline gap-3 text-[3.17em] font-semibold mb-6 text-default-900", ...props2, children: [
                children,
              ...
              li: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-[2.2em] leading-[1.6] text-default-900", ...props2, children }),
              ...
              a: ({ children, ...props2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { className: "inline-flex gap-3 items-baseline text-warning hover:underline", ...props2, children: [
