...
import { C as Client, D as DynamicType, g as getBilibiliData, A as AdditionalType, b as bilibiliApiUrls, w as wbi_sign, a as browserExports, M as MajorType, c as getDouyinData, h as heicConvertExports, l as logger$1 } from "./vendor-rHhqUoOh.js";
import karin, { copyConfigSync, filesByExt, watch, logger, requireFileSync, segment, createNotFoundResponse, ffmpeg, ffprobe, render, common, createBadRequestResponse, createServerErrorResponse, createSuccessResponse, getBot, defineConfig, components, karinPathRoot, mkdirSync, config } from "node-karin";
import axios, { AxiosError } from "node-karin/axios";
import { pipeline } from "stream/promises";
import path, { join } from "node:path";
import { r as reactServerRender } from "./template-8JdpNGkC.js";
import { karinPathBase, karinPathTemp } from "node-karin/root";
import { getDouyinDB, getBilibiliDB, cleanOldDynamicCache, bilibiliDBInstance, douyinDBInstance } from "./db-ZYChPqa4.js";
...
const Render = async (path2, params) => {
  return await SSR(path2, params);
};
const SSR = async (path2, params) => {
...
function wrapWithErrorHandler(fn, options) {
  return (async (...args) => {
...
async function handleBusinessError(error, options, logs, event) {
