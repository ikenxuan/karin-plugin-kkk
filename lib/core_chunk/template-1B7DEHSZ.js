...
import { $ as Coins, A as Star, B as MessageCircle, C as User, D as ThumbsUp, E as TrendingUp, F as RefreshCw, Ft as Chalk, G as Info, H as LogIn, I as Radio, J as FileText, K as Heart, L as QrCode, M as Shield, N as Share2, O as ThumbsDown, P as Send, Q as CornerDownLeft, R as Play, S as Users, T as TriangleAlert, U as List, V as MapPin, W as Link, X as ExternalLink, Y as Eye, Z as Crown, _ as button_default, a as remarkGfm, at as Calendar, b as init_lucide_react, c as init_rehype_raw, ct as Bell, d as rehypeHighlight, dt as require_server_node, et as Code, f as init_react_markdown, ft as require_react, g as chip_default, h as code_default, ht as init_dedent, i as init_remark_gfm, it as CircleAlert, j as Sparkles, k as Terminal, l as rehypeRaw, lt as clsx_default, m as init_dist, mt as dedent_default, nt as CircleQuestionMark, o as init_remark_breaks, ot as Bot, p as Markdown, pt as require_js, q as Hash, r as init_chalk, rt as CircleCheckBig, s as remarkBreaks, st as Bookmark, tt as Clock, u as init_rehype_highlight, ut as init_clsx, v as HeroUIProvider, w as UserPlus, x as Zap, y as require_jsx_runtime, z as Music } from "./vendor-1l39W3vc.js";
...
var init_GlowImage = __esmMin(() => {
	...
	GlowImage = ({ src, alt, className, imgClassName, mode = "blur-layer", blurRadius = 18, glowStrength = .6, scale = 1.06, shadowRadius = 28, crossOrigin }) => {
		...
		if (mode === "dominant-shadow") return (0, import_jsx_runtime$23.jsx)("img", {
			src,
			alt,
...
var init_DefaultLayout = __esmMin(() => {
	...
	DefaultLayout = ({ children, version, data, scale = 3, className = "", style = {} }) => {
		...
		return (0, import_jsx_runtime$22.jsx)(HeroUIProvider, { children: (0, import_jsx_runtime$22.jsxs)("div", {
			...
			children: [children, version ? (0, import_jsx_runtime$22.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$22.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$22.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$22.jsx)(GlowImage, {
							...
							children: [(0, import_jsx_runtime$22.jsx)("div", {
								...
								children: (0, import_jsx_runtime$22.jsx)("span", { children: "karin-plugin" })
						...
						children: [(0, import_jsx_runtime$22.jsxs)("div", {
							...
							children: [version.releaseType === "Stable" ? (0, import_jsx_runtime$22.jsx)(CircleCheckBig, {
								strokeWidth: 3,
								className: "w-4 h-4 text-success/90"
							}) : version.releaseType === "Preview" ? (0, import_jsx_runtime$22.jsx)(TriangleAlert, {
								strokeWidth: 3,
								className: "w-4 h-4 text-warning"
							}) : (0, import_jsx_runtime$22.jsx)(Info, {
								strokeWidth: 3,
								className: "w-4 h-4"
							}), version.releaseType === "Stable" ? (0, import_jsx_runtime$22.jsx)("span", {
							...
							children: version.releaseType === "Stable" ? (0, import_jsx_runtime$22.jsxs)("span", {
								className: "text-success/90",
					...
					children: [
						...
						(0, import_jsx_runtime$22.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }),
						(0, import_jsx_runtime$22.jsxs)("div", {
							className: "flex items-end space-x-8",
							children: [(0, import_jsx_runtime$22.jsx)(GlowImage, {
								src: "/image/vite.svg",
								...
								children: [(0, import_jsx_runtime$22.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [
										(0, import_jsx_runtime$22.jsx)(Code, {
											strokeWidth: 3,
											className: "w-4 h-4"
										}),
										(0, import_jsx_runtime$22.jsx)("span", { children: "Built with" }),
										(0, import_jsx_runtime$22.jsx)(GlowImage, {
...
var init_Comment$3 = __esmMin(() => {
	...
	QRCodeSection$5 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$21.jsx)("div", {
		...
		children: [(0, import_jsx_runtime$21.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$21.jsx)("div", {
				...
				children: [
					...
					type === "视频" && (0, import_jsx_runtime$21.jsxs)(import_jsx_runtime$21.Fragment, { children: [(0, import_jsx_runtime$21.jsxs)("div", {
						className: "flex items-center p-2.5 tracking-[6px] text-[45px] text-left select-text",
						children: [
							"视频大小：",
							videoSize,
					...
					(type === "图集" || type === "合辑") && (0, import_jsx_runtime$21.jsxs)("div", {
						className: "flex items-center p-2.5 tracking-[6px] text-[45px] text-left select-text",
						children: [
							"图片数量：",
							imageLength,
	...
	CommentItemComponent$2 = ({ comment, isLast = false }) => (0, import_jsx_runtime$21.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime$21.jsxs)("div", {
					...
					children: [
						...
						comment.label_type === 1 && (0, import_jsx_runtime$21.jsx)("div", {
...
var init_Dynamic = __esmMin(() => {
	init_lucide_react();
	import_react$21 = __toESM(require_react());
	init_DefaultLayout();
	import_jsx_runtime$20 = __toESM(require_jsx_runtime());
	DouyinHeader$1 = ({ useDarkTheme }) => (0, import_jsx_runtime$20.jsxs)("div", {
	...
	CoCreatorsInfo = ({ info }) => {
		...
		return (0, import_jsx_runtime$20.jsx)("div", {
...
var init_Live = __esmMin(() => {
	...
	CoverSection = ({ imageUrl }) => (0, import_jsx_runtime$19.jsx)("div", {
		className: "py-10",
...
var init_MusicInfo = __esmMin(() => {
	...
	DouyinHeader = ({ useDarkTheme }) => (0, import_jsx_runtime$18.jsxs)("div", {
		className: "flex items-center px-12 py-15",
...
var UserList_exports$1 = __export({ default: () => UserList_default$1 }), import_jsx_runtime$17, DouyinUserItem, DouyinUserList, UserList_default$1;
var init_UserList$1 = __esmMin(() => {
	init_lucide_react();
	__toESM(require_react());
	init_DefaultLayout();
	import_jsx_runtime$17 = __toESM(require_jsx_runtime());
	DouyinUserItem = ({ user, index }) => (0, import_jsx_runtime$17.jsxs)(import_jsx_runtime$17.Fragment, { children: [(0, import_jsx_runtime$17.jsxs)("li", {
	...
	}), (0, import_jsx_runtime$17.jsx)("div", { className: "h-[36px]" })] });
	DouyinUserList = (prop) => (0, import_jsx_runtime$17.jsx)(DefaultLayout, {
		...prop,
...
var init_Comment$2 = __esmMin(() => {
	...
	CommentText$1 = ({ content, className, style }) => (0, import_jsx_runtime$15.jsx)("div", {
		className,
		style,
	...
	ImageWithSkeleton = ({ src, alt, className = "", placeholder }) => {
		...
		if (hasError) return (0, import_jsx_runtime$15.jsx)("div", {
	...
	VideoInfoHeader = ({ type, commentLength, videoSize, clarity }) => (0, import_jsx_runtime$15.jsxs)("div", {
		...
		children: [
			...
			type === "视频" && (0, import_jsx_runtime$15.jsxs)(import_jsx_runtime$15.Fragment, { children: [videoSize && (0, import_jsx_runtime$15.jsx)(InfoItem, {
				label: "视频大小",
				value: videoSize,
				unit: "MB"
	...
	CommentItemComponent$1 = ({ comment, isLast = false }) => (0, import_jsx_runtime$15.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$15.jsxs)("div", {
							...
							children: [
								...
								comment.level !== void 0 && comment.level >= 0 && comment.level <= 7 && (0, import_jsx_runtime$15.jsx)("img", {
						...
						comment.label_type === 1 && (0, import_jsx_runtime$15.jsx)("div", {
...
var init_shared = __esmMin(() => {
	import_react$15 = __toESM(require_react());
	...
	CommentText = ({ content, className, style }) => (0, import_jsx_runtime$14.jsx)("div", {
		className,
		style,
	...
	EnhancedImage = ({ src, alt, className = "", placeholder, isCircular = false }) => {
		...
		if (!src || hasError) return (0, import_jsx_runtime$14.jsx)("div", {
		...
		return (0, import_jsx_runtime$14.jsx)("img", {
			src,
			alt,
			className,
			onError: handleError,
...
var UserList_exports = __export({ default: () => UserList_default }), import_jsx_runtime$13, BilibiliUserItem, BilibiliUserList, UserList_default;
var init_UserList = __esmMin(() => {
	...
	BilibiliUserItem = ({ user }) => (0, import_jsx_runtime$13.jsxs)(import_jsx_runtime$13.Fragment, { children: [(0, import_jsx_runtime$13.jsxs)("li", {
		className: "flex w-[92%] items-center p-[40px] gap-[40px] rounded-[28px] shadow-large bg-content1 select-text",
	...
	}), (0, import_jsx_runtime$13.jsx)("div", { className: "h-[36px]" })] });
	BilibiliUserList = (prop) => (0, import_jsx_runtime$13.jsx)(DefaultLayout, {
		...prop,
								...
								children: [
									(0, import_jsx_runtime$12.jsxs)("div", {
										...
										children: [
											...
											props.upInfo.verify_type > 0 && (0, import_jsx_runtime$12.jsx)("div", {
												className: "flex items-center",
												children: props.upInfo.verify_type === 1 ? (0, import_jsx_runtime$12.jsx)(Shield, {
													size: 20,
													className: "text-warning"
											...
											props.upInfo.vip_status === 1 && props.upInfo.vip_label?.text && (0, import_jsx_runtime$12.jsx)(chip_default, {
												size: "sm",
									...
									(0, import_jsx_runtime$12.jsxs)("div", {
										...
										children: [
											...
											props.upInfo.is_follow === 1 && (0, import_jsx_runtime$12.jsx)(chip_default, {
												size: "sm",
												color: "primary",
												variant: "flat",
...
var init_DYNAMIC_TYPE_DRAW = __esmMin(() => {
	...
	BilibiliDynamicUserInfo = (props) => (0, import_jsx_runtime$11.jsxs)("div", {
	...
	BilibiliDynamicContent = (props) => {
		...
		return (0, import_jsx_runtime$11.jsxs)(import_jsx_runtime$11.Fragment, { children: [(0, import_jsx_runtime$11.jsxs)("div", {
			...
			className: "px-20",
			children: [
				layoutType === "grid" && (0, import_jsx_runtime$11.jsx)("div", {
				...
				layoutType === "waterfall" && (0, import_jsx_runtime$11.jsxs)("div", {
				...
				layoutType === "vertical" && props.image_url.map((img, index) => (0, import_jsx_runtime$11.jsxs)(import_react$12.Fragment, { children: [(0, import_jsx_runtime$11.jsx)("div", {
					className: "flex flex-col items-center",
					children: (0, import_jsx_runtime$11.jsx)("div", {
				...
				(layoutType === "waterfall" || layoutType === "grid") && (0, import_jsx_runtime$11.jsx)("div", { className: "h-18" })
			]
		})] });
	};
...
var init_DYNAMIC_TYPE_AV = __esmMin(() => {
	...
	BilibiliVideoDynamicHeader = () => (0, import_jsx_runtime$10.jsxs)(import_jsx_runtime$10.Fragment, { children: [
...
var init_DYNAMIC_TYPE_FORWARD = __esmMin(() => {
	...
	BilibiliForwardUserInfo = (props) => (0, import_jsx_runtime$9.jsxs)("div", {
		className: "flex gap-10 items-center px-0 pb-0 pl-24",
		children: [
	...
	OriginalDrawContent = ({ content }) => (0, import_jsx_runtime$9.jsxs)("div", {
		...
		children: [
			...
			content.image_url && content.image_url.length === 1 ? (0, import_jsx_runtime$9.jsx)("div", {
	...
	BilibiliForwardContent = (props) => (0, import_jsx_runtime$9.jsxs)(import_jsx_runtime$9.Fragment, { children: [
		(0, import_jsx_runtime$9.jsxs)("div", {
			...
			}), props.imgList && props.imgList.length === 0 && (0, import_jsx_runtime$9.jsx)("div", { className: "h-15" })]
		}),
...
var init_DYNAMIC_TYPE_LIVE_RCMD = __esmMin(() => {
	...
	BilibiliLiveDynamicHeader = () => (0, import_jsx_runtime$8.jsxs)(import_jsx_runtime$8.Fragment, { children: [
