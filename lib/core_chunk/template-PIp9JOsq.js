...
}), import_jsx_runtime$23, CoverSection, UserInfoSection, QRCodeSection$2, DouyinLive, Live_default;
...
}), import_jsx_runtime$22, DouyinHeader, MusicCoverSection, MusicInfoSection, MusicAuthorInfoSection, MusicQRCodeSection, DouyinMusicInfo, MusicInfo_default;
...
var UserVideoList_exports = __export({ DouyinUserVideoList: () => DouyinUserVideoList });
var import_react$23, import_jsx_runtime$21, formatCount, formatDuration, VideoCard, DouyinUserVideoList;
var init_UserVideoList$1 = __esmMin(() => {
	init_date_fns();
	init_locale();
...
var UserList_exports$1 = __export({ default: () => UserList_default$1 }), import_jsx_runtime$20, DouyinUserItem, DouyinUserList, UserList_default$1;
...
var import_react$21, import_jsx_runtime$19, formatNumber$3, formatDate$2, StatItem$2, DouyinVideoInfo, videoInfo_default$1;
var init_videoInfo$1 = __esmMin(() => {
	...
	StatItem$2 = import_react$21.memo(({ icon, value, label, iconColor = "text-foreground-500" }) => (0, import_jsx_runtime$19.jsxs)("div", {
	...
	DouyinVideoInfo = import_react$21.memo((props) => {
		...
		const statsData = (0, import_react$21.useMemo)(() => [
			{
				icon: (0, import_jsx_runtime$19.jsx)(Heart, { size: 48 }),
				value: props.data.statistics.digg_count,
				label: "点赞",
				iconColor: "text-like"
			},
			{
				icon: (0, import_jsx_runtime$19.jsx)(MessageCircle, { size: 48 }),
				value: props.data.statistics.comment_count,
				label: "评论",
				iconColor: "text-comment"
			},
			{
				icon: (0, import_jsx_runtime$19.jsx)(Star, { size: 48 }),
				value: props.data.statistics.collect_count,
				label: "收藏",
				iconColor: "text-yellow-500"
			},
			{
				icon: (0, import_jsx_runtime$19.jsx)(Share2, { size: 48 }),
		...
		return (0, import_jsx_runtime$19.jsx)(DefaultLayout, {
			...props,
			children: (0, import_jsx_runtime$19.jsx)("div", { children: (0, import_jsx_runtime$19.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$19.jsxs)("div", {
						...
						}), (0, import_jsx_runtime$19.jsx)("div", { className: "absolute inset-0 bg-linear-to-t to-transparent from-black/30" })]
					}),
					(0, import_jsx_runtime$19.jsxs)("div", {
						className: "p-20 pb-36",
						children: [(0, import_jsx_runtime$19.jsx)("h1", {
							className: "mb-8 text-7xl font-bold leading-tight text-foreground-900",
							children: props.data.desc
						}), (0, import_jsx_runtime$19.jsx)("p", {
					...
					(0, import_jsx_runtime$19.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$19.jsx)("div", {
								...
								children: statsData.map((stat, index) => (0, import_jsx_runtime$19.jsx)(StatItem$2, {
									icon: stat.icon,
									value: stat.value,
									label: stat.label,
							...
							(0, import_jsx_runtime$19.jsx)("div", { className: "h-18" }),
							(0, import_jsx_runtime$19.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$19.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$19.jsxs)("div", {
										className: "flex gap-2 items-center",
										children: [
											(0, import_jsx_runtime$19.jsx)(TrendingUp, { size: 48 }),
											(0, import_jsx_runtime$19.jsx)("span", {
												className: "font-medium",
									...
									}), props.data.statistics.play_count > 0 && (0, import_jsx_runtime$19.jsxs)("div", {
										className: "flex gap-2 items-center",
										children: [
											(0, import_jsx_runtime$19.jsx)(Eye, { size: 48 }),
											(0, import_jsx_runtime$19.jsx)("span", {
												className: "font-medium",
									...
									children: (0, import_jsx_runtime$19.jsxs)(chip_default, {
										color: "primary",
										variant: "flat",
										size: "lg",
										radius: "sm",
					...
					(0, import_jsx_runtime$19.jsx)("div", { className: "h-18" }),
					(0, import_jsx_runtime$19.jsx)("div", { className: "h-0.5 bg-default-300" }),
					(0, import_jsx_runtime$19.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$19.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$19.jsx)("img", {
								...
								children: [(0, import_jsx_runtime$19.jsx)("p", {
							...
							children: (0, import_jsx_runtime$19.jsx)(button_default, {
								size: "sm",
								...
								children: (0, import_jsx_runtime$19.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$19.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$19.jsx)(ExternalLink, {
...
var UserList_exports = __export({ default: () => UserList_default }), import_jsx_runtime$15, BilibiliUserItem, BilibiliUserList, UserList_default;
...
var VersionWarning_exports = __export({ VersionWarning: () => VersionWarning }), import_jsx_runtime, VersionWarning;
		...
		return (0, import_jsx_runtime.jsxs)(DefaultLayout, {
			...
			children: [
					...
					children: [
						(0, import_jsx_runtime.jsx)("div", {
							...
							style: {
								...
								top: "-150px",
								left: "-100px",
								background: isDark ? "radial-gradient(ellipse at 40% 40%, rgba(194,65,12,0.4) 0%, rgba(154,52,18,0.2) 50%, transparent 100%)" : "radial-gradient(ellipse at 40% 40%, rgba(234,88,12,0.35) 0%, rgba(251,146,60,0.18) 50%, transparent 100%)",
								filter: "blur(60px)",
						...
						(0, import_jsx_runtime.jsx)("div", {
							...
							style: {
								...
								top: "250px",
								right: "-50px",
								background: isDark ? "radial-gradient(ellipse at 50% 50%, rgba(68,44,21,0.35) 0%, rgba(41,26,13,0.18) 50%, transparent 100%)" : "radial-gradient(ellipse at 50% 50%, rgba(255,251,240,0.9) 0%, rgba(254,243,199,0.5) 50%, transparent 100%)",
								filter: "blur(50px)",
						...
						(0, import_jsx_runtime.jsx)("div", {
							...
							style: {
								...
								bottom: "-100px",
								left: "100px",
								background: isDark ? "radial-gradient(ellipse at 50% 60%, rgba(180,83,9,0.35) 0%, rgba(146,64,14,0.18) 50%, transparent 100%)" : "radial-gradient(ellipse at 50% 60%, rgba(194,65,12,0.3) 0%, rgba(180,83,9,0.15) 50%, transparent 100%)",
								filter: "blur(70px)",
				...
				(0, import_jsx_runtime.jsx)("div", {
					className: "absolute inset-0 pointer-events-none",
					style: {
						filter: "contrast(800%) brightness(500%)",
					...
					children: (0, import_jsx_runtime.jsxs)("svg", {
						...
						children: [(0, import_jsx_runtime.jsxs)("filter", {
							id: "monoNoise",
							children: [(0, import_jsx_runtime.jsx)("feTurbulence", {
								type: "fractalNoise",
								baseFrequency: "0.8",
								numOctaves: "4",
								stitchTiles: "stitch"
						...
						(0, import_jsx_runtime.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime.jsxs)("div", { children: [
								...
								(0, import_jsx_runtime.jsx)("h1", {
									className: "text-8xl font-black leading-none mt-4",
								...
								children: [
									(0, import_jsx_runtime.jsxs)("div", { children: [(0, import_jsx_runtime.jsx)("p", {
										...
										children: [
											...
											(0, import_jsx_runtime.jsx)("span", {
												className: "font-mono font-bold",
												children: props.data.requireVersion
											}),
											"，高于当前运行版本，可能导致部分功能异常"
										]
									})] }),
									...
									(0, import_jsx_runtime.jsxs)("div", { children: [
										...
										(0, import_jsx_runtime.jsx)("p", {
											className: "text-xl leading-relaxed",
											style: { color: secondaryColor },
											children: "建议升级框架以获得最佳体验"
										}),
										(0, import_jsx_runtime.jsx)("div", {
											className: "mt-3 px-5 py-3 rounded-lg inline-block",
											style: { backgroundColor: accentColor },
											children: (0, import_jsx_runtime.jsx)("code", {
												className: "text-lg font-mono font-bold",
												style: { color: bgColor },
												children: "pnpm up node-karin"
											})
										})
									] })
								]
			...
			case PlatformType.DOUYIN:
				platform.components = basePlatform.components.map((baseComponent) => {
					switch (baseComponent.id) {
						...
						case "user_profile": return createComponentConfig(baseComponent, { lazyComponent: () => Promise.resolve().then(() => (init_UserVideoList$1(), UserVideoList_exports)).then((module) => ({ default: module.DouyinUserVideoList })) });
