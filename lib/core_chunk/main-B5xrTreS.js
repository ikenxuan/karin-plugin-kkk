...
import { C as Client, D as DynamicType, g as getBilibiliData, b as bilibiliApiUrls, w as wbi_sign, M as MajorType, a as getDouyinData, h as heicConvertExports, l as logger$1 } from "./vendor-ClxefV4m.js";
...
import { getDouyinDB, getBilibiliDB, cleanOldDynamicCache, bilibiliDBInstance, douyinDBInstance } from "./db-BmR8SVQE.js";
...
async function douyinComments(data, emojidata) {
  ...
  for (const item of CommentData.jsonArray) {
    item.text = processCommentEmojis$1(item.text, emojidata);
  }
  return CommentData;
}
