...
import { A as format, Bt as Chalk, C as init_locale, D as init_date_fns, Gt as Xhshow, Ht as AxiosError$1, Jt as zod_default, Kt as init_esm, O as fromUnixTime, Rt as require_express, Ut as init_axios, Vt as init_source, Wt as axios_default, a as require_qr_code_styling, i as require_lib, j as differenceInSeconds, k as formatDistanceToNow, n as require_dist, o as init_lib, qt as init_zod, r as require_lib$1, s as Window, t as require_heic_convert, w as zhCN, zt as require_protobufjs } from "./vendor-kni-ecY8.js";
import { n as init_client, r as reactServerRender } from "./template-BUkWS7cy.js";
					...
					case DynamicType.DRAW: {
						...
						this.e.reply(await Render("bilibili/dynamic/DYNAMIC_TYPE_DRAW", {
							...
							reserve: dynamicInfo.data.data.item.modules.module_dynamic.additional?.reserve ? {
								...
								buttonText: dynamicInfo.data.data.item.modules.module_dynamic.additional.reserve.button.type === 1 ? dynamicInfo.data.data.item.modules.module_dynamic.additional.reserve.button.jump_style.text : dynamicInfo.data.data.item.modules.module_dynamic.additional.reserve.button.uncheck.text
							} : void 0
						}));
						break;
					}
				...
				switch (data$1[dynamicId].dynamic_type) {
					case DynamicType.DRAW:
						...
						img$2 = await Render("bilibili/dynamic/DYNAMIC_TYPE_DRAW", {
							...
							render_time: format(/* @__PURE__ */ new Date(), "yyyy-MM-dd HH:mm:ss"),
							imageLayout: Config.bilibili.imageLayout,
							reserve: data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve ? {
								title: data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve.title,
								desc1: data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve.desc1.text,
								desc2: data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve.desc2.text,
								desc3: data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve.desc3?.text,
								buttonText: data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve.button.type === 1 ? data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve.button.jump_style.text : data$1[dynamicId].Dynamic_Data.modules.module_dynamic.additional?.reserve.button.uncheck.text
							} : void 0,
							dynamicTYPE: "图文动态推送"
						});
						break;
