...
import { $ as Send, A as format, At as ChartColumn, B as init_lucide_react, C as init_locale, Ct as Code, D as init_date_fns, Dt as CircleEllipsis, E as init_lu, Et as CircleFadingArrowUp, F as button_default, Ft as Bell, G as TriangleAlert, H as Users, I as HeroUIProvider, It as clsx_default, J as Star, K as ThumbsUp, L as require_jsx_runtime, Lt as init_clsx, M as init_dist, Mt as Bot, N as code_default, Nt as Bookmark, Ot as CircleCheckBig, P as chip_default, Pt as BookOpen, Q as Share2, R as IoSearch, Rt as require_server_node, S as init_ai, St as Coins, T as LuFullscreen, Tt as CircleQuestionMark, U as User, V as Zap, W as UserPlus, X as Smartphone, Y as Sparkles, Z as Shield, _ as FaCodeBranch, _t as FileText, at as Play, b as AiFillHeart, bt as Crown, c as init_rehype_highlight, ct as MapPin, d as Markdown, dt as Link, et as RefreshCw, f as MdAccessTime, ft as Info, g as FaBug, gt as Gamepad2, h as init_ri, ht as Gift, it as Plug2, jt as Calendar, k as formatDistanceToNow, kt as CircleAlert, l as rehypeHighlight, lt as LogIn, m as RiShareForwardFill, mt as Hash, nt as QrCode, ot as Music, p as init_md, pt as Heart, q as Terminal, rt as Power, st as MessageCircle, tt as Radio, u as init_react_markdown, ut as List, v as FaCommentDots, vt as Eye, w as zhCN, wt as Clock, x as AiFillStar, xt as CornerDownLeft, y as init_fa6, yt as ExternalLink, z as init_io5, zt as require_react } from "./vendor-Dj-6KtKb.js";
...
var import_react$32, import_jsx_runtime$30, GlowImage, GlowText, GlowIcon, GlowBorderContainer, SmartGlowBorder;
var init_GlowImage = __esmMin(() => {
	...
	GlowImage = ({ src, children, alt, className, imgClassName, mode = "blur-layer", blurRadius = 18, glowStrength = .6, scale = 1.06, shadowRadius = 28, crossOrigin }) => {
		const [shadowColor, setShadowColor] = import_react$32.useState("rgba(255,255,255,0.5)");
		...
		if (children) return (0, import_jsx_runtime$30.jsxs)("div", {
			className,
			style: {
				position: "relative",
		...
		if (mode === "dominant-shadow") return (0, import_jsx_runtime$30.jsx)("img", {
			src,
			alt,
			className: imgClassName,
	...
	GlowText = ({ children, className, glowClassName, blurRadius = 12, glowStrength = .6, scale = 1.02 }) => (0, import_jsx_runtime$30.jsxs)("span", {
		className,
		style: {
			position: "relative",
			display: "inline-block"
	...
	GlowIcon = ({ Icon, iconProps = {}, className, glowColor, glowStrength = .8, glowRadius = 12, glowLayers = 3, glowSpread = 4 }) => {
		const dropShadow = import_react$32.useMemo(() => Array.from({ length: glowLayers }, (_, i) => {
		...
		return (0, import_jsx_runtime$30.jsx)("div", {
			...
			children: (0, import_jsx_runtime$30.jsx)(Icon, {
				...iconProps,
				style: {
					filter: dropShadow,
					...iconProps.style
	...
	SmartGlowBorder = ({ children, className, glowColor, glowStrength = .5, borderWidth = 1, borderRadius = "1.5rem", glowPosition = "left-top", lightInfluenceRange = .3, enableDynamicGlow = true }) => {
		const containerRef = import_react$32.useRef(null);
		const [detectedGlowColor, setDetectedGlowColor] = import_react$32.useState("rgb(245, 158, 11)");
		import_react$32.useEffect(() => {
		...
		return (0, import_jsx_runtime$30.jsx)("div", {
			ref: containerRef,
			children: (0, import_jsx_runtime$30.jsx)(GlowBorderContainer, {
				className,
...
}), import_jsx_runtime$29, DefaultLayout;
var init_DefaultLayout = __esmMin(() => {
	...
	DefaultLayout = ({ children, version, data, scale = 3, className = "", style = {} }) => {
		...
		return (0, import_jsx_runtime$29.jsx)(HeroUIProvider, { children: (0, import_jsx_runtime$29.jsxs)("div", {
			...
			children: [children, version ? (0, import_jsx_runtime$29.jsx)("div", {
				...
				children: (0, import_jsx_runtime$29.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$29.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$29.jsx)(GlowImage, {
								...
								children: (0, import_jsx_runtime$29.jsxs)("svg", {
									...
									children: [
										(0, import_jsx_runtime$29.jsx)("path", {
											id: "_1",
								...
								children: [(0, import_jsx_runtime$29.jsx)("div", {
									...
									children: (0, import_jsx_runtime$29.jsx)("span", { children: version.plugin })
						...
						(0, import_jsx_runtime$29.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$29.jsxs)("div", {
								...
								children: [
									version.hasUpdate && (0, import_jsx_runtime$29.jsx)(CircleFadingArrowUp, {
										strokeWidth: 3,
										className: "w-4 h-4 text-success"
									}),
									!version.hasUpdate && version.releaseType === "Stable" && (0, import_jsx_runtime$29.jsx)(CircleCheckBig, {
										strokeWidth: 3,
										className: "w-4 h-4"
									}),
									!version.hasUpdate && version.releaseType === "Preview" && (0, import_jsx_runtime$29.jsx)(TriangleAlert, {
										strokeWidth: 3,
										className: "w-4 h-4 text-warning"
									}),
									!version.hasUpdate && version.releaseType !== "Stable" && version.releaseType !== "Preview" && (0, import_jsx_runtime$29.jsx)(Info, {
										strokeWidth: 3,
										className: "w-4 h-4"
									}),
									(0, import_jsx_runtime$29.jsx)("span", {
						...
						(0, import_jsx_runtime$29.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }),
						(0, import_jsx_runtime$29.jsxs)("div", {
							className: "flex items-end space-x-8",
							children: [(0, import_jsx_runtime$29.jsx)(GlowImage, {
								...
								children: [(0, import_jsx_runtime$29.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [(0, import_jsx_runtime$29.jsx)(Zap, {
										strokeWidth: 3,
						...
						version.releaseType === "Stable" && (0, import_jsx_runtime$29.jsxs)(import_jsx_runtime$29.Fragment, { children: [(0, import_jsx_runtime$29.jsx)("div", { className: "w-1 h-14 opacity-90 bg-default-900" }), (0, import_jsx_runtime$29.jsxs)("div", {
							className: "flex items-end space-x-8",
							children: [(0, import_jsx_runtime$29.jsx)(GlowImage, {
								src: "/image/vite.svg",
								alt: "logo",
								...
								children: [(0, import_jsx_runtime$29.jsxs)("div", {
									className: "flex items-center mb-1 space-x-2 text-sm font-bold tracking-widest uppercase text-default-900",
									children: [
										(0, import_jsx_runtime$29.jsx)(Code, {
											strokeWidth: 3,
											className: "w-4 h-4"
										}),
										(0, import_jsx_runtime$29.jsx)("span", { children: "Built with" }),
										(0, import_jsx_runtime$29.jsx)(GlowImage, {
			...
			}) : (0, import_jsx_runtime$29.jsx)("div", { className: "h-24" })]
		}) });
	};
});
...
var import_react$30, import_jsx_runtime$28, QRCodeSection$3, VideoInfoHeader$1, organizeReplies, ReplyItemComponent, CommentItemComponent$2, DouyinComment, Comment_default$3;
var init_Comment$3 = __esmMin(() => {
	...
	VideoInfoHeader$1 = (props) => (0, import_jsx_runtime$28.jsx)("div", {
			...
			children: [(0, import_jsx_runtime$28.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$28.jsx)("div", {
					...
					children: (0, import_jsx_runtime$28.jsxs)("div", {
						...
						}), props.Type === "视频" && props.Resolution && (0, import_jsx_runtime$28.jsxs)("div", {
					...
					children: [
						...
						props.Type === "视频" ? (0, import_jsx_runtime$28.jsxs)(import_jsx_runtime$28.Fragment, { children: [(0, import_jsx_runtime$28.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text",
							children: [(0, import_jsx_runtime$28.jsx)("span", {
								className: "mr-4 text-foreground-400",
								children: "大小"
						...
						})] }) : (0, import_jsx_runtime$28.jsxs)(import_jsx_runtime$28.Fragment, { children: [(0, import_jsx_runtime$28.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text",
							children: [(0, import_jsx_runtime$28.jsx)("span", {
								className: "mr-4 text-foreground-400",
								children: "区域"
				...
				className: "shrink-0",
				children: (0, import_jsx_runtime$28.jsx)(QRCodeSection$3, { qrCodeDataUrl: props.qrCodeDataUrl })
			})]
		})
	});
	...
	ReplyItemComponent = ({ reply, depth = 0, isLast, maxDepth = 6 }) => {
		...
		if (reply.hiddenCount) return (0, import_jsx_runtime$28.jsx)("div", {
			...
			children: (0, import_jsx_runtime$28.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$28.jsxs)("div", {
					...
					children: [
						!isLast && (0, import_jsx_runtime$28.jsx)("div", { className: "absolute top-0 bottom-0 left-1/2 w-0.5 bg-default-300 -ml-px" }),
						!isLast && (0, import_jsx_runtime$28.jsx)("div", { className: "absolute -bottom-6 left-1/2 w-0.5 h-6 bg-default-300 -ml-px" }),
					...
					children: (0, import_jsx_runtime$28.jsx)("div", {
						...
						children: (0, import_jsx_runtime$28.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$28.jsx)(CircleEllipsis, {
								size: 45,
								className: "mr-5"
							}), (0, import_jsx_runtime$28.jsxs)("span", {
				...
				children: [(0, import_jsx_runtime$28.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$28.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$28.jsxs)("div", {
							...
							}), reply.children.length > 0 && (0, import_jsx_runtime$28.jsx)("div", { className: "w-0.5 bg-default-300 h-full grow mt-3 rounded-t-full" })]
						}), (0, import_jsx_runtime$28.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$28.jsxs)("div", {
									...
									children: [
										...
										reply.label_text !== "" && (0, import_jsx_runtime$28.jsx)("div", {
										...
										reply.reply_to_username && (0, import_jsx_runtime$28.jsxs)("div", {
											className: clsx_default("flex items-center", !isNicknameLonger ? "overflow-hidden min-w-0 shrink" : "shrink-0"),
											children: [(0, import_jsx_runtime$28.jsx)(Play, {
												size: 35,
								...
								(0, import_jsx_runtime$28.jsxs)("div", {
									...
									}), reply.image_list && reply.image_list.length > 0 && reply.image_list.filter(Boolean).map((img, idx) => (0, import_jsx_runtime$28.jsx)("div", {
									...
									children: (0, import_jsx_runtime$28.jsxs)("div", {
										...
										children: [
											(0, import_jsx_runtime$28.jsxs)("div", {
												...
												children: [(0, import_jsx_runtime$28.jsx)(Heart, {
													size: 40,
					...
					}), reply.children.length > 0 && (0, import_jsx_runtime$28.jsx)("div", {
						className: "flex relative flex-col",
						children: (0, import_jsx_runtime$28.jsx)("div", { children: reply.children.map((child, index) => (0, import_jsx_runtime$28.jsx)(ReplyItemComponent, {
							reply: child,
							depth: depth + 1,
	...
	CommentItemComponent$2 = (props) => (0, import_jsx_runtime$28.jsx)("div", {
		...
		children: (0, import_jsx_runtime$28.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$28.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$28.jsxs)("div", {
					...
					}), props.replyComment && props.replyComment.length > 0 && (0, import_jsx_runtime$28.jsx)("div", { className: "w-0.5 bg-default-300 h-full grow mt-4 rounded-t-full" })]
				}), (0, import_jsx_runtime$28.jsxs)("div", {
					...
					children: [
						...
						(props.commentimage || props.sticker) && (0, import_jsx_runtime$28.jsx)("div", {
			...
			}), props.replyComment && props.replyComment.length > 0 && (0, import_jsx_runtime$28.jsxs)("div", {
				className: "flex relative flex-col mt-8 ml-5",
				children: [(0, import_jsx_runtime$28.jsx)("div", { className: "absolute -top-8 left-[50px] w-0.5 h-8 bg-default-300 -ml-px" }), organizeReplies(props.replyComment, props.cid || "", props.maxDepth).map((reply, index, arr) => (0, import_jsx_runtime$28.jsx)(ReplyItemComponent, {
					reply,
					depth: 1,
	...
	DouyinComment = import_react$30.memo((props) => {
		const randomSuggestWord = import_react$30.useMemo(() => {
		...
		return (0, import_jsx_runtime$28.jsx)(DefaultLayout, {
			...props,
			children: (0, import_jsx_runtime$28.jsxs)("div", {
				className: "p-5",
				children: [
					(0, import_jsx_runtime$28.jsx)("div", { className: "h-20" }),
					(0, import_jsx_runtime$28.jsx)(VideoInfoHeader$1, {
						...props.data,
						qrCodeDataUrl: props.qrCodeDataUrl
					}),
					randomSuggestWord && (0, import_jsx_runtime$28.jsx)("div", {
						...
						children: (0, import_jsx_runtime$28.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$28.jsx)("span", {
								...
								children: [randomSuggestWord, (0, import_jsx_runtime$28.jsx)(IoSearch, {
									size: 32,
					...
					(0, import_jsx_runtime$28.jsx)("div", {
						...
						children: props.data.CommentsData.length > 0 ? (0, import_jsx_runtime$28.jsx)(import_jsx_runtime$28.Fragment, { children: props.data.CommentsData.map((comment, index) => (0, import_jsx_runtime$28.jsx)(CommentItemComponent$2, {
							...comment,
							isLast: index === props.data.CommentsData.length - 1,
							maxDepth: props.data.maxDepth
						}, comment.cid || index)) }) : (0, import_jsx_runtime$28.jsx)("div", {
							className: "flex justify-center items-center py-20 text-foreground-400",
							children: (0, import_jsx_runtime$28.jsx)("div", {
								className: "text-center",
								children: (0, import_jsx_runtime$28.jsx)("p", {
									className: "text-xl",
									children: "暂无评论数据"
								})
							})
...
var import_react$29, import_jsx_runtime$27, DouyinHeader$1, CoverSection$1, InfoSection, UserInfoSection$1, CoCreatorsInfo, DouyinDynamic, Dynamic_default;
var init_Dynamic = __esmMin(() => {
	...
	DouyinHeader$1 = ({ useDarkTheme }) => (0, import_jsx_runtime$27.jsxs)("div", {
	...
	CoverSection$1 = ({ imageUrl }) => (0, import_jsx_runtime$27.jsx)("div", {
	...
	InfoSection = (props) => (0, import_jsx_runtime$27.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime$27.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$27.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$27.jsx)(Heart, { className: "w-11 h-11 text-like" }), (0, import_jsx_runtime$27.jsxs)("span", { children: [props.data.dianzan, "点赞"] })]
					}),
					(0, import_jsx_runtime$27.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$27.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$27.jsx)(MessageCircle, { className: "w-11 h-11 text-comment" }), (0, import_jsx_runtime$27.jsxs)("span", { children: [props.data.pinglun, "评论"] })]
					}),
					(0, import_jsx_runtime$27.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$27.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$27.jsx)(Bookmark, { className: "w-11 h-11" }), (0, import_jsx_runtime$27.jsxs)("span", { children: [props.data.shouchang, "收藏"] })]
					}),
					(0, import_jsx_runtime$27.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$27.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [(0, import_jsx_runtime$27.jsx)(Share2, { className: "w-11 h-11 text-success" }), (0, import_jsx_runtime$27.jsxs)("span", { children: [props.data.share, "分享"] })]
					})
				]
			}),
			(0, import_jsx_runtime$27.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$27.jsx)(Clock, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$27.jsxs)("span", { children: ["发布于: ", props.data.create_time] })]
			}),
			(0, import_jsx_runtime$27.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-foreground-500 font-light select-text",
				children: [(0, import_jsx_runtime$27.jsx)(LuFullscreen, { className: "w-11 h-11 text-time text-time" }), (0, import_jsx_runtime$27.jsxs)("span", { children: ["图片生成于: ", format(/* @__PURE__ */ new Date(), "yyyy-MM-dd HH:mm:ss")] })]
			})
		]
	});
	UserInfoSection$1 = (props) => (0, import_jsx_runtime$27.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$27.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$27.jsx)("div", {
				...
				children: [(0, import_jsx_runtime$27.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$27.jsx)(Hash, {
						size: 32,
			...
			children: [
				(0, import_jsx_runtime$27.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$27.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$27.jsx)(Heart, {
								size: 28,
								className: "text-like"
							}), (0, import_jsx_runtime$27.jsx)("span", {
								className: "text-default-400",
						...
						(0, import_jsx_runtime$27.jsx)("div", { className: "w-full h-px bg-default-300" }),
						(0, import_jsx_runtime$27.jsx)("span", {
				...
				(0, import_jsx_runtime$27.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$27.jsxs)("div", {
							className: "flex gap-1 items-center",
							children: [(0, import_jsx_runtime$27.jsx)(Eye, {
								size: 28,
								className: "text-view"
							}), (0, import_jsx_runtime$27.jsx)("span", {
								className: "text-default-400",
				...
				(0, import_jsx_runtime$27.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime$27.jsxs)("div", {
							className: "flex gap-1 items-center",
							children: [(0, import_jsx_runtime$27.jsx)(Users, {
								size: 28,
	...
	CoCreatorsInfo = ({ info }) => {
		...
		const listRef = import_react$29.useRef(null);
		const [visibleCount, setVisibleCount] = import_react$29.useState(items.length);
		...
		return (0, import_jsx_runtime$27.jsx)("div", {
			...
			children: (0, import_jsx_runtime$27.jsxs)("div", {
				...
				}), items.length > visibleCount && (0, import_jsx_runtime$27.jsxs)("div", {
					className: "flex flex-col items-center min-w-[152px] w-[152px] shrink-0",
					children: [
						(0, import_jsx_runtime$27.jsx)("div", {
	...
	DouyinDynamic = (props) => {
		...
		return (0, import_jsx_runtime$27.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$27.jsxs)("div", { children: [
				(0, import_jsx_runtime$27.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$27.jsx)(DouyinHeader$1, { useDarkTheme: props.data.useDarkTheme }),
				(0, import_jsx_runtime$27.jsx)("div", { className: "h-[60px]" }),
				(0, import_jsx_runtime$27.jsx)(CoverSection$1, { imageUrl: props.data.image_url }),
				(0, import_jsx_runtime$27.jsx)("div", { className: "h-[20px]" }),
				(0, import_jsx_runtime$27.jsx)(InfoSection, { ...props }),
				(0, import_jsx_runtime$27.jsx)("div", { className: "h-[100px]" }),
				(0, import_jsx_runtime$27.jsxs)("div", {
					className: "flex flex-col gap-10 px-0 pt-25",
					children: [(0, import_jsx_runtime$27.jsxs)("div", {
						className: "w-full",
						children: [coCreatorCount && coCreatorCount > 0 && (0, import_jsx_runtime$27.jsx)("div", {
							className: "px-16 pb-8",
							children: (0, import_jsx_runtime$27.jsxs)("div", {
								className: "gap-2 inline-flex items-center rounded-2xl bg-default-100 text-foreground-700 px-6 py-3",
								children: [(0, import_jsx_runtime$27.jsx)(Users, { className: "w-7 h-7" }), (0, import_jsx_runtime$27.jsxs)("span", {
									className: "text-3xl font-medium leading-none select-text text-foreground-700",
									children: [coCreatorCount, "人共创"]
								})]
							})
						}), (0, import_jsx_runtime$27.jsx)(CoCreatorsInfo, { info: props.data.cooperation_info })]
					}), (0, import_jsx_runtime$27.jsxs)("div", {
						className: "flex justify-between items-start px-20 pb-20",
						children: [(0, import_jsx_runtime$27.jsx)(UserInfoSection$1, { ...props }), (0, import_jsx_runtime$27.jsx)("div", {
...
var init_Live = __esmMin(() => {
	...
	QRCodeSection$2 = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$26.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$26.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$26.jsx)(QrCode, { className: "w-12 h-12" }), (0, import_jsx_runtime$26.jsx)("span", { children: "直播分享链接" })]
		}), (0, import_jsx_runtime$26.jsx)("div", {
				...
				children: [
					...
					(0, import_jsx_runtime$26.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime$26.jsxs)("div", {
								className: "flex gap-2 items-center",
								children: [(0, import_jsx_runtime$26.jsx)(Eye, { className: "w-11 h-11 text-view" }), (0, import_jsx_runtime$26.jsxs)("span", { children: ["观看总人数", props.data.总观看次数] })]
							}),
							(0, import_jsx_runtime$26.jsx)("span", { children: "|" }),
							(0, import_jsx_runtime$26.jsxs)("div", {
								className: "flex gap-2 items-center",
								children: [(0, import_jsx_runtime$26.jsx)(Users, { className: "w-11 h-11 text-follow" }), (0, import_jsx_runtime$26.jsxs)("span", { children: ["在线观众", props.data.在线观众] })]
							})
						]
					}),
					...
					(0, import_jsx_runtime$26.jsx)("div", { className: "h-[120px]" }),
					(0, import_jsx_runtime$26.jsxs)("div", {
...
var init_MusicInfo = __esmMin(() => {
		...
		children: [
			...
			(0, import_jsx_runtime$25.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$25.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$25.jsx)(Music, { className: "w-11 h-11" }), (0, import_jsx_runtime$25.jsxs)("span", { children: ["音乐ID: ", musicId] })]
				}), (0, import_jsx_runtime$25.jsxs)("div", {
					className: "flex gap-2 items-center select-text",
					children: [(0, import_jsx_runtime$25.jsx)(Users, { className: "w-11 h-11 text-follow" }), (0, import_jsx_runtime$25.jsxs)("span", { children: [userCount, " 人使用过"] })]
				})]
			}),
			(0, import_jsx_runtime$25.jsxs)("div", {
				className: "flex items-center gap-2 text-[45px] text-default-500 font-light select-text",
				children: [(0, import_jsx_runtime$25.jsx)(LuFullscreen, { className: "w-11 h-11 text-time" }), (0, import_jsx_runtime$25.jsxs)("span", { children: ["图片生成于: ", createTime] })]
			})
		]
	});
	MusicAuthorInfoSection = ({ avatarUrl, username, userShortId, totalFavorited, followingCount, fans }) => (0, import_jsx_runtime$25.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$25.jsxs)("div", {
			...
			children: [
				...
				(0, import_jsx_runtime$25.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$25.jsx)(Heart, { className: "w-8 h-8 text-like" }), (0, import_jsx_runtime$25.jsxs)("span", { children: ["获赞: ", totalFavorited] })]
				}),
				(0, import_jsx_runtime$25.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$25.jsx)(UserPlus, { className: "w-8 h-8" }), (0, import_jsx_runtime$25.jsxs)("span", { children: ["关注: ", followingCount] })]
				}),
				(0, import_jsx_runtime$25.jsxs)("div", {
					className: "flex gap-2 items-center",
					children: [(0, import_jsx_runtime$25.jsx)(Users, { className: "w-8 h-8 text-follow" }), (0, import_jsx_runtime$25.jsxs)("span", { children: ["粉丝: ", fans] })]
				})
			]
		})]
	});
	MusicQRCodeSection = ({ qrCodeDataUrl }) => (0, import_jsx_runtime$25.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$25.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$25.jsx)(QrCode, { className: "w-11 h-11" }), (0, import_jsx_runtime$25.jsx)("span", { children: "文件直链：永久有效" })]
		}), (0, import_jsx_runtime$25.jsx)("div", {
	...
	DouyinMusicInfo = (props) => {
		...
		return (0, import_jsx_runtime$25.jsx)(DefaultLayout, {
			...
			children: (0, import_jsx_runtime$25.jsxs)("div", { children: [
				...
				(0, import_jsx_runtime$25.jsx)("div", { className: "h-[90px]" }),
			...
			children: [(0, import_jsx_runtime$24.jsxs)("div", {
				...
				children: [
					...
					video.music && (0, import_jsx_runtime$24.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$24.jsx)("span", { children: "♫" }), (0, import_jsx_runtime$24.jsx)("span", {
						...
						children: [(0, import_jsx_runtime$24.jsx)("img", {
							...
							children: [
								...
								(0, import_jsx_runtime$24.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$24.jsxs)("span", { children: ["抖音号：", prpos.data.user.short_id] }), prpos.data.user.ip_location && (0, import_jsx_runtime$24.jsx)("span", { children: prpos.data.user.ip_location })]
								}),
								(0, import_jsx_runtime$24.jsxs)("div", {
...
var init_UserList$1 = __esmMin(() => {
		...
		children: [(0, import_jsx_runtime$23.jsx)("img", {
			...
			children: [(0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$23.jsxs)("span", {
					...
					children: [(0, import_jsx_runtime$23.jsx)(User, {
				...
				}), (0, import_jsx_runtime$23.jsx)(chip_default, {
					color: props.switch ? "success" : "default",
					variant: "flat",
					size: "lg",
					startContent: (0, import_jsx_runtime$23.jsx)(Power, {
						className: "w-4 h-4",
						"aria-hidden": "true"
					}),
				...
				children: [
					...
					(0, import_jsx_runtime$23.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$23.jsx)(UserPlus, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$23.jsxs)("span", {
							className: "truncate",
	...
	DouyinUserList = (prop) => (0, import_jsx_runtime$23.jsx)(DefaultLayout, {
		...prop,
		children: (0, import_jsx_runtime$23.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime$23.jsx)("h2", {
				...
				"aria-label": "抖音用户列表",
				children: prop.data.renderOpt.map((user, index) => (0, import_jsx_runtime$23.jsx)(DouyinUserItem, { ...user }, `${user.short_id}-${index}`))
			})]
		})
	});
				...
				children: [
					(0, import_jsx_runtime$21.jsxs)("div", {
						...
						children: [(0, import_jsx_runtime$21.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$21.jsx)(QrCode, { className: "w-12 h-12 text-foreground-600" }), (0, import_jsx_runtime$21.jsx)("h1", {
								className: "text-6xl font-bold text-foreground",
								children: "抖音扫码登录"
							})]
						}), (0, import_jsx_runtime$21.jsxs)("div", {
							className: "flex gap-3 items-center text-3xl text-default-600",
							children: [(0, import_jsx_runtime$21.jsx)(Clock, { className: "w-8 h-8" }), (0, import_jsx_runtime$21.jsx)("span", { children: "请在120秒内通过抖音APP扫码进行登录" })]
						})]
					}),
					(0, import_jsx_runtime$21.jsx)("div", { className: "h-12" }),
					(0, import_jsx_runtime$21.jsx)("div", {
						...
						children: (0, import_jsx_runtime$21.jsx)("div", {
							...
							children: props.data.qrCodeDataUrl ? (0, import_jsx_runtime$21.jsx)("div", {
								...
								children: [(0, import_jsx_runtime$21.jsx)(QrCode, { className: "w-16 h-16 text-default-500" }), (0, import_jsx_runtime$21.jsx)("span", {
					...
					(0, import_jsx_runtime$21.jsx)("div", { className: "h-10" }),
					(0, import_jsx_runtime$21.jsxs)("div", {
						className: "p-8 rounded-3xl border-2 shadow-lg bg-warning-50 border-warning-200",
						children: [(0, import_jsx_runtime$21.jsxs)("h3", {
							className: "flex gap-4 items-center mb-6 text-4xl font-semibold text-warning-700",
							children: [(0, import_jsx_runtime$21.jsx)(Shield, { className: "w-10 h-10 text-warning-600" }), "注意事项与免责声明"]
						}), (0, import_jsx_runtime$21.jsx)("div", {
							className: "space-y-4",
							children: disclaimer.split("\n").map((line, index) => (0, import_jsx_runtime$21.jsx)("p", {
			...
			children: [(0, import_jsx_runtime$20.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$20.jsx)("div", {
					...
					children: (0, import_jsx_runtime$20.jsxs)("div", {
						...
						}), props.Type === "视频" && props.Resolution && (0, import_jsx_runtime$20.jsxs)("div", {
					...
					children: [
						...
						props.Type === "视频" ? (0, import_jsx_runtime$20.jsxs)(import_jsx_runtime$20.Fragment, { children: [(0, import_jsx_runtime$20.jsxs)("div", {
							className: "flex items-center tracking-[6px] text-[45px] text-foreground-500 select-text whitespace-nowrap",
							children: [(0, import_jsx_runtime$20.jsx)("span", {
								className: "flex-shrink-0 mr-4 text-foreground-400",
								children: "大小"
				...
				(0, import_jsx_runtime$20.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$20.jsx)("div", {
						...
						children: (0, import_jsx_runtime$20.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$20.jsx)(ThumbsUp, { className: "w-[60px] h-[60px] text-foreground-500" }), (0, import_jsx_runtime$20.jsx)("span", {
...
var init_UserList = __esmMin(() => {
		...
		children: [(0, import_jsx_runtime$18.jsx)(EnhancedImage, {
			...
			children: [(0, import_jsx_runtime$18.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$18.jsxs)("span", {
					className: "text-4xl font-medium text-foreground select-text inline-flex items-center gap-2.5 truncate",
					children: [(0, import_jsx_runtime$18.jsx)(User, {
						className: "w-8 h-8 opacity-80 flex-shrink-0",
						"aria-hidden": "true"
				...
				}), (0, import_jsx_runtime$18.jsx)(chip_default, {
					color: props.switch ? "success" : "default",
					variant: "flat",
					size: "lg",
					startContent: (0, import_jsx_runtime$18.jsx)(Power, {
						className: "w-5 h-5",
						"aria-hidden": "true"
					}),
					className: "flex-shrink-0",
				...
				children: [
					(0, import_jsx_runtime$18.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$18.jsx)(Hash, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$18.jsxs)("span", {
							className: "truncate",
					...
					(0, import_jsx_runtime$18.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$18.jsx)(Users, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$18.jsxs)("span", {
							className: "truncate",
					...
					(0, import_jsx_runtime$18.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$18.jsx)(Heart, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$18.jsxs)("span", {
							className: "truncate",
					...
					(0, import_jsx_runtime$18.jsxs)("span", {
						className: "inline-flex items-center gap-2.5 truncate",
						children: [(0, import_jsx_runtime$18.jsx)(UserPlus, {
							className: "w-5 h-5 opacity-70 flex-shrink-0",
							"aria-hidden": "true"
						}), (0, import_jsx_runtime$18.jsxs)("span", {
							className: "truncate",
	...
	BilibiliUserList = (prop) => (0, import_jsx_runtime$18.jsx)(DefaultLayout, {
		...prop,
		children: (0, import_jsx_runtime$18.jsxs)("div", {
			className: "w-full px-10 py-16",
			children: [(0, import_jsx_runtime$18.jsxs)("div", {
				className: "mb-8 p-7 rounded-3xl bg-content2 shadow-medium",
				children: [
					(0, import_jsx_runtime$18.jsx)("h2", {
						className: "text-5xl font-bold text-foreground mb-2 select-text",
						children: prop.data.groupInfo.groupName
					}),
				...
				className: "grid grid-cols-2 gap-7 list-none p-0",
				"aria-label": "B站用户列表",
				children: prop.data.renderOpt.map((user, index) => (0, import_jsx_runtime$18.jsx)(BilibiliUserItem, { ...user }, `${user.host_mid}-${index}`))
			})]
		})
	});
				...
				children: [(0, import_jsx_runtime$17.jsxs)("div", {
					...
					children: [
								...
								children: [
									...
									(0, import_jsx_runtime$17.jsxs)("div", {
										...
										children: [
											...
											(0, import_jsx_runtime$17.jsxs)("span", { children: [formatNumber$2(props.upInfo.follower), "粉丝"] }),
						...
						(0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime$17.jsx)("span", { children: "提示：请在120秒内发送" }),
								(0, import_jsx_runtime$17.jsx)(code_default, {
									size: "lg",
									color: "danger",
									children: " 第 ？ 集 "
								}),
								(0, import_jsx_runtime$17.jsx)("span", { children: "选择集数" })
							]
						})
					]
				}), (0, import_jsx_runtime$17.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$17.jsxs)("div", { children: [
						...
						actorList.length > 0 && (0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$17.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$17.jsx)(Users, { size: 30 }), (0, import_jsx_runtime$17.jsx)("span", { children: "声优阵容" })]
							}), (0, import_jsx_runtime$17.jsxs)("div", {
						...
						props.evaluate && (0, import_jsx_runtime$17.jsxs)("div", {
							...
							children: [(0, import_jsx_runtime$17.jsxs)("div", {
								className: "flex gap-6 items-center mb-6 text-3xl select-text text-foreground",
								children: [(0, import_jsx_runtime$17.jsx)(Star, { size: 30 }), (0, import_jsx_runtime$17.jsx)("span", { children: "评价" })]
							}), (0, import_jsx_runtime$17.jsx)("div", {
		...
		return (0, import_jsx_runtime$17.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime$17.jsxs)("div", {
				...
				children: [
					...
					(0, import_jsx_runtime$17.jsx)("span", { children: "剧集列表" }),
							...
							children: [(0, import_jsx_runtime$17.jsxs)("div", {
								...
								children: [(0, import_jsx_runtime$17.jsx)("div", {
									...
									children: [(0, import_jsx_runtime$17.jsx)("div", {
										...
										children: [(0, import_jsx_runtime$17.jsx)(Calendar, { size: 30 }), (0, import_jsx_runtime$17.jsx)("span", { children: "发布了内容" })]
									})]
								})]
							}), (0, import_jsx_runtime$17.jsx)("div", {
...
var init_AdditionalCard = __esmMin(() => {
			...
			children: (0, import_jsx_runtime$16.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$16.jsxs)("div", {
					...
					children: (0, import_jsx_runtime$16.jsx)(button_default, {
						startContent: reserve.buttonText !== "已结束" ? (0, import_jsx_runtime$16.jsx)(Bell, { className: "scale-180 mr-4" }) : void 0,
	...
	BilibiliCommonCard = ({ common }) => {
		...
		return (0, import_jsx_runtime$16.jsxs)("div", {
			className: "flex flex-col gap-4",
			children: [common.head_text && (0, import_jsx_runtime$16.jsxs)("div", {
				className: "flex gap-2 items-center text-4xl text-foreground-500",
				children: [(0, import_jsx_runtime$16.jsx)(Gamepad2, { size: 40 }), (0, import_jsx_runtime$16.jsx)("span", { children: common.head_text })]
			}), (0, import_jsx_runtime$16.jsx)("div", {
				className: "overflow-hidden rounded-2xl bg-default-100",
				children: (0, import_jsx_runtime$16.jsxs)("div", {
					className: "flex gap-8 items-center px-10 py-8",
							...
							children: [
								...
								(0, import_jsx_runtime$16.jsxs)("div", {
									...
									children: [(0, import_jsx_runtime$16.jsx)("span", {
										...
										children: getTagText()
									}), common.sub_type === "game" && common.desc1 && (0, import_jsx_runtime$16.jsx)("span", {
										className: "text-foreground-500 line-clamp-1 select-text",
										children: common.desc1
									})]
								}),
								common.desc2 && (0, import_jsx_runtime$16.jsx)("div", {
									className: "text-4xl text-foreground-500 line-clamp-1 select-text",
									children: common.desc2
								})
							]
						}),
						common.button_text && (0, import_jsx_runtime$16.jsx)("div", {
							className: "shrink-0",
							children: (0, import_jsx_runtime$16.jsx)(button_default, {
			...
			children: (0, import_jsx_runtime$16.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime$16.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime$16.jsx)("div", {
						...
						children: [(0, import_jsx_runtime$16.jsxs)("span", { children: [ugc.play, "播放"] }), (0, import_jsx_runtime$16.jsxs)("span", { children: [ugc.danmaku, "弹幕"] })]
					})]
				})]
			})
		});
	...
	BilibiliDynamicUserInfo$1 = (props) => (0, import_jsx_runtime$15.jsxs)("div", {
		...
		children: [
			...
			props.decoration_card && (0, import_jsx_runtime$15.jsx)("div", {
				className: "pl-40",
				children: (0, import_jsx_runtime$15.jsx)("div", { dangerouslySetInnerHTML: { __html: props.decoration_card } })
			})
		]
	});
		...
		children: [
			(0, import_jsx_runtime$15.jsxs)("div", {
				...
				children: [
					...
					(0, import_jsx_runtime$15.jsx)("span", { children: "·" }),
					(0, import_jsx_runtime$15.jsxs)("div", {
						className: "flex gap-2 items-center",
						children: [
	...
	BilibiliWordContent = (props) => (0, import_jsx_runtime$14.jsxs)(import_jsx_runtime$14.Fragment, { children: [(0, import_jsx_runtime$14.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime$14.jsx)("div", {
			...
			children: (0, import_jsx_runtime$14.jsx)(CommentText, {
				className: clsx_default("text-[60px] tracking-[0.5px] leading-[1.6] whitespace-pre-wrap text-foreground mb-[20px] select-text", "[&_svg]:inline [&_svg]:mb-4!", "[&_img]:inline [&_img]:mx-1 [&_img]:align-bottom [&_img]:relative [&_img]:-top-2"),
				content: props.text,
				style: {
					wordBreak: "break-word",
					overflowWrap: "break-word"
