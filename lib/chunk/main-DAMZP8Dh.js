...
import { C as Client, b as bilibiliErrorCodeMap, g as getBilibiliData, a as bilibiliApiUrls, w as wbi_sign, c as getDouyinData, h as heicConvertExports, d as browserExports } from "./vendor-Dd5y9t4u.js";
...
import { g as getDouyinDB, a as getBilibiliDB, c as cleanOldDynamicCache, b as bilibiliDBInstance, d as douyinDBInstance } from "./db-ISNCNmKd.js";
...
const getAuthorsRouter = async (req, res) => {
  try {
    ...
    const bilibiliDB = await getBilibiliDB();
    const authorOptions = [];
    const douyinSubscriptions = await douyinDB.getGroupSubscriptions(groupId);
    ...
    const bilibiliSubscriptions = await bilibiliDB.getGroupSubscriptions(groupId);
