...
import { v as v5_default, b as bilibiliErrorCodeMap, g as getBilibiliData2, a as bilibiliApiUrls, w as wbi_sign, c as getBilibiliData, d as getDouyinData2, h as heicConvertExports, e as browserExports, C as Client } from "./vendor-CmittF14.js";
...
import { g as getDouyinDB, a as getBilibiliDB, c as cleanOldDynamicCache, b as bilibiliDBInstance, d as douyinDBInstance } from "./db-BduQx8o5.js";
...
` + dynamicInfo.data.data.item.modules.module_dynamic.desc.text;
          ...
          case DynamicType.FORWARD: {
            ...
            switch (dynamicInfo.data.data.item.orig.type) {
              ...
              case DynamicType.DRAW: {
                const dynamicCARD2 = await getBilibiliData2("动态卡片数据", Config.cookies.bilibili, { dynamic_id: dynamicInfo.data.data.item.orig.id_str });
          ...
          /** 直播动态 */
          case DynamicType.LIVE_RCMD: {
            const userINFO = await getBilibiliData2("用户主页数据", "", { host_mid: dynamicInfo.data.data.item.modules.module_author.mid, typeMode: "strict" });
            img$1 = await Render(
