...
import { C as Client, b as bilibiliErrorCodeMap, g as getBilibiliData, a as bilibiliApiUrls, w as wbi_sign, c as browserExports, i as index, d as getDouyinData, h as heicConvertExports, m as markdown } from "./vendor-BnVODeEf.js";
import karin, { logger, config, segment, createNotFoundResponse, copyConfigSync, filesByExt, watch, requireFileSync, ffmpeg, ffprobe, render, common, karin as karin$1, defineConfig, components, karinPathRoot, mkdirSync, handler } from "node-karin";
import axios, { AxiosError } from "node-karin/axios";
import { pipeline } from "stream/promises";
import path, { join } from "node:path";
import "sequelize";
import { douyinDB, bilibiliDB, cleanOldDynamicCache } from "./db-DCqK0jme.js";
...
class Cfg {
  ...
  async syncConfigToDatabase() {
    try {
      ...
      const { bilibiliDB: bilibiliDB2, douyinDB: douyinDB2 } = await import("./db-DCqK0jme.js");
      if (pushCfg.bilibili) {
