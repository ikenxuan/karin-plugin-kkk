...
import { Config, logMiddleware, registerBilibiliRoutes, registerDouyinRoutes, registerKuaishouRoutes, logger, index_default, Version, Common } from './chunk-XTVHNDV3.js';
import { init_esm_shims } from './chunk-2FTP7FNI.js';
import cors from 'cors';
import { createProxyMiddleware } from 'http-proxy-middleware';
import { app, basePath, mkdirSync, logger as logger$1 } from 'node-karin';
...
var base = `${basePath}/${Version.pluginName}`;
mkdirSync(`${base}/data`);
