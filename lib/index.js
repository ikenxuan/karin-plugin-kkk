import { C as Config, l as logMiddleware, r as registerBilibiliRoutes, a as registerDouyinRoutes, b as registerKuaishouRoutes, c as logger$1, i as index_default, d as Common } from "./chunk/douyin-C1kMBq00.js";
...
function requireWebIncoming() {
  ...
  var httpNative = require$$0$2, httpsNative = require$$1$1, web_o = requireWebOutgoing(), common2 = requireCommon$1(), followRedirects2 = requireFollowRedirects();
...
function requireWsIncoming() {
  ...
  var http = require$$0$2, https = require$$1$1, common2 = requireCommon$1();
  /*!
   * Array of passes.
   *
...
function requireHttpProxy$2() {
  ...
  (function(module) {
    var httpProxy2 = module.exports, extend = require$$0._extend, parse_url = require$$0$1.parse, EE3 = requireEventemitter3(), http = require$$0$2, https = require$$1$1, web = requireWebIncoming(), ws = requireWsIncoming();
