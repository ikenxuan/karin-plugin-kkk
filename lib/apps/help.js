...
import { Render, Config, Version, Common } from '../chunk-XTVHNDV3.js';
import { init_esm_shims } from '../chunk-2FTP7FNI.js';
import { execSync } from 'node:child_process';
import fs from 'node:fs';
import { markdown } from '@karinjs/md-html';
import karin, { mkdirSync, tempPath, render, segment, isPkg, updatePkg, updateGitPlugin, logger, common, restart } from 'node-karin';
