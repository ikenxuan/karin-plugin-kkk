...
export default
  withPwa(defineConfig({
    ...
    titleTemplate: 'Karin 的视频解析插件',
    description: 'Karin 的视频解析插件',
    markdown: {
      math: true,
      // 全局代码块行号显示
      lineNumbers: true,
    ...
    vite: {
      plugins: [
        ...
        GitChangelog({
          maxGitLogCount: 2000,
          // 要获取git日志的仓库
          repoURL: () => 'https://github.com/ikenxuan/karin-plugin-kkk',
        }),
        GitChangelogMarkdownSection({
    ...
    // 站点地图
    sitemap: {
      hostname: 'https://ikenxuan.github.io/karin-plugin-kkk/',
    },
    head: [
    ...
    themeConfig: {
      ...
      editLink: {
        pattern: 'https://github.com/ikenxuan/karin-plugin-kkk/edit/docs/:path',
