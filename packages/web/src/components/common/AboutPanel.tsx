    ...
    <Card className="mx-auto max-w-3xl">
      ...
      <Card.Content className="flex flex-col gap-6 pb-8">
        ...
        <section>
          ...
          <Description>Karin 的「抖音」「B站」视频解析/动态推送插件。 支持视频解析、动态推送、扫码登录等功能。</Description>
        </section>

        {/* 作者 */}
        <section>
          <h3 className="mb-3 text-base font-semibold">开发者</h3>
          <Description>ikenxuan, sj817</Description>
        </section>
        ...
        <section>
          ...
          <div className="mt-3 flex flex-wrap gap-3">
            <Button variant="outline" onPress={() => openLink('https://github.com/ikenxuan/karin-plugin-kkk')}>
              <ExternalLink size={18} aria-hidden="true" />
              <span>GitHub 仓库</span>
            </Button>
            <Button variant="outline" onPress={() => openLink('https://github.com/ikenxuan/karin-plugin-kkk/issues')}>
              <ExternalLink size={18} aria-hidden="true" />
              <span>反馈问题</span>
            </Button>
          </div>
