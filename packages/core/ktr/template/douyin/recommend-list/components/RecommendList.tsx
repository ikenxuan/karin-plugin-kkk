      ...
      <div className="relative z-20 p-12 pb-0 grid grid-cols-12 gap-12 min-h-150 items-stretch">
        ...
        <div className="col-span-4 flex flex-col justify-between py-8">
          ...
          <div className="flex flex-col gap-1 select-none">
            <span className="text-6xl font-bold text-foreground/10 tracking-tighter leading-none">DOUYIN</span>
            <span className="text-6xl font-bold text-emerald-500/20 tracking-tighter leading-none">RECOMMEND</span>
