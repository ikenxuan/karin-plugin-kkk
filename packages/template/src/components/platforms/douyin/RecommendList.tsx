 ...
 * 抖音推荐列表组件
 */
export const DouyinRecommendList: React.FC<DouyinRecommendListProps> = (props) => {
      ...
      <div className="relative z-20 p-12 pb-0 grid grid-cols-12 gap-12 min-h-screen items-stretch">
        ...
        <div className="col-span-4 flex flex-col justify-between py-8">
          ...
          <div className="flex flex-col gap-1 select-none">
            <span className="text-6xl font-black text-default-900/10 tracking-tighter leading-none">DOUYIN</span>
          ...
          <div className="flex flex-col gap-10 relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="px-6 py-6 pt-0 rounded-full text-2xl text-default-500 font-mono">
