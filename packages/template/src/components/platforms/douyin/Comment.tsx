...
const renderDouyinCommentRichText = (
  content: DouyinSubComment['text'] | DouyinCommentProps['data']['CommentsData'][number]['text']
): ReactNode => {
 ...
 */
const CommentItemComponent: React.FC<DouyinCommentProps['data']['CommentsData'][number] & { isLast?: boolean; maxDepth?: number }> = (
  props
) => {
  return (
