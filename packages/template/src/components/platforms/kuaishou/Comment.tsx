...
import type { KuaishouCommentProps } from '../../../types/platforms/kuaishou'
 ...
 * @returns JSX元素
 */
const KuaishouCommentItemComponent: React.FC<KuaishouCommentProps['data']['CommentsData'][0] & { isLast?: boolean }> = (
  { ...props },
  isLast = false
) => {
  return (
