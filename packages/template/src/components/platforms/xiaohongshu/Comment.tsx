...
import type { XiaohongshuCommentProps } from '../../../types/platforms/xiaohongshu'
import { generateQRCode } from '../../../utils/QRcode'
import { DefaultLayout } from '../../layouts/DefaultLayout'

const xiaohongshuMentionClassName = 'text-[#13386c] dark:text-[#c7daef]'

const renderXiaohongshuCommentRichText = (content: XiaohongshuCommentProps['data']['CommentsData'][0]['content']) => {
 ...
 * @returns JSX元素
 */
const CommentItemComponent: React.FC<XiaohongshuCommentProps['data']['CommentsData'][0] & { isLast?: boolean }> = (
  { ...props },
  isLast = false
) => {
  return (
