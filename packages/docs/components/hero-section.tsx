...
function PlatformBadge({ icon, label, colorClass }: { icon: React.ReactNode; label: string; colorClass: string }) {
  return (
      ...
      <section className="absolute inset-0 flex overflow-hidden flex-col w-full">
        ...
        >
          ...
          >
            ...
            框架的短视频解析与动态推送插件
            <br />
            <span className="text-fd-muted-foreground/80">为群聊打造一流的媒体分享体验，自动识别分享链接，无需跳转即可浏览</span>
          </motion.p>
