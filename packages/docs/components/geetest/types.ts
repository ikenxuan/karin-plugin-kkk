...
declare global {
  function initGeetest(config: Geetest3Config, callback: (captchaObj: Geetest3CaptchaObj) => void): void

  function initGeetest4(config: Geetest4Config, callback: (captchaObj: Geetest4CaptchaObj) => void): void
}
